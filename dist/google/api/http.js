...
exports.Http = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Http.typeUrl ||
                (Array.isArray(o.rules) &&
                    (!o.rules.length || exports.HttpRule.is(o.rules[0])) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Http.typeUrl ||
                (Array.isArray(o.rules) &&
                    (!o.rules.length || exports.HttpRule.isSDK(o.rules[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Http.typeUrl ||
                (Array.isArray(o.rules) &&
                    (!o.rules.length || exports.HttpRule.isAmino(o.rules[0])) &&
                    typeof o.fully_decode_reserved_expansion === 'boolean')));
    },
...
exports.HttpRule = {
            ...
            (o.$typeUrl === exports.HttpRule.typeUrl ||
                (typeof o.selector === 'string' &&
                    ...
                    (!o.additional_bindings.length ||
                        exports.HttpRule.isSDK(o.additional_bindings[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.HttpRule.typeUrl ||
                (typeof o.selector === 'string' &&
                    ...
                    Array.isArray(o.additional_bindings) &&
                    (!o.additional_bindings.length ||
                        exports.HttpRule.isAmino(o.additional_bindings[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.selector !== '') {
    ...
    fromAmino(object) {
        ...
        message.additionalBindings =
            object.additional_bindings?.map(e => exports.HttpRule.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        obj.custom = message.custom
            ? exports.CustomHttpPattern.toAmino(message.custom)
            : undefined;
...
exports.CustomHttpPattern = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CustomHttpPattern.typeUrl ||
