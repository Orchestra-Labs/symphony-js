...
export const TickSpacingDecreaseProposal = {
            ...
            (o.$typeUrl === TickSpacingDecreaseProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    ...
                    (!o.pool_id_to_tick_spacing_records.length ||
                        PoolIdToTickSpacingRecord.isSDK(o.pool_id_to_tick_spacing_records[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === TickSpacingDecreaseProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    ...
                    Array.isArray(o.pool_id_to_tick_spacing_records) &&
                    (!o.pool_id_to_tick_spacing_records.length ||
                        PoolIdToTickSpacingRecord.isAmino(o.pool_id_to_tick_spacing_records[0])))));
    },
    encode(message, writer = BinaryWriter.create()) {
        if (message.title !== '') {
            writer.uint32(10).string(message.title);
    ...
    fromAmino(object) {
        ...
        message.poolIdToTickSpacingRecords =
            object.pool_id_to_tick_spacing_records?.map(e => PoolIdToTickSpacingRecord.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.poolIdToTickSpacingRecords) {
            obj.pool_id_to_tick_spacing_records =
                message.poolIdToTickSpacingRecords.map(e => e ? PoolIdToTickSpacingRecord.toAmino(e) : undefined);
        }
        else {
