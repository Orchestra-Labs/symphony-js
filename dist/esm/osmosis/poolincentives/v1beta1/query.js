...
export const QueryGaugeIdsResponse = {
            ...
            (o.$typeUrl === QueryGaugeIdsResponse.typeUrl ||
                (Array.isArray(o.gaugeIdsWithDuration) &&
                    (!o.gaugeIdsWithDuration.length ||
                        QueryGaugeIdsResponse_GaugeIdWithDuration.is(o.gaugeIdsWithDuration[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === QueryGaugeIdsResponse.typeUrl ||
                (Array.isArray(o.gauge_ids_with_duration) &&
                    (!o.gauge_ids_with_duration.length ||
                        QueryGaugeIdsResponse_GaugeIdWithDuration.isSDK(o.gauge_ids_with_duration[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === QueryGaugeIdsResponse.typeUrl ||
                (Array.isArray(o.gauge_ids_with_duration) &&
                    (!o.gauge_ids_with_duration.length ||
                        QueryGaugeIdsResponse_GaugeIdWithDuration.isAmino(o.gauge_ids_with_duration[0])))));
    },
    encode(message, writer = BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryGaugeIdsResponse();
        message.gaugeIdsWithDuration =
            object.gauge_ids_with_duration?.map(e => QueryGaugeIdsResponse_GaugeIdWithDuration.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
