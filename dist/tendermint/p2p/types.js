...
exports.NetAddress = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.NetAddress.typeUrl ||
                (typeof o.id === 'string' &&
                    typeof o.ip === 'string' &&
...
exports.ProtocolVersion = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ProtocolVersion.typeUrl ||
                (typeof o.p2p === 'bigint' &&
...
exports.DefaultNodeInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DefaultNodeInfo.typeUrl ||
                (exports.ProtocolVersion.is(o.protocolVersion) &&
                    ...
                    exports.DefaultNodeInfoOther.is(o.other))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DefaultNodeInfo.typeUrl ||
                (exports.ProtocolVersion.isSDK(o.protocol_version) &&
                    ...
                    (o.channels instanceof Uint8Array ||
                        typeof o.channels === 'string') &&
                    typeof o.moniker === 'string' &&
                    exports.DefaultNodeInfoOther.isSDK(o.other))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DefaultNodeInfo.typeUrl ||
                (exports.ProtocolVersion.isAmino(o.protocol_version) &&
                    typeof o.default_node_id === 'string' &&
                    typeof o.listen_addr === 'string' &&
                    typeof o.network === 'string' &&
                    typeof o.version === 'string' &&
                    (o.channels instanceof Uint8Array ||
                        typeof o.channels === 'string') &&
                    typeof o.moniker === 'string' &&
                    exports.DefaultNodeInfoOther.isAmino(o.other))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.protocol_version = message.protocolVersion
            ? exports.ProtocolVersion.toAmino(message.protocolVersion)
            : undefined;
        obj.default_node_id =
        ...
        obj.channels = message.channels
            ? (0, helpers_1.base64FromBytes)(message.channels)
            : undefined;
        obj.moniker = message.moniker === '' ? undefined : message.moniker;
        obj.other = message.other
            ? exports.DefaultNodeInfoOther.toAmino(message.other)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.DefaultNodeInfoOther = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DefaultNodeInfoOther.typeUrl ||
