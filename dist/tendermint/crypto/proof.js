...
exports.Proof = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Proof.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.leaf_hash = message.leafHash
            ? (0, helpers_1.base64FromBytes)(message.leafHash)
            : undefined;
        if (message.aunts) {
...
exports.ValueOp = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValueOp.typeUrl ||
...
exports.DominoOp = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DominoOp.typeUrl ||
                (typeof o.key === 'string' &&
...
exports.ProofOp = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ProofOp.typeUrl ||
...
exports.ProofOps = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ProofOps.typeUrl ||
                (Array.isArray(o.ops) && (!o.ops.length || exports.ProofOp.is(o.ops[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ProofOps.typeUrl ||
                (Array.isArray(o.ops) && (!o.ops.length || exports.ProofOp.isSDK(o.ops[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ProofOps.typeUrl ||
                (Array.isArray(o.ops) && (!o.ops.length || exports.ProofOp.isAmino(o.ops[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
