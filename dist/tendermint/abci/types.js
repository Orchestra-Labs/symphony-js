...
exports.Request = {
    ...
    toAmino(message) {
        ...
        obj.init_chain = message.initChain
            ? exports.RequestInitChain.toAmino(message.initChain)
            : undefined;
        obj.query = message.query ? exports.RequestQuery.toAmino(message.query) : undefined;
        obj.begin_block = message.beginBlock
            ? exports.RequestBeginBlock.toAmino(message.beginBlock)
            : undefined;
        obj.check_tx = message.checkTx
            ? exports.RequestCheckTx.toAmino(message.checkTx)
            : undefined;
        obj.deliver_tx = message.deliverTx
            ? exports.RequestDeliverTx.toAmino(message.deliverTx)
            : undefined;
        obj.end_block = message.endBlock
            ? exports.RequestEndBlock.toAmino(message.endBlock)
            : undefined;
        obj.commit = message.commit
            ? exports.RequestCommit.toAmino(message.commit)
            : undefined;
        obj.list_snapshots = message.listSnapshots
            ? exports.RequestListSnapshots.toAmino(message.listSnapshots)
            : undefined;
        obj.offer_snapshot = message.offerSnapshot
            ? exports.RequestOfferSnapshot.toAmino(message.offerSnapshot)
            : undefined;
        ...
        obj.apply_snapshot_chunk = message.applySnapshotChunk
            ? exports.RequestApplySnapshotChunk.toAmino(message.applySnapshotChunk)
            : undefined;
        obj.prepare_proposal = message.prepareProposal
            ? exports.RequestPrepareProposal.toAmino(message.prepareProposal)
            : undefined;
        obj.process_proposal = message.processProposal
            ? exports.RequestProcessProposal.toAmino(message.processProposal)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.RequestInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestInfo.typeUrl ||
...
exports.RequestInitChain = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestInitChain.typeUrl ||
                (timestamp_1.Timestamp.is(o.time) &&
                    typeof o.chainId === 'string' &&
                    Array.isArray(o.validators) &&
                    (!o.validators.length || exports.ValidatorUpdate.is(o.validators[0])) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.RequestInitChain.typeUrl ||
                (timestamp_1.Timestamp.isSDK(o.time) &&
                    typeof o.chain_id === 'string' &&
                    Array.isArray(o.validators) &&
                    (!o.validators.length || exports.ValidatorUpdate.isSDK(o.validators[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.RequestInitChain.typeUrl ||
                (timestamp_1.Timestamp.isAmino(o.time) &&
                    typeof o.chain_id === 'string' &&
                    Array.isArray(o.validators) &&
                    (!o.validators.length || exports.ValidatorUpdate.isAmino(o.validators[0])) &&
                    (o.app_state_bytes instanceof Uint8Array ||
                        typeof o.app_state_bytes === 'string') &&
                    typeof o.initial_height === 'bigint')));
    },
    ...
    fromAmino(object) {
        ...
        message.validators =
            object.validators?.map(e => exports.ValidatorUpdate.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        obj.time = message.time
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.time))
            : undefined;
        obj.chain_id = message.chainId === '' ? undefined : message.chainId;
        obj.consensus_params = message.consensusParams
            ? params_1.ConsensusParams.toAmino(message.consensusParams)
            : undefined;
        ...
        obj.app_state_bytes = message.appStateBytes
            ? (0, helpers_1.base64FromBytes)(message.appStateBytes)
            : undefined;
        obj.initial_height =
...
exports.RequestQuery = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestQuery.typeUrl ||
...
exports.RequestBeginBlock = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestBeginBlock.typeUrl ||
                ((o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    types_1.Header.is(o.header) &&
                    exports.CommitInfo.is(o.lastCommitInfo) &&
                    Array.isArray(o.byzantineValidators) &&
                    (!o.byzantineValidators.length ||
                        exports.Misbehavior.is(o.byzantineValidators[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.RequestBeginBlock.typeUrl ||
                ((o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    types_1.Header.isSDK(o.header) &&
                    exports.CommitInfo.isSDK(o.last_commit_info) &&
                    Array.isArray(o.byzantine_validators) &&
                    (!o.byzantine_validators.length ||
                        exports.Misbehavior.isSDK(o.byzantine_validators[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.RequestBeginBlock.typeUrl ||
                ((o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    types_1.Header.isAmino(o.header) &&
                    exports.CommitInfo.isAmino(o.last_commit_info) &&
                    Array.isArray(o.byzantine_validators) &&
                    (!o.byzantine_validators.length ||
                        exports.Misbehavior.isAmino(o.byzantine_validators[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        ...
        message.byzantineValidators =
            object.byzantine_validators?.map(e => exports.Misbehavior.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        obj.last_commit_info = message.lastCommitInfo
            ? exports.CommitInfo.toAmino(message.lastCommitInfo)
            : undefined;
...
exports.RequestCheckTx = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestCheckTx.typeUrl ||
                ((o.tx instanceof Uint8Array || typeof o.tx === 'string') &&
                    (0, helpers_1.isSet)(o.type))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.RequestCheckTx.typeUrl ||
...
exports.RequestDeliverTx = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestDeliverTx.typeUrl ||
...
exports.RequestEndBlock = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestEndBlock.typeUrl || typeof o.height === 'bigint'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.RequestEndBlock.typeUrl || typeof o.height === 'bigint'));
...
exports.RequestOfferSnapshot = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestOfferSnapshot.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.snapshot = message.snapshot
            ? exports.Snapshot.toAmino(message.snapshot)
            : undefined;
        obj.app_hash = message.appHash
            ? (0, helpers_1.base64FromBytes)(message.appHash)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.RequestLoadSnapshotChunk = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestLoadSnapshotChunk.typeUrl ||
                (typeof o.height === 'bigint' &&
...
exports.RequestApplySnapshotChunk = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestApplySnapshotChunk.typeUrl ||
...
exports.RequestPrepareProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestPrepareProposal.typeUrl ||
                (typeof o.maxTxBytes === 'bigint' &&
                    Array.isArray(o.txs) &&
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string') &&
                    exports.ExtendedCommitInfo.is(o.localLastCommit) &&
                    Array.isArray(o.misbehavior) &&
                    (!o.misbehavior.length || exports.Misbehavior.is(o.misbehavior[0])) &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.is(o.time) &&
            ...
            (o.$typeUrl === exports.RequestPrepareProposal.typeUrl ||
                (typeof o.max_tx_bytes === 'bigint' &&
                    ...
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string') &&
                    exports.ExtendedCommitInfo.isSDK(o.local_last_commit) &&
                    Array.isArray(o.misbehavior) &&
                    (!o.misbehavior.length || exports.Misbehavior.isSDK(o.misbehavior[0])) &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.isSDK(o.time) &&
            ...
            (o.$typeUrl === exports.RequestPrepareProposal.typeUrl ||
                (typeof o.max_tx_bytes === 'bigint' &&
                    ...
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string') &&
                    exports.ExtendedCommitInfo.isAmino(o.local_last_commit) &&
                    Array.isArray(o.misbehavior) &&
                    (!o.misbehavior.length || exports.Misbehavior.isAmino(o.misbehavior[0])) &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.isAmino(o.time) &&
                    (o.next_validators_hash instanceof Uint8Array ||
                        typeof o.next_validators_hash === 'string') &&
    ...
    toAmino(message) {
        ...
        obj.local_last_commit = message.localLastCommit
            ? exports.ExtendedCommitInfo.toAmino(message.localLastCommit)
            : undefined;
        ...
        obj.next_validators_hash = message.nextValidatorsHash
            ? (0, helpers_1.base64FromBytes)(message.nextValidatorsHash)
            : undefined;
...
exports.RequestProcessProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RequestProcessProposal.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string') &&
                    exports.CommitInfo.is(o.proposedLastCommit) &&
                    Array.isArray(o.misbehavior) &&
                    (!o.misbehavior.length || exports.Misbehavior.is(o.misbehavior[0])) &&
                    (o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    typeof o.height === 'bigint' &&
            ...
            (o.$typeUrl === exports.RequestProcessProposal.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string') &&
                    exports.CommitInfo.isSDK(o.proposed_last_commit) &&
                    Array.isArray(o.misbehavior) &&
                    (!o.misbehavior.length || exports.Misbehavior.isSDK(o.misbehavior[0])) &&
                    (o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    typeof o.height === 'bigint' &&
            ...
            (o.$typeUrl === exports.RequestProcessProposal.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string') &&
                    exports.CommitInfo.isAmino(o.proposed_last_commit) &&
                    Array.isArray(o.misbehavior) &&
                    (!o.misbehavior.length || exports.Misbehavior.isAmino(o.misbehavior[0])) &&
                    (o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    typeof o.height === 'bigint' &&
    ...
    fromAmino(object) {
        const message = createBaseRequestProcessProposal();
        message.txs = object.txs?.map(e => (0, helpers_1.bytesFromBase64)(e)) || [];
        if (object.proposed_last_commit !== undefined &&
    ...
    toAmino(message) {
        ...
        obj.proposed_last_commit = message.proposedLastCommit
            ? exports.CommitInfo.toAmino(message.proposedLastCommit)
            : undefined;
        if (message.misbehavior) {
            obj.misbehavior = message.misbehavior.map(e => e ? exports.Misbehavior.toAmino(e) : undefined);
        }
...
exports.Response = {
    ...
    toAmino(message) {
        ...
        obj.exception = message.exception
            ? exports.ResponseException.toAmino(message.exception)
            : undefined;
        obj.echo = message.echo ? exports.ResponseEcho.toAmino(message.echo) : undefined;
        obj.flush = message.flush
            ? exports.ResponseFlush.toAmino(message.flush)
            : undefined;
        obj.info = message.info ? exports.ResponseInfo.toAmino(message.info) : undefined;
        obj.init_chain = message.initChain
            ? exports.ResponseInitChain.toAmino(message.initChain)
            : undefined;
        obj.query = message.query
            ? exports.ResponseQuery.toAmino(message.query)
            : undefined;
        obj.begin_block = message.beginBlock
            ? exports.ResponseBeginBlock.toAmino(message.beginBlock)
            : undefined;
        obj.check_tx = message.checkTx
            ? exports.ResponseCheckTx.toAmino(message.checkTx)
            : undefined;
        obj.deliver_tx = message.deliverTx
            ? exports.ResponseDeliverTx.toAmino(message.deliverTx)
            : undefined;
        obj.end_block = message.endBlock
            ? exports.ResponseEndBlock.toAmino(message.endBlock)
            : undefined;
        obj.commit = message.commit
            ? exports.ResponseCommit.toAmino(message.commit)
            : undefined;
        obj.list_snapshots = message.listSnapshots
            ? exports.ResponseListSnapshots.toAmino(message.listSnapshots)
            : undefined;
        obj.offer_snapshot = message.offerSnapshot
            ? exports.ResponseOfferSnapshot.toAmino(message.offerSnapshot)
            : undefined;
        obj.load_snapshot_chunk = message.loadSnapshotChunk
            ? exports.ResponseLoadSnapshotChunk.toAmino(message.loadSnapshotChunk)
            : undefined;
        obj.apply_snapshot_chunk = message.applySnapshotChunk
            ? exports.ResponseApplySnapshotChunk.toAmino(message.applySnapshotChunk)
            : undefined;
        obj.prepare_proposal = message.prepareProposal
            ? exports.ResponsePrepareProposal.toAmino(message.prepareProposal)
            : undefined;
        obj.process_proposal = message.processProposal
            ? exports.ResponseProcessProposal.toAmino(message.processProposal)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ResponseException = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseException.typeUrl || typeof o.error === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseException.typeUrl || typeof o.error === 'string'));
...
exports.ResponseEcho = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseEcho.typeUrl || typeof o.message === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseEcho.typeUrl || typeof o.message === 'string'));
...
exports.ResponseInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseInfo.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.last_block_app_hash = message.lastBlockAppHash
            ? (0, helpers_1.base64FromBytes)(message.lastBlockAppHash)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ResponseInitChain = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseInitChain.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || exports.ValidatorUpdate.is(o.validators[0])) &&
...
exports.ResponseQuery = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseQuery.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.proof_ops = message.proofOps
            ? proof_1.ProofOps.toAmino(message.proofOps)
            : undefined;
        obj.height =
            message.height !== BigInt(0) ? message.height.toString() : undefined;
...
exports.ResponseBeginBlock = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseBeginBlock.typeUrl ||
                (Array.isArray(o.events) &&
                    (!o.events.length || exports.Event.is(o.events[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseBeginBlock.typeUrl ||
                (Array.isArray(o.events) &&
                    (!o.events.length || exports.Event.isSDK(o.events[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseBeginBlock.typeUrl ||
                (Array.isArray(o.events) &&
                    (!o.events.length || exports.Event.isAmino(o.events[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.ResponseCheckTx = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseCheckTx.typeUrl ||
                (typeof o.code === 'number' &&
                    (o.data instanceof Uint8Array || typeof o.data === 'string') &&
                    typeof o.log === 'string' &&
                    typeof o.info === 'string' &&
...
exports.ResponseDeliverTx = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseDeliverTx.typeUrl ||
                (typeof o.code === 'number' &&
                    (o.data instanceof Uint8Array || typeof o.data === 'string') &&
                    typeof o.log === 'string' &&
                    typeof o.info === 'string' &&
...
exports.ResponseEndBlock = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseEndBlock.typeUrl ||
                (Array.isArray(o.validatorUpdates) &&
                    (!o.validatorUpdates.length ||
                        exports.ValidatorUpdate.is(o.validatorUpdates[0])) &&
                    Array.isArray(o.events) &&
                    (!o.events.length || exports.Event.is(o.events[0])))));
    },
    isSDK(o) {
            ...
            (o.$typeUrl === exports.ResponseEndBlock.typeUrl ||
                (Array.isArray(o.validator_updates) &&
                    (!o.validator_updates.length ||
                        exports.ValidatorUpdate.isSDK(o.validator_updates[0])) &&
                    Array.isArray(o.events) &&
                    (!o.events.length || exports.Event.isSDK(o.events[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseEndBlock.typeUrl ||
                (Array.isArray(o.validator_updates) &&
                    (!o.validator_updates.length ||
                        exports.ValidatorUpdate.isAmino(o.validator_updates[0])) &&
                    Array.isArray(o.events) &&
                    (!o.events.length || exports.Event.isAmino(o.events[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseResponseEndBlock();
        message.validatorUpdates =
            object.validator_updates?.map(e => exports.ValidatorUpdate.fromAmino(e)) || [];
...
exports.ResponseCommit = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseCommit.typeUrl ||
                ((o.data instanceof Uint8Array || typeof o.data === 'string') &&
...
exports.ResponseListSnapshots = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseListSnapshots.typeUrl ||
                (Array.isArray(o.snapshots) &&
                    (!o.snapshots.length || exports.Snapshot.is(o.snapshots[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseListSnapshots.typeUrl ||
                (Array.isArray(o.snapshots) &&
                    (!o.snapshots.length || exports.Snapshot.isSDK(o.snapshots[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseListSnapshots.typeUrl ||
                (Array.isArray(o.snapshots) &&
                    (!o.snapshots.length || exports.Snapshot.isAmino(o.snapshots[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.ResponseLoadSnapshotChunk = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseLoadSnapshotChunk.typeUrl ||
...
exports.ResponseApplySnapshotChunk = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponseApplySnapshotChunk.typeUrl ||
                ((0, helpers_1.isSet)(o.result) &&
...
exports.ResponsePrepareProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ResponsePrepareProposal.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length ||
                        o.txs[0] instanceof Uint8Array ||
                        typeof o.txs[0] === 'string'))));
...
exports.CommitInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CommitInfo.typeUrl ||
                (typeof o.round === 'number' &&
                    Array.isArray(o.votes) &&
                    (!o.votes.length || exports.VoteInfo.is(o.votes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.CommitInfo.typeUrl ||
                (typeof o.round === 'number' &&
                    Array.isArray(o.votes) &&
                    (!o.votes.length || exports.VoteInfo.isSDK(o.votes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.CommitInfo.typeUrl ||
                (typeof o.round === 'number' &&
                    Array.isArray(o.votes) &&
                    (!o.votes.length || exports.VoteInfo.isAmino(o.votes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.round !== 0) {
...
exports.ExtendedCommitInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ExtendedCommitInfo.typeUrl ||
                (typeof o.round === 'number' &&
                    Array.isArray(o.votes) &&
                    (!o.votes.length || exports.ExtendedVoteInfo.is(o.votes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ExtendedCommitInfo.typeUrl ||
                (typeof o.round === 'number' &&
                    Array.isArray(o.votes) &&
                    (!o.votes.length || exports.ExtendedVoteInfo.isSDK(o.votes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ExtendedCommitInfo.typeUrl ||
                (typeof o.round === 'number' &&
                    Array.isArray(o.votes) &&
                    (!o.votes.length || exports.ExtendedVoteInfo.isAmino(o.votes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.round !== 0) {
            writer.uint32(8).int32(message.round);
...
exports.Event = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Event.typeUrl ||
                (typeof o.type === 'string' &&
                    Array.isArray(o.attributes) &&
                    (!o.attributes.length || exports.EventAttribute.is(o.attributes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Event.typeUrl ||
                (typeof o.type === 'string' &&
                    Array.isArray(o.attributes) &&
                    (!o.attributes.length || exports.EventAttribute.isSDK(o.attributes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Event.typeUrl ||
                (typeof o.type === 'string' &&
                    Array.isArray(o.attributes) &&
                    (!o.attributes.length || exports.EventAttribute.isAmino(o.attributes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.type !== '') {
    ...
    fromAmino(object) {
        ...
        message.attributes =
            object.attributes?.map(e => exports.EventAttribute.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.EventAttribute = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.EventAttribute.typeUrl ||
                (typeof o.key === 'string' &&
...
exports.TxResult = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxResult.typeUrl ||
                (typeof o.height === 'bigint' &&
                    typeof o.index === 'number' &&
                    (o.tx instanceof Uint8Array || typeof o.tx === 'string') &&
                    exports.ResponseDeliverTx.is(o.result))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.TxResult.typeUrl ||
                (typeof o.height === 'bigint' &&
                    typeof o.index === 'number' &&
                    (o.tx instanceof Uint8Array || typeof o.tx === 'string') &&
                    exports.ResponseDeliverTx.isSDK(o.result))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.TxResult.typeUrl ||
                (typeof o.height === 'bigint' &&
                    typeof o.index === 'number' &&
                    (o.tx instanceof Uint8Array || typeof o.tx === 'string') &&
                    exports.ResponseDeliverTx.isAmino(o.result))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.height !== BigInt(0)) {
            writer.uint32(8).int64(message.height);
    ...
    toAmino(message) {
        ...
        obj.result = message.result
            ? exports.ResponseDeliverTx.toAmino(message.result)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.Validator = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Validator.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.address = message.address
            ? (0, helpers_1.base64FromBytes)(message.address)
            : undefined;
        obj.power =
...
exports.ValidatorUpdate = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorUpdate.typeUrl ||
                (keys_1.PublicKey.is(o.pubKey) && typeof o.power === 'bigint')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorUpdate.typeUrl ||
                (keys_1.PublicKey.isSDK(o.pub_key) && typeof o.power === 'bigint')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorUpdate.typeUrl ||
                (keys_1.PublicKey.isAmino(o.pub_key) && typeof o.power === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.pub_key = message.pubKey
            ? keys_1.PublicKey.toAmino(message.pubKey)
            : undefined;
        obj.power =
            message.power !== BigInt(0) ? message.power.toString() : undefined;
        return obj;
...
exports.VoteInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.VoteInfo.typeUrl ||
                (exports.Validator.is(o.validator) && typeof o.signedLastBlock === 'boolean')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.VoteInfo.typeUrl ||
                (exports.Validator.isSDK(o.validator) &&
                    typeof o.signed_last_block === 'boolean')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.VoteInfo.typeUrl ||
                (exports.Validator.isAmino(o.validator) &&
                    typeof o.signed_last_block === 'boolean')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.validator = message.validator
            ? exports.Validator.toAmino(message.validator)
            : undefined;
...
exports.ExtendedVoteInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ExtendedVoteInfo.typeUrl ||
                (exports.Validator.is(o.validator) &&
    ...
    toAmino(message) {
        ...
        obj.vote_extension = message.voteExtension
            ? (0, helpers_1.base64FromBytes)(message.voteExtension)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.Misbehavior = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Misbehavior.typeUrl ||
                ((0, helpers_1.isSet)(o.type) &&
                    exports.Validator.is(o.validator) &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.is(o.time) &&
...
exports.Snapshot = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Snapshot.typeUrl ||
                (typeof o.height === 'bigint' &&
                    typeof o.format === 'number' &&
    ...
    toAmino(message) {
        ...
        obj.metadata = message.metadata
            ? (0, helpers_1.base64FromBytes)(message.metadata)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
