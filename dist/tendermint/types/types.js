...
exports.PartSetHeader = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.PartSetHeader.typeUrl ||
...
exports.BlockID = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.BlockID.typeUrl ||
                ((o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    exports.PartSetHeader.is(o.partSetHeader))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.BlockID.typeUrl ||
                ((o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    exports.PartSetHeader.isSDK(o.part_set_header))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.BlockID.typeUrl ||
                ((o.hash instanceof Uint8Array || typeof o.hash === 'string') &&
                    exports.PartSetHeader.isAmino(o.part_set_header))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.hash.length !== 0) {
    ...
    toAmino(message) {
        ...
        obj.part_set_header = message.partSetHeader
            ? exports.PartSetHeader.toAmino(message.partSetHeader)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.Header = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Header.typeUrl ||
                (types_1.Consensus.is(o.version) &&
                    typeof o.chainId === 'string' &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.is(o.time) &&
                    exports.BlockID.is(o.lastBlockId) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Header.typeUrl ||
                (types_1.Consensus.isSDK(o.version) &&
                    typeof o.chain_id === 'string' &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.isSDK(o.time) &&
                    exports.BlockID.isSDK(o.last_block_id) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Header.typeUrl ||
                (types_1.Consensus.isAmino(o.version) &&
                    typeof o.chain_id === 'string' &&
                    typeof o.height === 'bigint' &&
                    timestamp_1.Timestamp.isAmino(o.time) &&
                    exports.BlockID.isAmino(o.last_block_id) &&
                    (o.last_commit_hash instanceof Uint8Array ||
                        typeof o.last_commit_hash === 'string') &&
                    (o.data_hash instanceof Uint8Array ||
                        typeof o.data_hash === 'string') &&
    ...
    toAmino(message) {
        ...
        obj.version = message.version
            ? types_1.Consensus.toAmino(message.version)
            : undefined;
        ...
        obj.last_block_id = message.lastBlockId
            ? exports.BlockID.toAmino(message.lastBlockId)
            : undefined;
        ...
        obj.data_hash = message.dataHash
            ? (0, helpers_1.base64FromBytes)(message.dataHash)
            : undefined;
        obj.validators_hash = message.validatorsHash
            ? (0, helpers_1.base64FromBytes)(message.validatorsHash)
            : undefined;
        ...
        obj.last_results_hash = message.lastResultsHash
            ? (0, helpers_1.base64FromBytes)(message.lastResultsHash)
            : undefined;
        obj.evidence_hash = message.evidenceHash
            ? (0, helpers_1.base64FromBytes)(message.evidenceHash)
            : undefined;
...
exports.Data = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Data.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length ||
        ...
        return (o &&
            (o.$typeUrl === exports.Vote.typeUrl ||
                ((0, helpers_1.isSet)(o.type) &&
                    typeof o.height === 'bigint' &&
                    typeof o.round === 'number' &&
                    exports.BlockID.isSDK(o.block_id) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Vote.typeUrl ||
                ((0, helpers_1.isSet)(o.type) &&
                    typeof o.height === 'bigint' &&
                    typeof o.round === 'number' &&
                    exports.BlockID.isAmino(o.block_id) &&
...
exports.Commit = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Commit.typeUrl ||
                (typeof o.height === 'bigint' &&
                    typeof o.round === 'number' &&
                    exports.BlockID.is(o.blockId) &&
                    Array.isArray(o.signatures) &&
                    (!o.signatures.length || exports.CommitSig.is(o.signatures[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Commit.typeUrl ||
                (typeof o.height === 'bigint' &&
                    ...
                    exports.BlockID.isSDK(o.block_id) &&
                    Array.isArray(o.signatures) &&
                    (!o.signatures.length || exports.CommitSig.isSDK(o.signatures[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Commit.typeUrl ||
                (typeof o.height === 'bigint' &&
                    ...
                    exports.BlockID.isAmino(o.block_id) &&
                    Array.isArray(o.signatures) &&
                    (!o.signatures.length || exports.CommitSig.isAmino(o.signatures[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.height !== BigInt(0)) {
    ...
    fromAmino(object) {
        ...
        message.signatures =
            object.signatures?.map(e => exports.CommitSig.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.CommitSig = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CommitSig.typeUrl ||
                ((0, helpers_1.isSet)(o.blockIdFlag) &&
                    (o.validatorAddress instanceof Uint8Array ||
                        typeof o.validatorAddress === 'string') &&
                    timestamp_1.Timestamp.is(o.timestamp) &&
                    (o.signature instanceof Uint8Array ||
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.CommitSig.typeUrl ||
                ((0, helpers_1.isSet)(o.block_id_flag) &&
                    (o.validator_address instanceof Uint8Array ||
                        typeof o.validator_address === 'string') &&
                    timestamp_1.Timestamp.isSDK(o.timestamp) &&
                    (o.signature instanceof Uint8Array ||
...
exports.LightBlock = {
    ...
    toAmino(message) {
        ...
        obj.signed_header = message.signedHeader
            ? exports.SignedHeader.toAmino(message.signedHeader)
            : undefined;
        obj.validator_set = message.validatorSet
            ? validator_1.ValidatorSet.toAmino(message.validatorSet)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.BlockMeta = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.BlockMeta.typeUrl ||
                (exports.BlockID.is(o.blockId) &&
                    typeof o.blockSize === 'bigint' &&
                    exports.Header.is(o.header) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.BlockMeta.typeUrl ||
                (exports.BlockID.isAmino(o.block_id) &&
                    typeof o.block_size === 'bigint' &&
                    exports.Header.isAmino(o.header) &&
                    typeof o.num_txs === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.blockId !== undefined) {
...
exports.TxProof = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxProof.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.root_hash = message.rootHash
            ? (0, helpers_1.base64FromBytes)(message.rootHash)
            : undefined;
