...
exports.ConsensusParams = {
    ...
    toAmino(message) {
        ...
        obj.evidence = message.evidence
            ? exports.EvidenceParams.toAmino(message.evidence)
            : undefined;
        obj.validator = message.validator
            ? exports.ValidatorParams.toAmino(message.validator)
            : undefined;
        obj.version = message.version
            ? exports.VersionParams.toAmino(message.version)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.BlockParams = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.BlockParams.typeUrl ||
...
exports.EvidenceParams = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.EvidenceParams.typeUrl ||
                (typeof o.maxAgeNumBlocks === 'bigint' &&
                    duration_1.Duration.is(o.maxAgeDuration) &&
        ...
        return (o &&
            (o.$typeUrl === exports.EvidenceParams.typeUrl ||
                (typeof o.max_age_num_blocks === 'bigint' &&
                    duration_1.Duration.isSDK(o.max_age_duration) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.EvidenceParams.typeUrl ||
                (typeof o.max_age_num_blocks === 'bigint' &&
                    duration_1.Duration.isAmino(o.max_age_duration) &&
                    typeof o.max_bytes === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.max_age_duration = message.maxAgeDuration
            ? duration_1.Duration.toAmino(message.maxAgeDuration)
            : undefined;
        obj.max_bytes =
            message.maxBytes !== BigInt(0) ? message.maxBytes.toString() : undefined;
        return obj;
...
exports.ValidatorParams = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorParams.typeUrl ||
...
exports.HashedParams = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.HashedParams.typeUrl ||
