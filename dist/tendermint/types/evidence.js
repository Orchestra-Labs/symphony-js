...
exports.Evidence = {
    ...
    toAmino(message) {
        ...
        obj.duplicate_vote_evidence = message.duplicateVoteEvidence
            ? exports.DuplicateVoteEvidence.toAmino(message.duplicateVoteEvidence)
            : undefined;
...
exports.DuplicateVoteEvidence = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DuplicateVoteEvidence.typeUrl ||
...
exports.LightClientAttackEvidence = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LightClientAttackEvidence.typeUrl ||
                (typeof o.commonHeight === 'bigint' &&
                    Array.isArray(o.byzantineValidators) &&
                    (!o.byzantineValidators.length ||
                        validator_1.Validator.is(o.byzantineValidators[0])) &&
                    typeof o.totalVotingPower === 'bigint' &&
                    timestamp_1.Timestamp.is(o.timestamp))));
    },
    isSDK(o) {
            ...
            (o.$typeUrl === exports.LightClientAttackEvidence.typeUrl ||
                (typeof o.common_height === 'bigint' &&
                    ...
                    (!o.byzantine_validators.length ||
                        validator_1.Validator.isSDK(o.byzantine_validators[0])) &&
                    typeof o.total_voting_power === 'bigint' &&
                    timestamp_1.Timestamp.isSDK(o.timestamp))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.LightClientAttackEvidence.typeUrl ||
                (typeof o.common_height === 'bigint' &&
                    Array.isArray(o.byzantine_validators) &&
                    (!o.byzantine_validators.length ||
                        validator_1.Validator.isAmino(o.byzantine_validators[0])) &&
                    typeof o.total_voting_power === 'bigint' &&
                    timestamp_1.Timestamp.isAmino(o.timestamp))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.byzantineValidators =
            object.byzantineValidators?.map(e => validator_1.Validator.fromPartial(e)) || [];
        message.totalVotingPower =
            object.totalVotingPower !== undefined && object.totalVotingPower !== null
                ? BigInt(object.totalVotingPower.toString())
                : BigInt(0);
    ...
    fromAmino(object) {
        ...
        message.byzantineValidators =
            object.byzantine_validators?.map(e => validator_1.Validator.fromAmino(e)) || [];
        if (object.total_voting_power !== undefined &&
            object.total_voting_power !== null) {
            message.totalVotingPower = BigInt(object.total_voting_power);
        }
    ...
    toAmino(message) {
        ...
        obj.conflicting_block = message.conflictingBlock
            ? types_1.LightBlock.toAmino(message.conflictingBlock)
            : undefined;
        obj.common_height =
...
exports.EvidenceList = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.EvidenceList.typeUrl ||
                (Array.isArray(o.evidence) &&
                    (!o.evidence.length || exports.Evidence.is(o.evidence[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.EvidenceList.typeUrl ||
                (Array.isArray(o.evidence) &&
                    (!o.evidence.length || exports.Evidence.isSDK(o.evidence[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.EvidenceList.typeUrl ||
                (Array.isArray(o.evidence) &&
                    (!o.evidence.length || exports.Evidence.isAmino(o.evidence[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
