...
exports.ValidatorSet = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSet.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || exports.Validator.is(o.validators[0])) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSet.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || exports.Validator.isSDK(o.validators[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSet.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || exports.Validator.isAmino(o.validators[0])) &&
                    typeof o.total_voting_power === 'bigint')));
    },
    ...
    fromPartial(object) {
        const message = createBaseValidatorSet();
        message.validators =
            object.validators?.map(e => exports.Validator.fromPartial(e)) || [];
        message.proposer =
    ...
    fromAmino(object) {
        const message = createBaseValidatorSet();
        message.validators =
            object.validators?.map(e => exports.Validator.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        obj.proposer = message.proposer
            ? exports.Validator.toAmino(message.proposer)
            : undefined;
...
exports.Validator = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Validator.typeUrl ||
                ((o.address instanceof Uint8Array || typeof o.address === 'string') &&
                    keys_1.PublicKey.isSDK(o.pub_key) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Validator.typeUrl ||
                ((o.address instanceof Uint8Array || typeof o.address === 'string') &&
                    keys_1.PublicKey.isAmino(o.pub_key) &&
                    typeof o.voting_power === 'bigint' &&
                    typeof o.proposer_priority === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.SimpleValidator = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SimpleValidator.typeUrl ||
                typeof o.votingPower === 'bigint'));
    },
    isSDK(o) {
        return (o &&
