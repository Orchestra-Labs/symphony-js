...
exports.Block = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Block.typeUrl ||
                (types_1.Header.is(o.header) && types_1.Data.is(o.data) && evidence_1.EvidenceList.is(o.evidence))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Block.typeUrl ||
                (types_1.Header.isSDK(o.header) &&
                    types_1.Data.isSDK(o.data) &&
                    evidence_1.EvidenceList.isSDK(o.evidence))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Block.typeUrl ||
                (types_1.Header.isAmino(o.header) &&
                    types_1.Data.isAmino(o.data) &&
                    evidence_1.EvidenceList.isAmino(o.evidence))));
    },
    ...
    toAmino(message) {
        ...
        obj.evidence = message.evidence
            ? evidence_1.EvidenceList.toAmino(message.evidence)
            : undefined;
        obj.last_commit = message.lastCommit
            ? types_1.Commit.toAmino(message.lastCommit)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
