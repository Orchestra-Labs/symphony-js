...
exports.GenericAuthorization = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GenericAuthorization.typeUrl || typeof o.msg === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenericAuthorization.typeUrl || typeof o.msg === 'string'));
...
exports.Grant = {
    ...
    fromPartial(object) {
        ...
        message.authorization =
            object.authorization !== undefined && object.authorization !== null
                ? registry_1.GlobalDecoderRegistry.fromPartial(object.authorization)
                : undefined;
    ...
    toAmino(message) {
        ...
        obj.authorization = message.authorization
            ? registry_1.GlobalDecoderRegistry.toAminoMsg(message.authorization)
            : undefined;
        obj.expiration = message.expiration
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.expiration))
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GrantAuthorization = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GrantAuthorization.typeUrl ||
...
exports.GrantQueueItem = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GrantQueueItem.typeUrl ||
