...
exports.MsgGrant = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgGrant.typeUrl ||
                (typeof o.granter === 'string' &&
                    typeof o.grantee === 'string' &&
                    authz_1.Grant.is(o.grant))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgGrant.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.grant = message.grant
            ? authz_1.Grant.toAmino(message.grant)
            : authz_1.Grant.toAmino(authz_1.Grant.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.MsgExecResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgExecResponse.typeUrl ||
...
exports.MsgExec = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgExec.typeUrl ||
                (typeof o.grantee === 'string' &&
                    Array.isArray(o.msgs) &&
                    (!o.msgs.length || any_1.Any.is(o.msgs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgExec.typeUrl ||
                (typeof o.grantee === 'string' &&
                    Array.isArray(o.msgs) &&
                    (!o.msgs.length || any_1.Any.isSDK(o.msgs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgExec.typeUrl ||
                (typeof o.grantee === 'string' &&
                    Array.isArray(o.msgs) &&
                    (!o.msgs.length || any_1.Any.isAmino(o.msgs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.grantee !== '') {
    ...
    fromPartial(object) {
        ...
        message.grantee = object.grantee ?? '';
        message.msgs =
            object.msgs?.map(e => registry_1.GlobalDecoderRegistry.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseMsgExec();
        ...
        message.msgs =
            object.msgs?.map(e => registry_1.GlobalDecoderRegistry.fromAminoMsg(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.MsgRevoke = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgRevoke.typeUrl ||
                (typeof o.granter === 'string' &&
                    typeof o.grantee === 'string' &&
