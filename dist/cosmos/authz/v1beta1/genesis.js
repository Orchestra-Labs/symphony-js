...
exports.GenesisState = {
            ...
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.authorization) &&
                    (!o.authorization.length ||
                        authz_1.GrantAuthorization.is(o.authorization[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.authorization) &&
                    (!o.authorization.length ||
                        authz_1.GrantAuthorization.isSDK(o.authorization[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.authorization) &&
                    (!o.authorization.length ||
                        authz_1.GrantAuthorization.isAmino(o.authorization[0])))));
    },
    ...
    fromPartial(object) {
        ...
        message.authorization =
            object.authorization?.map(e => authz_1.GrantAuthorization.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseGenesisState();
        message.authorization =
            object.authorization?.map(e => authz_1.GrantAuthorization.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
