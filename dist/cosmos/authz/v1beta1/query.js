...
exports.QueryGrantsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGrantsRequest.typeUrl ||
...
exports.QueryGrantsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.Grant.is(o.grants[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.Grant.isSDK(o.grants[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.Grant.isAmino(o.grants[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryGranterGrantsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGranterGrantsRequest.typeUrl ||
                typeof o.granter === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryGranterGrantsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGranterGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.GrantAuthorization.is(o.grants[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGranterGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.GrantAuthorization.isSDK(o.grants[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGranterGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.GrantAuthorization.isAmino(o.grants[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        for (const v of message.grants) {
    ...
    fromPartial(object) {
        const message = createBaseQueryGranterGrantsResponse();
        message.grants =
            object.grants?.map(e => authz_1.GrantAuthorization.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
    ...
    fromAmino(object) {
        const message = createBaseQueryGranterGrantsResponse();
        message.grants =
            object.grants?.map(e => authz_1.GrantAuthorization.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
        return message;
...
exports.QueryGranteeGrantsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGranteeGrantsRequest.typeUrl ||
                typeof o.grantee === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryGranteeGrantsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGranteeGrantsResponse.typeUrl ||
                (Array.isArray(o.grants) &&
                    (!o.grants.length || authz_1.GrantAuthorization.is(o.grants[0])))));
    },
    isSDK(o) {
