...
exports.LegacyAminoPubKey = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LegacyAminoPubKey.typeUrl ||
                (typeof o.threshold === 'number' &&
                    Array.isArray(o.publicKeys) &&
                    (!o.publicKeys.length || any_1.Any.is(o.publicKeys[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.LegacyAminoPubKey.typeUrl ||
                (typeof o.threshold === 'number' &&
                    ...
                    (!o.public_keys.length || any_1.Any.isSDK(o.public_keys[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.LegacyAminoPubKey.typeUrl ||
                (typeof o.threshold === 'number' &&
                    Array.isArray(o.public_keys) &&
                    (!o.public_keys.length || any_1.Any.isAmino(o.public_keys[0])))));
    },
