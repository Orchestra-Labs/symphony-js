...
exports.ModuleDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleDescriptor.typeUrl ||
                (typeof o.goImport === 'string' &&
                    Array.isArray(o.usePackage) &&
                    (!o.usePackage.length || exports.PackageReference.is(o.usePackage[0])) &&
                    Array.isArray(o.canMigrateFrom) &&
                    (!o.canMigrateFrom.length ||
                        exports.MigrateFromInfo.is(o.canMigrateFrom[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleDescriptor.typeUrl ||
                (typeof o.go_import === 'string' &&
                    ...
                    (!o.use_package.length || exports.PackageReference.isSDK(o.use_package[0])) &&
                    Array.isArray(o.can_migrate_from) &&
                    (!o.can_migrate_from.length ||
                        exports.MigrateFromInfo.isSDK(o.can_migrate_from[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleDescriptor.typeUrl ||
                (typeof o.go_import === 'string' &&
                    ...
                    (!o.use_package.length ||
                        exports.PackageReference.isAmino(o.use_package[0])) &&
                    Array.isArray(o.can_migrate_from) &&
                    (!o.can_migrate_from.length ||
                        exports.MigrateFromInfo.isAmino(o.can_migrate_from[0])))));
    },
    ...
    fromAmino(object) {
        ...
        message.usePackage =
            object.use_package?.map(e => exports.PackageReference.fromAmino(e)) || [];
        message.canMigrateFrom =
            object.can_migrate_from?.map(e => exports.MigrateFromInfo.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.PackageReference = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.PackageReference.typeUrl ||
...
exports.MigrateFromInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MigrateFromInfo.typeUrl || typeof o.module === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MigrateFromInfo.typeUrl || typeof o.module === 'string'));
