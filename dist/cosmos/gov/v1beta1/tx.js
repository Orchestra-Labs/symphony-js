...
exports.MsgSubmitProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSubmitProposal.typeUrl ||
                (Array.isArray(o.initialDeposit) &&
                    (!o.initialDeposit.length || coin_1.Coin.is(o.initialDeposit[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.MsgSubmitProposal.typeUrl ||
                (Array.isArray(o.initial_deposit) &&
                    (!o.initial_deposit.length || coin_1.Coin.isSDK(o.initial_deposit[0])) &&
                    typeof o.proposer === 'string')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSubmitProposal.typeUrl ||
                (Array.isArray(o.initial_deposit) &&
                    (!o.initial_deposit.length || coin_1.Coin.isAmino(o.initial_deposit[0])) &&
                    typeof o.proposer === 'string')));
    },
    ...
    fromPartial(object) {
        ...
        message.initialDeposit =
            object.initialDeposit?.map(e => coin_1.Coin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.initialDeposit =
            object.initial_deposit?.map(e => coin_1.Coin.fromAmino(e)) || [];
...
exports.MsgSubmitProposalResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSubmitProposalResponse.typeUrl ||
...
exports.MsgVote = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgVote.typeUrl ||
                (typeof o.proposalId === 'bigint' &&
...
exports.MsgVoteWeighted = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgVoteWeighted.typeUrl ||
                (typeof o.proposalId === 'bigint' &&
                    typeof o.voter === 'string' &&
                    Array.isArray(o.options) &&
                    (!o.options.length || gov_1.WeightedVoteOption.is(o.options[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgVoteWeighted.typeUrl ||
                (typeof o.proposal_id === 'bigint' &&
                    typeof o.voter === 'string' &&
                    Array.isArray(o.options) &&
                    (!o.options.length || gov_1.WeightedVoteOption.isSDK(o.options[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgVoteWeighted.typeUrl ||
                (typeof o.proposal_id === 'bigint' &&
                    typeof o.voter === 'string' &&
                    Array.isArray(o.options) &&
                    (!o.options.length || gov_1.WeightedVoteOption.isAmino(o.options[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
    ...
    fromPartial(object) {
        ...
        message.voter = object.voter ?? '';
        message.options =
            object.options?.map(e => gov_1.WeightedVoteOption.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseMsgVoteWeighted();
        ...
        message.options =
            object.options?.map(e => gov_1.WeightedVoteOption.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.MsgDeposit = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgDeposit.typeUrl ||
                (typeof o.proposalId === 'bigint' &&
