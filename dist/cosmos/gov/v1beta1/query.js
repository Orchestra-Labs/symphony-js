...
exports.QueryProposalRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalRequest.typeUrl ||
...
exports.QueryProposalResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalResponse.typeUrl || gov_1.Proposal.is(o.proposal)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalResponse.typeUrl ||
                gov_1.Proposal.isSDK(o.proposal)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalResponse.typeUrl ||
                gov_1.Proposal.isAmino(o.proposal)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.proposal = message.proposal
            ? gov_1.Proposal.toAmino(message.proposal)
            : gov_1.Proposal.toAmino(gov_1.Proposal.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryProposalsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalsRequest.typeUrl ||
                ((0, helpers_1.isSet)(o.proposalStatus) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalsRequest.typeUrl ||
                ((0, helpers_1.isSet)(o.proposal_status) &&
                    typeof o.voter === 'string' &&
                    typeof o.depositor === 'string')));
    },
    isAmino(o) {
...
exports.QueryProposalsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalsResponse.typeUrl ||
                (Array.isArray(o.proposals) &&
                    (!o.proposals.length || gov_1.Proposal.is(o.proposals[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalsResponse.typeUrl ||
                (Array.isArray(o.proposals) &&
                    (!o.proposals.length || gov_1.Proposal.isSDK(o.proposals[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryProposalsResponse.typeUrl ||
                (Array.isArray(o.proposals) &&
                    (!o.proposals.length || gov_1.Proposal.isAmino(o.proposals[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryProposalsResponse();
        message.proposals =
            object.proposals?.map(e => gov_1.Proposal.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
...
exports.QueryVoteRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryVoteRequest.typeUrl ||
...
exports.QueryVoteResponse = {
    ...
    toAmino(message) {
        ...
        obj.vote = message.vote
            ? gov_1.Vote.toAmino(message.vote)
            : gov_1.Vote.toAmino(gov_1.Vote.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryVotesRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryVotesRequest.typeUrl ||
                typeof o.proposalId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryVotesResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryVotesResponse.typeUrl ||
                (Array.isArray(o.votes) && (!o.votes.length || gov_1.Vote.is(o.votes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryVotesResponse.typeUrl ||
                (Array.isArray(o.votes) && (!o.votes.length || gov_1.Vote.isSDK(o.votes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryVotesResponse.typeUrl ||
                (Array.isArray(o.votes) &&
                    (!o.votes.length || gov_1.Vote.isAmino(o.votes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryParamsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsRequest.typeUrl ||
...
exports.QueryParamsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl ||
                (gov_1.VotingParams.is(o.votingParams) &&
                    gov_1.DepositParams.is(o.depositParams) &&
                    gov_1.TallyParams.is(o.tallyParams))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl ||
                (gov_1.VotingParams.isSDK(o.voting_params) &&
                    gov_1.DepositParams.isSDK(o.deposit_params) &&
                    gov_1.TallyParams.isSDK(o.tally_params))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl ||
                (gov_1.VotingParams.isAmino(o.voting_params) &&
                    gov_1.DepositParams.isAmino(o.deposit_params) &&
                    gov_1.TallyParams.isAmino(o.tally_params))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.voting_params = message.votingParams
            ? gov_1.VotingParams.toAmino(message.votingParams)
            : gov_1.VotingParams.toAmino(gov_1.VotingParams.fromPartial({}));
        obj.deposit_params = message.depositParams
            ? gov_1.DepositParams.toAmino(message.depositParams)
            : gov_1.DepositParams.toAmino(gov_1.DepositParams.fromPartial({}));
        obj.tally_params = message.tallyParams
            ? gov_1.TallyParams.toAmino(message.tallyParams)
            : gov_1.TallyParams.toAmino(gov_1.TallyParams.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryDepositRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositRequest.typeUrl ||
...
exports.QueryDepositResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositResponse.typeUrl || gov_1.Deposit.is(o.deposit)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositResponse.typeUrl || gov_1.Deposit.isSDK(o.deposit)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositResponse.typeUrl ||
                gov_1.Deposit.isAmino(o.deposit)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.deposit = message.deposit
            ...
            : gov_1.Deposit.toAmino(gov_1.Deposit.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryDepositsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositsRequest.typeUrl ||
                typeof o.proposalId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDepositsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositsResponse.typeUrl ||
                (Array.isArray(o.deposits) &&
                    (!o.deposits.length || gov_1.Deposit.is(o.deposits[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositsResponse.typeUrl ||
                (Array.isArray(o.deposits) &&
                    (!o.deposits.length || gov_1.Deposit.isSDK(o.deposits[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDepositsResponse.typeUrl ||
                (Array.isArray(o.deposits) &&
                    (!o.deposits.length || gov_1.Deposit.isAmino(o.deposits[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryTallyResultRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTallyResultRequest.typeUrl ||
                typeof o.proposalId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryTallyResultResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTallyResultResponse.typeUrl ||
                gov_1.TallyResult.is(o.tally)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTallyResultResponse.typeUrl ||
                gov_1.TallyResult.isSDK(o.tally)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTallyResultResponse.typeUrl ||
                gov_1.TallyResult.isAmino(o.tally)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.tally = message.tally
            ? gov_1.TallyResult.toAmino(message.tally)
            : gov_1.TallyResult.toAmino(gov_1.TallyResult.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
