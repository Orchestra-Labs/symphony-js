...
exports.WeightedVoteOption = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.WeightedVoteOption.typeUrl ||
                ((0, helpers_1.isSet)(o.option) && typeof o.weight === 'string')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.WeightedVoteOption.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.weight !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.weight, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.TextProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TextProposal.typeUrl ||
...
exports.Deposit = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Deposit.typeUrl ||
                (typeof o.proposalId === 'bigint' &&
                    typeof o.depositor === 'string' &&
                    Array.isArray(o.amount) &&
                    (!o.amount.length || coin_1.Coin.is(o.amount[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Deposit.typeUrl ||
...
exports.Proposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Proposal.typeUrl ||
                (typeof o.proposalId === 'bigint' &&
                    (0, helpers_1.isSet)(o.status) &&
                    exports.TallyResult.is(o.finalTallyResult) &&
                    timestamp_1.Timestamp.is(o.submitTime) &&
                    timestamp_1.Timestamp.is(o.depositEndTime) &&
                    Array.isArray(o.totalDeposit) &&
                    (!o.totalDeposit.length || coin_1.Coin.is(o.totalDeposit[0])) &&
                    timestamp_1.Timestamp.is(o.votingStartTime) &&
                    timestamp_1.Timestamp.is(o.votingEndTime))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Proposal.typeUrl ||
                (typeof o.proposal_id === 'bigint' &&
                    (0, helpers_1.isSet)(o.status) &&
                    exports.TallyResult.isSDK(o.final_tally_result) &&
                    timestamp_1.Timestamp.isSDK(o.submit_time) &&
                    timestamp_1.Timestamp.isSDK(o.deposit_end_time) &&
                    Array.isArray(o.total_deposit) &&
                    (!o.total_deposit.length || coin_1.Coin.isSDK(o.total_deposit[0])) &&
                    timestamp_1.Timestamp.isSDK(o.voting_start_time) &&
                    timestamp_1.Timestamp.isSDK(o.voting_end_time))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Proposal.typeUrl ||
                (typeof o.proposal_id === 'bigint' &&
                    (0, helpers_1.isSet)(o.status) &&
                    exports.TallyResult.isAmino(o.final_tally_result) &&
                    timestamp_1.Timestamp.isAmino(o.submit_time) &&
                    timestamp_1.Timestamp.isAmino(o.deposit_end_time) &&
                    Array.isArray(o.total_deposit) &&
                    (!o.total_deposit.length || coin_1.Coin.isAmino(o.total_deposit[0])) &&
                    timestamp_1.Timestamp.isAmino(o.voting_start_time) &&
                    timestamp_1.Timestamp.isAmino(o.voting_end_time))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
    ...
    fromPartial(object) {
        ...
        message.content =
            object.content !== undefined && object.content !== null
                ? registry_1.GlobalDecoderRegistry.fromPartial(object.content)
                : undefined;
        ...
        message.totalDeposit =
            object.totalDeposit?.map(e => coin_1.Coin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.totalDeposit =
            object.total_deposit?.map(e => coin_1.Coin.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        obj.content = message.content
            ? registry_1.GlobalDecoderRegistry.toAminoMsg(message.content)
            : undefined;
        obj.status = message.status === 0 ? undefined : message.status;
        obj.final_tally_result = message.finalTallyResult
            ? exports.TallyResult.toAmino(message.finalTallyResult)
            : exports.TallyResult.toAmino(exports.TallyResult.fromPartial({}));
        obj.submit_time = message.submitTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.submitTime))
            : new Date();
        obj.deposit_end_time = message.depositEndTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.depositEndTime))
            : new Date();
        ...
        obj.voting_start_time = message.votingStartTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.votingStartTime))
            : new Date();
        obj.voting_end_time = message.votingEndTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.votingEndTime))
            : new Date();
        return obj;
    },
    fromAminoMsg(object) {
...
exports.TallyResult = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TallyResult.typeUrl ||
                (typeof o.yes === 'string' &&
...
exports.Vote = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Vote.typeUrl ||
                (typeof o.proposalId === 'bigint' &&
                    typeof o.voter === 'string' &&
                    (0, helpers_1.isSet)(o.option) &&
                    Array.isArray(o.options) &&
                    (!o.options.length || exports.WeightedVoteOption.is(o.options[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Vote.typeUrl ||
                (typeof o.proposal_id === 'bigint' &&
                    ...
                    (0, helpers_1.isSet)(o.option) &&
                    Array.isArray(o.options) &&
                    (!o.options.length || exports.WeightedVoteOption.isSDK(o.options[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Vote.typeUrl ||
                (typeof o.proposal_id === 'bigint' &&
                    ...
                    (0, helpers_1.isSet)(o.option) &&
                    Array.isArray(o.options) &&
                    (!o.options.length || exports.WeightedVoteOption.isAmino(o.options[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.proposalId !== BigInt(0)) {
            writer.uint32(8).uint64(message.proposalId);
    ...
    fromPartial(object) {
        ...
        message.option = object.option ?? 0;
        message.options =
            object.options?.map(e => exports.WeightedVoteOption.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseVote();
        ...
        message.options =
            object.options?.map(e => exports.WeightedVoteOption.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.DepositParams = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DepositParams.typeUrl ||
                (Array.isArray(o.minDeposit) &&
                    (!o.minDeposit.length || coin_1.Coin.is(o.minDeposit[0])) &&
                    duration_1.Duration.is(o.maxDepositPeriod))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DepositParams.typeUrl ||
                (Array.isArray(o.min_deposit) &&
                    (!o.min_deposit.length || coin_1.Coin.isSDK(o.min_deposit[0])) &&
                    duration_1.Duration.isSDK(o.max_deposit_period))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DepositParams.typeUrl ||
                (Array.isArray(o.min_deposit) &&
                    (!o.min_deposit.length || coin_1.Coin.isAmino(o.min_deposit[0])) &&
                    duration_1.Duration.isAmino(o.max_deposit_period))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.max_deposit_period = message.maxDepositPeriod
            ? duration_1.Duration.toAmino(message.maxDepositPeriod)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.VotingParams = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.VotingParams.typeUrl || duration_1.Duration.isSDK(o.voting_period)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.VotingParams.typeUrl || duration_1.Duration.isAmino(o.voting_period)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.voting_period = message.votingPeriod
            ? duration_1.Duration.toAmino(message.votingPeriod)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.TallyParams = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TallyParams.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.veto_threshold = message.vetoThreshold
            ? (0, helpers_1.base64FromBytes)(message.vetoThreshold)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
