...
exports.GenesisState = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (bank_1.Params.is(o.params) &&
                    Array.isArray(o.balances) &&
                    (!o.balances.length || exports.Balance.is(o.balances[0])) &&
                    Array.isArray(o.supply) &&
                    (!o.supply.length || coin_1.Coin.is(o.supply[0])) &&
                    Array.isArray(o.denomMetadata) &&
                    (!o.denomMetadata.length || bank_1.Metadata.is(o.denomMetadata[0])) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (bank_1.Params.isSDK(o.params) &&
                    Array.isArray(o.balances) &&
                    (!o.balances.length || exports.Balance.isSDK(o.balances[0])) &&
                    Array.isArray(o.supply) &&
                    (!o.supply.length || coin_1.Coin.isSDK(o.supply[0])) &&
                    Array.isArray(o.denom_metadata) &&
                    (!o.denom_metadata.length || bank_1.Metadata.isSDK(o.denom_metadata[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (bank_1.Params.isAmino(o.params) &&
                    Array.isArray(o.balances) &&
                    (!o.balances.length || exports.Balance.isAmino(o.balances[0])) &&
                    Array.isArray(o.supply) &&
                    (!o.supply.length || coin_1.Coin.isAmino(o.supply[0])) &&
                    Array.isArray(o.denom_metadata) &&
                    (!o.denom_metadata.length || bank_1.Metadata.isAmino(o.denom_metadata[0])) &&
                    Array.isArray(o.send_enabled) &&
    ...
    fromPartial(object) {
        ...
        message.denomMetadata =
            object.denomMetadata?.map(e => bank_1.Metadata.fromPartial(e)) || [];
        message.sendEnabled =
    ...
    fromAmino(object) {
        ...
        message.denomMetadata =
            object.denom_metadata?.map(e => bank_1.Metadata.fromAmino(e)) || [];
        message.sendEnabled =
...
exports.Balance = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Balance.typeUrl ||
