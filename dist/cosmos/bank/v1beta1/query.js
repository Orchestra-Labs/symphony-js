...
exports.QueryBalanceRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryBalanceRequest.typeUrl ||
...
exports.QueryAllBalancesRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAllBalancesRequest.typeUrl ||
...
exports.QueryAllBalancesResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAllBalancesResponse.typeUrl ||
                (Array.isArray(o.balances) &&
                    (!o.balances.length || coin_1.Coin.is(o.balances[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAllBalancesResponse.typeUrl ||
                (Array.isArray(o.balances) &&
                    (!o.balances.length || coin_1.Coin.isSDK(o.balances[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAllBalancesResponse.typeUrl ||
                (Array.isArray(o.balances) &&
                    (!o.balances.length || coin_1.Coin.isAmino(o.balances[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QuerySpendableBalancesRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySpendableBalancesRequest.typeUrl ||
                typeof o.address === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QuerySpendableBalancesResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySpendableBalancesResponse.typeUrl ||
                (Array.isArray(o.balances) &&
                    (!o.balances.length || coin_1.Coin.is(o.balances[0])))));
    },
    isSDK(o) {
...
exports.QuerySpendableBalanceByDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySpendableBalanceByDenomRequest.typeUrl ||
                (typeof o.address === 'string' && typeof o.denom === 'string')));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryTotalSupplyResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalSupplyResponse.typeUrl ||
                (Array.isArray(o.supply) && (!o.supply.length || coin_1.Coin.is(o.supply[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalSupplyResponse.typeUrl ||
                (Array.isArray(o.supply) &&
                    (!o.supply.length || coin_1.Coin.isSDK(o.supply[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalSupplyResponse.typeUrl ||
                (Array.isArray(o.supply) &&
                    (!o.supply.length || coin_1.Coin.isAmino(o.supply[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QuerySupplyOfRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySupplyOfRequest.typeUrl ||
...
exports.QuerySupplyOfResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySupplyOfResponse.typeUrl || coin_1.Coin.isSDK(o.amount)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySupplyOfResponse.typeUrl || coin_1.Coin.isAmino(o.amount)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.amount = message.amount
            ? coin_1.Coin.toAmino(message.amount)
            : coin_1.Coin.toAmino(coin_1.Coin.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryTotalSupplyWithoutOffsetRequest = {
    ...
    is(o) {
        return o && o.$typeUrl === exports.QueryTotalSupplyWithoutOffsetRequest.typeUrl;
    },
    isSDK(o) {
        return o && o.$typeUrl === exports.QueryTotalSupplyWithoutOffsetRequest.typeUrl;
    },
    ...
    fromAminoMsg(object) {
        return exports.QueryTotalSupplyWithoutOffsetRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: 'cosmos-sdk/QueryTotalSupplyWithoutOffsetRequest',
            value: exports.QueryTotalSupplyWithoutOffsetRequest.toAmino(message),
        };
    },
    fromProtoMsg(message) {
        return exports.QueryTotalSupplyWithoutOffsetRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryTotalSupplyWithoutOffsetRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: '/cosmos.bank.v1beta1.QueryTotalSupplyWithoutOffsetRequest',
            value: exports.QueryTotalSupplyWithoutOffsetRequest.encode(message).finish(),
        };
    },
};
registry_1.GlobalDecoderRegistry.register(exports.QueryTotalSupplyWithoutOffsetRequest.typeUrl, exports.QueryTotalSupplyWithoutOffsetRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QueryTotalSupplyWithoutOffsetRequest.aminoType, exports.QueryTotalSupplyWithoutOffsetRequest.typeUrl);
...
exports.QueryTotalSupplyWithoutOffsetResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalSupplyWithoutOffsetResponse.typeUrl ||
                (Array.isArray(o.supply) && (!o.supply.length || coin_1.Coin.is(o.supply[0])))));
    },
    isSDK(o) {
        return (o &&
    ...
    fromAminoMsg(object) {
        return exports.QueryTotalSupplyWithoutOffsetResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: 'cosmos-sdk/QueryTotalSupplyWithoutOffsetResponse',
            value: exports.QueryTotalSupplyWithoutOffsetResponse.toAmino(message),
        };
    },
    fromProtoMsg(message) {
        return exports.QueryTotalSupplyWithoutOffsetResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryTotalSupplyWithoutOffsetResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: '/cosmos.bank.v1beta1.QueryTotalSupplyWithoutOffsetResponse',
            value: exports.QueryTotalSupplyWithoutOffsetResponse.encode(message).finish(),
        };
    },
};
registry_1.GlobalDecoderRegistry.register(exports.QueryTotalSupplyWithoutOffsetResponse.typeUrl, exports.QueryTotalSupplyWithoutOffsetResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QueryTotalSupplyWithoutOffsetResponse.aminoType, exports.QueryTotalSupplyWithoutOffsetResponse.typeUrl);
function createBaseQuerySupplyOfWithoutOffsetRequest() {
    return {
        denom: '',
    };
}
exports.QuerySupplyOfWithoutOffsetRequest = {
    typeUrl: '/cosmos.bank.v1beta1.QuerySupplyOfWithoutOffsetRequest',
    aminoType: 'cosmos-sdk/QuerySupplyOfWithoutOffsetRequest',
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySupplyOfWithoutOffsetRequest.typeUrl ||
                typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
    ...
    fromAminoMsg(object) {
        return exports.QuerySupplyOfWithoutOffsetRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: 'cosmos-sdk/QuerySupplyOfWithoutOffsetRequest',
            value: exports.QuerySupplyOfWithoutOffsetRequest.toAmino(message),
        };
    },
    fromProtoMsg(message) {
        return exports.QuerySupplyOfWithoutOffsetRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QuerySupplyOfWithoutOffsetRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: '/cosmos.bank.v1beta1.QuerySupplyOfWithoutOffsetRequest',
            value: exports.QuerySupplyOfWithoutOffsetRequest.encode(message).finish(),
        };
    },
};
registry_1.GlobalDecoderRegistry.register(exports.QuerySupplyOfWithoutOffsetRequest.typeUrl, exports.QuerySupplyOfWithoutOffsetRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QuerySupplyOfWithoutOffsetRequest.aminoType, exports.QuerySupplyOfWithoutOffsetRequest.typeUrl);
function createBaseQuerySupplyOfWithoutOffsetResponse() {
    return {
        amount: coin_1.Coin.fromPartial({}),
    };
}
exports.QuerySupplyOfWithoutOffsetResponse = {
    typeUrl: '/cosmos.bank.v1beta1.QuerySupplyOfWithoutOffsetResponse',
    aminoType: 'cosmos-sdk/QuerySupplyOfWithoutOffsetResponse',
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySupplyOfWithoutOffsetResponse.typeUrl ||
    ...
    fromAminoMsg(object) {
        return exports.QuerySupplyOfWithoutOffsetResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: 'cosmos-sdk/QuerySupplyOfWithoutOffsetResponse',
            value: exports.QuerySupplyOfWithoutOffsetResponse.toAmino(message),
        };
    },
    fromProtoMsg(message) {
        return exports.QuerySupplyOfWithoutOffsetResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QuerySupplyOfWithoutOffsetResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: '/cosmos.bank.v1beta1.QuerySupplyOfWithoutOffsetResponse',
            value: exports.QuerySupplyOfWithoutOffsetResponse.encode(message).finish(),
        };
    },
};
registry_1.GlobalDecoderRegistry.register(exports.QuerySupplyOfWithoutOffsetResponse.typeUrl, exports.QuerySupplyOfWithoutOffsetResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QuerySupplyOfWithoutOffsetResponse.aminoType, exports.QuerySupplyOfWithoutOffsetResponse.typeUrl);
...
exports.QueryParamsResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || bank_1.Params.isSDK(o.params)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || bank_1.Params.isAmino(o.params)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.params = message.params
            ? bank_1.Params.toAmino(message.params)
            : bank_1.Params.toAmino(bank_1.Params.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryDenomsMetadataResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomsMetadataResponse.typeUrl ||
                (Array.isArray(o.metadatas) &&
                    (!o.metadatas.length || bank_1.Metadata.is(o.metadatas[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomsMetadataResponse.typeUrl ||
                (Array.isArray(o.metadatas) &&
                    (!o.metadatas.length || bank_1.Metadata.isSDK(o.metadatas[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomsMetadataResponse.typeUrl ||
                (Array.isArray(o.metadatas) &&
                    (!o.metadatas.length || bank_1.Metadata.isAmino(o.metadatas[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryDenomsMetadataResponse();
        message.metadatas =
            object.metadatas?.map(e => bank_1.Metadata.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
...
exports.QueryDenomMetadataRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomMetadataRequest.typeUrl ||
                typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDenomMetadataResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomMetadataResponse.typeUrl ||
                bank_1.Metadata.is(o.metadata)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomMetadataResponse.typeUrl ||
                bank_1.Metadata.isSDK(o.metadata)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomMetadataResponse.typeUrl ||
                bank_1.Metadata.isAmino(o.metadata)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.metadata = message.metadata
            ...
            : bank_1.Metadata.toAmino(bank_1.Metadata.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryDenomOwnersRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomOwnersRequest.typeUrl ||
                typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.DenomOwner = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DenomOwner.typeUrl ||
                (typeof o.address === 'string' && coin_1.Coin.is(o.balance))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DenomOwner.typeUrl ||
                (typeof o.address === 'string' && coin_1.Coin.isSDK(o.balance))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DenomOwner.typeUrl ||
                (typeof o.address === 'string' && coin_1.Coin.isAmino(o.balance))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.address !== '') {
            writer.uint32(10).string(message.address);
    ...
    toAmino(message) {
        ...
        obj.balance = message.balance
            ? coin_1.Coin.toAmino(message.balance)
            : coin_1.Coin.toAmino(coin_1.Coin.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryDenomOwnersResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomOwnersResponse.typeUrl ||
                (Array.isArray(o.denomOwners) &&
                    (!o.denomOwners.length || exports.DenomOwner.is(o.denomOwners[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomOwnersResponse.typeUrl ||
                (Array.isArray(o.denom_owners) &&
                    (!o.denom_owners.length || exports.DenomOwner.isSDK(o.denom_owners[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomOwnersResponse.typeUrl ||
                (Array.isArray(o.denom_owners) &&
                    (!o.denom_owners.length || exports.DenomOwner.isAmino(o.denom_owners[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryDenomOwnersResponse();
        message.denomOwners =
            object.denomOwners?.map(e => exports.DenomOwner.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
    ...
    fromAmino(object) {
        const message = createBaseQueryDenomOwnersResponse();
        message.denomOwners =
            object.denom_owners?.map(e => exports.DenomOwner.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
        return message;
...
exports.QuerySendEnabledRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySendEnabledRequest.typeUrl ||
...
exports.QuerySendEnabledResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySendEnabledResponse.typeUrl ||
                (Array.isArray(o.sendEnabled) &&
                    (!o.sendEnabled.length || bank_1.SendEnabled.is(o.sendEnabled[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySendEnabledResponse.typeUrl ||
                (Array.isArray(o.send_enabled) &&
                    (!o.send_enabled.length || bank_1.SendEnabled.isSDK(o.send_enabled[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QuerySendEnabledResponse.typeUrl ||
                (Array.isArray(o.send_enabled) &&
                    (!o.send_enabled.length || bank_1.SendEnabled.isAmino(o.send_enabled[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQuerySendEnabledResponse();
        message.sendEnabled =
            object.sendEnabled?.map(e => bank_1.SendEnabled.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
    ...
    fromAmino(object) {
        const message = createBaseQuerySendEnabledResponse();
        message.sendEnabled =
            object.send_enabled?.map(e => bank_1.SendEnabled.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
        return message;
