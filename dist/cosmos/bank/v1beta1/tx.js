...
exports.MsgSend = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSend.typeUrl ||
...
exports.MsgMultiSend = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgMultiSend.typeUrl ||
                (Array.isArray(o.inputs) &&
                    (!o.inputs.length || bank_1.Input.is(o.inputs[0])) &&
                    Array.isArray(o.outputs) &&
                    (!o.outputs.length || bank_1.Output.is(o.outputs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgMultiSend.typeUrl ||
                (Array.isArray(o.inputs) &&
                    (!o.inputs.length || bank_1.Input.isSDK(o.inputs[0])) &&
                    Array.isArray(o.outputs) &&
                    (!o.outputs.length || bank_1.Output.isSDK(o.outputs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgMultiSend.typeUrl ||
                (Array.isArray(o.inputs) &&
                    (!o.inputs.length || bank_1.Input.isAmino(o.inputs[0])) &&
                    Array.isArray(o.outputs) &&
                    (!o.outputs.length || bank_1.Output.isAmino(o.outputs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && bank_1.Params.is(o.params))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && bank_1.Params.isSDK(o.params))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && bank_1.Params.isAmino(o.params))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.MsgSetSendEnabled = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSetSendEnabled.typeUrl ||
