...
exports.SendAuthorization = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SendAuthorization.typeUrl ||
                (Array.isArray(o.spendLimit) &&
                    (!o.spendLimit.length || coin_1.Coin.is(o.spendLimit[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.SendAuthorization.typeUrl ||
                (Array.isArray(o.spend_limit) &&
                    (!o.spend_limit.length || coin_1.Coin.isSDK(o.spend_limit[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.SendAuthorization.typeUrl ||
                (Array.isArray(o.spend_limit) &&
                    (!o.spend_limit.length || coin_1.Coin.isAmino(o.spend_limit[0])) &&
                    Array.isArray(o.allow_list) &&
                    (!o.allow_list.length || typeof o.allow_list[0] === 'string'))));
    },
