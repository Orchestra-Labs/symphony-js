...
exports.Params = {
        ...
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (Array.isArray(o.sendEnabled) &&
                    (!o.sendEnabled.length || exports.SendEnabled.is(o.sendEnabled[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (Array.isArray(o.send_enabled) &&
                    (!o.send_enabled.length || exports.SendEnabled.isSDK(o.send_enabled[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (Array.isArray(o.send_enabled) &&
                    (!o.send_enabled.length || exports.SendEnabled.isAmino(o.send_enabled[0])) &&
                    typeof o.default_send_enabled === 'boolean')));
    },
    ...
    fromPartial(object) {
        const message = createBaseParams();
        message.sendEnabled =
            object.sendEnabled?.map(e => exports.SendEnabled.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        const message = createBaseParams();
        message.sendEnabled =
            object.send_enabled?.map(e => exports.SendEnabled.fromAmino(e)) || [];
...
exports.SendEnabled = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SendEnabled.typeUrl ||
...
exports.Input = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Input.typeUrl ||
...
exports.Output = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Output.typeUrl ||
                (typeof o.address === 'string' &&
                    Array.isArray(o.coins) &&
                    (!o.coins.length || coin_1.Coin.is(o.coins[0])))));
    },
...
exports.Supply = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Supply.typeUrl ||
                (Array.isArray(o.total) && (!o.total.length || coin_1.Coin.is(o.total[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Supply.typeUrl ||
                (Array.isArray(o.total) && (!o.total.length || coin_1.Coin.isSDK(o.total[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Supply.typeUrl ||
                (Array.isArray(o.total) &&
                    (!o.total.length || coin_1.Coin.isAmino(o.total[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.DenomUnit = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DenomUnit.typeUrl ||
...
exports.Metadata = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Metadata.typeUrl ||
                (typeof o.description === 'string' &&
                    Array.isArray(o.denomUnits) &&
                    (!o.denomUnits.length || exports.DenomUnit.is(o.denomUnits[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Metadata.typeUrl ||
                (typeof o.description === 'string' &&
                    ...
                    (!o.denom_units.length || exports.DenomUnit.isSDK(o.denom_units[0])) &&
                    typeof o.base === 'string' &&
                    typeof o.display === 'string' &&
                    typeof o.name === 'string' &&
                    typeof o.symbol === 'string' &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Metadata.typeUrl ||
                (typeof o.description === 'string' &&
                    Array.isArray(o.denom_units) &&
                    (!o.denom_units.length || exports.DenomUnit.isAmino(o.denom_units[0])) &&
                    typeof o.base === 'string' &&
                    typeof o.display === 'string' &&
                    typeof o.name === 'string' &&
                    typeof o.symbol === 'string' &&
    ...
    fromPartial(object) {
        ...
        message.denomUnits =
            object.denomUnits?.map(e => exports.DenomUnit.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.denomUnits =
            object.denom_units?.map(e => exports.DenomUnit.fromAmino(e)) || [];
