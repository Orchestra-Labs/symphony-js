...
exports.StakeAuthorization = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.StakeAuthorization.typeUrl || (0, helpers_1.isSet)(o.authorizationType)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.StakeAuthorization.typeUrl || (0, helpers_1.isSet)(o.authorization_type)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.StakeAuthorization.typeUrl || (0, helpers_1.isSet)(o.authorization_type)));
    ...
    toAmino(message) {
        ...
        obj.max_tokens = message.maxTokens
            ? coin_1.Coin.toAmino(message.maxTokens)
            : undefined;
        obj.allow_list = message.allowList
            ? exports.StakeAuthorization_Validators.toAmino(message.allowList)
            : undefined;
        obj.deny_list = message.denyList
            ? exports.StakeAuthorization_Validators.toAmino(message.denyList)
            : undefined;
...
exports.StakeAuthorization_Validators = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.StakeAuthorization_Validators.typeUrl ||
