...
exports.QueryValidatorsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorsRequest.typeUrl ||
...
exports.QueryValidatorsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorsResponse.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || staking_1.Validator.is(o.validators[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorsResponse.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || staking_1.Validator.isSDK(o.validators[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorsResponse.typeUrl ||
                (Array.isArray(o.validators) &&
                    (!o.validators.length || staking_1.Validator.isAmino(o.validators[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryValidatorsResponse();
        message.validators =
            object.validators?.map(e => staking_1.Validator.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
    ...
    fromAmino(object) {
        const message = createBaseQueryValidatorsResponse();
        message.validators =
            object.validators?.map(e => staking_1.Validator.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryValidatorRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorRequest.typeUrl ||
...
exports.QueryValidatorResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorResponse.typeUrl ||
                staking_1.Validator.is(o.validator)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorResponse.typeUrl ||
                staking_1.Validator.isSDK(o.validator)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorResponse.typeUrl ||
                staking_1.Validator.isAmino(o.validator)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.validator = message.validator
            ? staking_1.Validator.toAmino(message.validator)
            : staking_1.Validator.toAmino(staking_1.Validator.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryValidatorDelegationsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDelegationsRequest.typeUrl ||
                typeof o.validatorAddr === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryValidatorDelegationsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDelegationsResponse.typeUrl ||
                (Array.isArray(o.delegationResponses) &&
                    (!o.delegationResponses.length ||
                        staking_1.DelegationResponse.is(o.delegationResponses[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDelegationsResponse.typeUrl ||
                (Array.isArray(o.delegation_responses) &&
                    (!o.delegation_responses.length ||
                        staking_1.DelegationResponse.isSDK(o.delegation_responses[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDelegationsResponse.typeUrl ||
                (Array.isArray(o.delegation_responses) &&
                    (!o.delegation_responses.length ||
                        staking_1.DelegationResponse.isAmino(o.delegation_responses[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryValidatorDelegationsResponse();
        message.delegationResponses =
            object.delegation_responses?.map(e => staking_1.DelegationResponse.fromAmino(e)) ||
                [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
...
exports.QueryValidatorUnbondingDelegationsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorUnbondingDelegationsRequest.typeUrl ||
                typeof o.validatorAddr === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryValidatorUnbondingDelegationsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorUnbondingDelegationsResponse.typeUrl ||
                (Array.isArray(o.unbondingResponses) &&
                    (!o.unbondingResponses.length ||
                        staking_1.UnbondingDelegation.is(o.unbondingResponses[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorUnbondingDelegationsResponse.typeUrl ||
                (Array.isArray(o.unbonding_responses) &&
                    (!o.unbonding_responses.length ||
                        staking_1.UnbondingDelegation.isSDK(o.unbonding_responses[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorUnbondingDelegationsResponse.typeUrl ||
                (Array.isArray(o.unbonding_responses) &&
                    (!o.unbonding_responses.length ||
                        staking_1.UnbondingDelegation.isAmino(o.unbonding_responses[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryValidatorUnbondingDelegationsResponse();
        message.unbondingResponses =
            object.unbonding_responses?.map(e => staking_1.UnbondingDelegation.fromAmino(e)) ||
                [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
...
exports.QueryDelegationRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationRequest.typeUrl ||
...
exports.QueryDelegationResponse = {
    ...
    toAmino(message) {
        ...
        obj.delegation_response = message.delegationResponse
            ? staking_1.DelegationResponse.toAmino(message.delegationResponse)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryUnbondingDelegationRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUnbondingDelegationRequest.typeUrl ||
                (typeof o.delegatorAddr === 'string' &&
                    typeof o.validatorAddr === 'string')));
    },
    isSDK(o) {
...
exports.QueryUnbondingDelegationResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUnbondingDelegationResponse.typeUrl ||
                staking_1.UnbondingDelegation.is(o.unbond)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUnbondingDelegationResponse.typeUrl ||
                staking_1.UnbondingDelegation.isSDK(o.unbond)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUnbondingDelegationResponse.typeUrl ||
                staking_1.UnbondingDelegation.isAmino(o.unbond)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.unbond = message.unbond
            ? staking_1.UnbondingDelegation.toAmino(message.unbond)
            : staking_1.UnbondingDelegation.toAmino(staking_1.UnbondingDelegation.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryDelegatorDelegationsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorDelegationsRequest.typeUrl ||
                typeof o.delegatorAddr === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDelegatorDelegationsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorDelegationsResponse.typeUrl ||
                (Array.isArray(o.delegationResponses) &&
                    (!o.delegationResponses.length ||
                        staking_1.DelegationResponse.is(o.delegationResponses[0])))));
    },
...
exports.QueryDelegatorUnbondingDelegationsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorUnbondingDelegationsRequest.typeUrl ||
                typeof o.delegatorAddr === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDelegatorUnbondingDelegationsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorUnbondingDelegationsResponse.typeUrl ||
                (Array.isArray(o.unbondingResponses) &&
                    (!o.unbondingResponses.length ||
                        staking_1.UnbondingDelegation.is(o.unbondingResponses[0])))));
    },
...
exports.QueryRedelegationsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRedelegationsRequest.typeUrl ||
                (typeof o.delegatorAddr === 'string' &&
...
exports.QueryRedelegationsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRedelegationsResponse.typeUrl ||
                (Array.isArray(o.redelegationResponses) &&
                    (!o.redelegationResponses.length ||
                        staking_1.RedelegationResponse.is(o.redelegationResponses[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRedelegationsResponse.typeUrl ||
                (Array.isArray(o.redelegation_responses) &&
                    (!o.redelegation_responses.length ||
                        staking_1.RedelegationResponse.isSDK(o.redelegation_responses[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRedelegationsResponse.typeUrl ||
                (Array.isArray(o.redelegation_responses) &&
                    (!o.redelegation_responses.length ||
                        staking_1.RedelegationResponse.isAmino(o.redelegation_responses[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryRedelegationsResponse();
        message.redelegationResponses =
            object.redelegation_responses?.map(e => staking_1.RedelegationResponse.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
        return message;
...
exports.QueryDelegatorValidatorRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorValidatorRequest.typeUrl ||
                (typeof o.delegatorAddr === 'string' &&
                    typeof o.validatorAddr === 'string')));
    },
    isSDK(o) {
...
exports.QueryDelegatorValidatorResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorValidatorResponse.typeUrl ||
                staking_1.Validator.is(o.validator)));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryHistoricalInfoRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryHistoricalInfoRequest.typeUrl ||
...
exports.QueryPoolResponse = {
    ...
    toAmino(message) {
        ...
        obj.pool = message.pool
            ? staking_1.Pool.toAmino(message.pool)
            : staking_1.Pool.toAmino(staking_1.Pool.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryParamsResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || staking_1.Params.isSDK(o.params)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || staking_1.Params.isAmino(o.params)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.params = message.params
            ? staking_1.Params.toAmino(message.params)
            : staking_1.Params.toAmino(staking_1.Params.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
