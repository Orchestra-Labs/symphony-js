...
exports.GenesisState = {
            ...
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (staking_1.Params.is(o.params) &&
                    ...
                    (!o.lastValidatorPowers.length ||
                        exports.LastValidatorPower.is(o.lastValidatorPowers[0])) &&
                    Array.isArray(o.validators) &&
                    (!o.validators.length || staking_1.Validator.is(o.validators[0])) &&
                    Array.isArray(o.delegations) &&
                    (!o.delegations.length || staking_1.Delegation.is(o.delegations[0])) &&
                    Array.isArray(o.unbondingDelegations) &&
                    (!o.unbondingDelegations.length ||
                        staking_1.UnbondingDelegation.is(o.unbondingDelegations[0])) &&
                    Array.isArray(o.redelegations) &&
                    (!o.redelegations.length || staking_1.Redelegation.is(o.redelegations[0])) &&
                    typeof o.exported === 'boolean')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (staking_1.Params.isSDK(o.params) &&
                    ...
                    (!o.last_validator_powers.length ||
                        exports.LastValidatorPower.isSDK(o.last_validator_powers[0])) &&
                    Array.isArray(o.validators) &&
                    (!o.validators.length || staking_1.Validator.isSDK(o.validators[0])) &&
                    Array.isArray(o.delegations) &&
                    (!o.delegations.length || staking_1.Delegation.isSDK(o.delegations[0])) &&
                    Array.isArray(o.unbonding_delegations) &&
                    (!o.unbonding_delegations.length ||
                        staking_1.UnbondingDelegation.isSDK(o.unbonding_delegations[0])) &&
                    Array.isArray(o.redelegations) &&
                    (!o.redelegations.length || staking_1.Redelegation.isSDK(o.redelegations[0])) &&
                    typeof o.exported === 'boolean')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (staking_1.Params.isAmino(o.params) &&
                    (o.last_total_power instanceof Uint8Array ||
                        typeof o.last_total_power === 'string') &&
                    Array.isArray(o.last_validator_powers) &&
                    (!o.last_validator_powers.length ||
                        exports.LastValidatorPower.isAmino(o.last_validator_powers[0])) &&
                    Array.isArray(o.validators) &&
                    (!o.validators.length || staking_1.Validator.isAmino(o.validators[0])) &&
                    Array.isArray(o.delegations) &&
                    (!o.delegations.length || staking_1.Delegation.isAmino(o.delegations[0])) &&
                    Array.isArray(o.unbonding_delegations) &&
                    (!o.unbonding_delegations.length ||
                        staking_1.UnbondingDelegation.isAmino(o.unbonding_delegations[0])) &&
                    Array.isArray(o.redelegations) &&
                    (!o.redelegations.length ||
                        staking_1.Redelegation.isAmino(o.redelegations[0])) &&
                    typeof o.exported === 'boolean')));
    },
    ...
    fromPartial(object) {
        ...
        message.delegations =
            object.delegations?.map(e => staking_1.Delegation.fromPartial(e)) || [];
        message.unbondingDelegations =
            object.unbondingDelegations?.map(e => staking_1.UnbondingDelegation.fromPartial(e)) || [];
        message.redelegations =
            object.redelegations?.map(e => staking_1.Redelegation.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.lastValidatorPowers =
            object.last_validator_powers?.map(e => exports.LastValidatorPower.fromAmino(e)) ||
                [];
        message.validators =
            object.validators?.map(e => staking_1.Validator.fromAmino(e)) || [];
        message.delegations =
            object.delegations?.map(e => staking_1.Delegation.fromAmino(e)) || [];
        message.unbondingDelegations =
            object.unbonding_delegations?.map(e => staking_1.UnbondingDelegation.fromAmino(e)) || [];
        message.redelegations =
            object.redelegations?.map(e => staking_1.Redelegation.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        obj.last_total_power = message.lastTotalPower
            ? (0, helpers_1.base64FromBytes)(message.lastTotalPower)
            : '';
...
exports.LastValidatorPower = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LastValidatorPower.typeUrl ||
