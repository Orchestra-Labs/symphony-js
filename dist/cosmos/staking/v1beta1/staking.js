...
exports.HistoricalInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.HistoricalInfo.typeUrl ||
                (types_1.Header.is(o.header) &&
                    Array.isArray(o.valset) &&
                    (!o.valset.length || exports.Validator.is(o.valset[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.HistoricalInfo.typeUrl ||
                (types_1.Header.isSDK(o.header) &&
                    Array.isArray(o.valset) &&
                    (!o.valset.length || exports.Validator.isSDK(o.valset[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.HistoricalInfo.typeUrl ||
                (types_1.Header.isAmino(o.header) &&
                    Array.isArray(o.valset) &&
                    (!o.valset.length || exports.Validator.isAmino(o.valset[0])))));
    },
    ...
    toAmino(message) {
        ...
        obj.header = message.header
            ? types_1.Header.toAmino(message.header)
            : types_1.Header.toAmino(types_1.Header.fromPartial({}));
        if (message.valset) {
...
exports.CommissionRates = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CommissionRates.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.maxRate !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.maxRate, 18).atomics);
        }
        if (message.maxChangeRate !== '') {
            writer
                .uint32(26)
                .string(math_1.Decimal.fromUserInput(message.maxChangeRate, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.Commission = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Commission.typeUrl ||
                (exports.CommissionRates.is(o.commissionRates) && timestamp_1.Timestamp.is(o.updateTime))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Commission.typeUrl ||
                (exports.CommissionRates.isSDK(o.commission_rates) &&
                    timestamp_1.Timestamp.isSDK(o.update_time))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Commission.typeUrl ||
                (exports.CommissionRates.isAmino(o.commission_rates) &&
                    timestamp_1.Timestamp.isAmino(o.update_time))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.commission_rates = message.commissionRates
            ? exports.CommissionRates.toAmino(message.commissionRates)
            : exports.CommissionRates.toAmino(exports.CommissionRates.fromPartial({}));
        obj.update_time = message.updateTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.updateTime))
            : new Date();
        return obj;
    },
    fromAminoMsg(object) {
...
exports.Description = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Description.typeUrl ||
...
exports.Validator = {
        ...
        return (o &&
            (o.$typeUrl === exports.Validator.typeUrl ||
                (typeof o.operatorAddress === 'string' &&
                    ...
                    (0, helpers_1.isSet)(o.status) &&
                    typeof o.tokens === 'string' &&
                    typeof o.delegatorShares === 'string' &&
                    exports.Description.is(o.description) &&
                    typeof o.unbondingHeight === 'bigint' &&
                    timestamp_1.Timestamp.is(o.unbondingTime) &&
                    exports.Commission.is(o.commission) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Validator.typeUrl ||
                (typeof o.operator_address === 'string' &&
                    ...
                    exports.Description.isSDK(o.description) &&
                    typeof o.unbonding_height === 'bigint' &&
                    timestamp_1.Timestamp.isSDK(o.unbonding_time) &&
                    exports.Commission.isSDK(o.commission) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Validator.typeUrl ||
                (typeof o.operator_address === 'string' &&
                    ...
                    typeof o.tokens === 'string' &&
                    typeof o.delegator_shares === 'string' &&
                    exports.Description.isAmino(o.description) &&
                    typeof o.unbonding_height === 'bigint' &&
                    timestamp_1.Timestamp.isAmino(o.unbonding_time) &&
                    exports.Commission.isAmino(o.commission) &&
                    typeof o.min_self_delegation === 'string' &&
                    typeof o.unbonding_on_hold_ref_count === 'bigint' &&
                    Array.isArray(o.unbonding_ids) &&
                    (!o.unbonding_ids.length || typeof o.unbonding_ids[0] === 'bigint'))));
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.delegatorShares !== '') {
            writer
                .uint32(50)
                .string(math_1.Decimal.fromUserInput(message.delegatorShares, 18).atomics);
        }
    ...
    fromPartial(object) {
        ...
        message.consensusPubkey =
            object.consensusPubkey !== undefined && object.consensusPubkey !== null
                ? registry_1.GlobalDecoderRegistry.fromPartial(object.consensusPubkey)
                : undefined;
    ...
    fromAmino(object) {
        ...
        if (object.unbonding_on_hold_ref_count !== undefined &&
    ...
    toAmino(message) {
        ...
        obj.consensus_pubkey = message.consensusPubkey
            ? (0, proto_signing_1.decodePubkey)(message.consensusPubkey)
            : undefined;
        ...
        obj.description = message.description
            ? exports.Description.toAmino(message.description)
            : exports.Description.toAmino(exports.Description.fromPartial({}));
        ...
        obj.unbonding_time = message.unbondingTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.unbondingTime))
            : new Date();
        obj.commission = message.commission
            ? exports.Commission.toAmino(message.commission)
            : exports.Commission.toAmino(exports.Commission.fromPartial({}));
...
exports.ValAddresses = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValAddresses.typeUrl ||
...
exports.DVPair = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DVPair.typeUrl ||
...
exports.DVPairs = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DVPairs.typeUrl ||
                (Array.isArray(o.pairs) && (!o.pairs.length || exports.DVPair.is(o.pairs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DVPairs.typeUrl ||
                (Array.isArray(o.pairs) &&
                    (!o.pairs.length || exports.DVPair.isSDK(o.pairs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DVPairs.typeUrl ||
                (Array.isArray(o.pairs) &&
                    (!o.pairs.length || exports.DVPair.isAmino(o.pairs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.DVVTriplet = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DVVTriplet.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
...
exports.DVVTriplets = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DVVTriplets.typeUrl ||
                (Array.isArray(o.triplets) &&
                    (!o.triplets.length || exports.DVVTriplet.is(o.triplets[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DVVTriplets.typeUrl ||
                (Array.isArray(o.triplets) &&
                    (!o.triplets.length || exports.DVVTriplet.isSDK(o.triplets[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DVVTriplets.typeUrl ||
                (Array.isArray(o.triplets) &&
                    (!o.triplets.length || exports.DVVTriplet.isAmino(o.triplets[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseDVVTriplets();
        message.triplets =
            object.triplets?.map(e => exports.DVVTriplet.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseDVVTriplets();
...
exports.Delegation = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Delegation.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.shares !== '') {
            writer
                .uint32(26)
                .string(math_1.Decimal.fromUserInput(message.shares, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.UnbondingDelegation = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.UnbondingDelegation.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.UnbondingDelegationEntry.is(o.entries[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.UnbondingDelegation.typeUrl ||
                (typeof o.delegator_address === 'string' &&
                    typeof o.validator_address === 'string' &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.UnbondingDelegationEntry.isSDK(o.entries[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.UnbondingDelegation.typeUrl ||
                (typeof o.delegator_address === 'string' &&
                    ...
                    Array.isArray(o.entries) &&
                    (!o.entries.length ||
                        exports.UnbondingDelegationEntry.isAmino(o.entries[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.delegatorAddress !== '') {
            writer.uint32(10).string(message.delegatorAddress);
    ...
    fromPartial(object) {
        ...
        message.validatorAddress = object.validatorAddress ?? '';
        message.entries =
            object.entries?.map(e => exports.UnbondingDelegationEntry.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseUnbondingDelegation();
        ...
        message.entries =
            object.entries?.map(e => exports.UnbondingDelegationEntry.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.UnbondingDelegationEntry = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.UnbondingDelegationEntry.typeUrl ||
                (typeof o.creationHeight === 'bigint' &&
                    timestamp_1.Timestamp.is(o.completionTime) &&
        ...
        return (o &&
            (o.$typeUrl === exports.UnbondingDelegationEntry.typeUrl ||
                (typeof o.creation_height === 'bigint' &&
                    timestamp_1.Timestamp.isSDK(o.completion_time) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.UnbondingDelegationEntry.typeUrl ||
                (typeof o.creation_height === 'bigint' &&
                    timestamp_1.Timestamp.isAmino(o.completion_time) &&
                    typeof o.initial_balance === 'string' &&
                    typeof o.balance === 'string' &&
                    typeof o.unbonding_id === 'bigint' &&
                    typeof o.unbonding_on_hold_ref_count === 'bigint')));
    ...
    toAmino(message) {
        ...
        obj.completion_time = message.completionTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.completionTime))
            : new Date();
        obj.initial_balance =
...
exports.RedelegationEntry = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationEntry.typeUrl ||
                (typeof o.creationHeight === 'bigint' &&
                    timestamp_1.Timestamp.is(o.completionTime) &&
                    typeof o.initialBalance === 'string' &&
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.sharesDst !== '') {
            writer
                .uint32(34)
                .string(math_1.Decimal.fromUserInput(message.sharesDst, 18).atomics);
        }
        if (message.unbondingId !== BigInt(0)) {
            writer.uint32(40).uint64(message.unbondingId);
        }
...
exports.Redelegation = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Redelegation.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorSrcAddress === 'string' &&
                    typeof o.validatorDstAddress === 'string' &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.RedelegationEntry.is(o.entries[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Redelegation.typeUrl ||
                (typeof o.delegator_address === 'string' &&
                    ...
                    typeof o.validator_dst_address === 'string' &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.RedelegationEntry.isSDK(o.entries[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Redelegation.typeUrl ||
                (typeof o.delegator_address === 'string' &&
                    ...
                    typeof o.validator_dst_address === 'string' &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.RedelegationEntry.isAmino(o.entries[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.delegatorAddress !== '') {
            writer.uint32(10).string(message.delegatorAddress);
    ...
    fromPartial(object) {
        ...
        message.validatorDstAddress = object.validatorDstAddress ?? '';
        message.entries =
            object.entries?.map(e => exports.RedelegationEntry.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseRedelegation();
        ...
        message.entries =
            object.entries?.map(e => exports.RedelegationEntry.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.Params = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (duration_1.Duration.is(o.unbondingTime) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (duration_1.Duration.isSDK(o.unbonding_time) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (duration_1.Duration.isAmino(o.unbonding_time) &&
                    typeof o.max_validators === 'number' &&
                    typeof o.max_entries === 'number' &&
                    typeof o.historical_entries === 'number' &&
                    typeof o.bond_denom === 'string' &&
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.minCommissionRate !== '') {
            writer
                .uint32(50)
                .string(math_1.Decimal.fromUserInput(message.minCommissionRate, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromAmino(object) {
        ...
        if (object.min_commission_rate !== undefined &&
    ...
    toAmino(message) {
        const obj = {};
        obj.unbonding_time = message.unbondingTime
            ? duration_1.Duration.toAmino(message.unbondingTime)
...
exports.DelegationResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DelegationResponse.typeUrl ||
                (exports.Delegation.is(o.delegation) && coin_1.Coin.is(o.balance))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DelegationResponse.typeUrl ||
                (exports.Delegation.isSDK(o.delegation) && coin_1.Coin.isSDK(o.balance))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DelegationResponse.typeUrl ||
                (exports.Delegation.isAmino(o.delegation) && coin_1.Coin.isAmino(o.balance))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.delegation = message.delegation
            ? exports.Delegation.toAmino(message.delegation)
            : exports.Delegation.toAmino(exports.Delegation.fromPartial({}));
...
exports.RedelegationEntryResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationEntryResponse.typeUrl ||
                (exports.RedelegationEntry.is(o.redelegationEntry) &&
                    typeof o.balance === 'string')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationEntryResponse.typeUrl ||
                (exports.RedelegationEntry.isSDK(o.redelegation_entry) &&
                    typeof o.balance === 'string')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationEntryResponse.typeUrl ||
                (exports.RedelegationEntry.isAmino(o.redelegation_entry) &&
                    typeof o.balance === 'string')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.redelegation_entry = message.redelegationEntry
            ? exports.RedelegationEntry.toAmino(message.redelegationEntry)
            : exports.RedelegationEntry.toAmino(exports.RedelegationEntry.fromPartial({}));
        obj.balance = message.balance === '' ? undefined : message.balance;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.RedelegationResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationResponse.typeUrl ||
                (exports.Redelegation.is(o.redelegation) &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.RedelegationEntryResponse.is(o.entries[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationResponse.typeUrl ||
                (exports.Redelegation.isSDK(o.redelegation) &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length || exports.RedelegationEntryResponse.isSDK(o.entries[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.RedelegationResponse.typeUrl ||
                (exports.Redelegation.isAmino(o.redelegation) &&
                    Array.isArray(o.entries) &&
                    (!o.entries.length ||
                        exports.RedelegationEntryResponse.isAmino(o.entries[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.redelegation =
            object.redelegation !== undefined && object.redelegation !== null
                ...
                : undefined;
        message.entries =
            object.entries?.map(e => exports.RedelegationEntryResponse.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseRedelegationResponse();
        ...
        message.entries =
            object.entries?.map(e => exports.RedelegationEntryResponse.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.redelegation = message.redelegation
            ? exports.Redelegation.toAmino(message.redelegation)
            : exports.Redelegation.toAmino(exports.Redelegation.fromPartial({}));
        if (message.entries) {
...
exports.ValidatorUpdates = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorUpdates.typeUrl ||
                (Array.isArray(o.updates) &&
                    (!o.updates.length || types_2.ValidatorUpdate.is(o.updates[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorUpdates.typeUrl ||
                (Array.isArray(o.updates) &&
                    (!o.updates.length || types_2.ValidatorUpdate.isSDK(o.updates[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorUpdates.typeUrl ||
                (Array.isArray(o.updates) &&
                    (!o.updates.length || types_2.ValidatorUpdate.isAmino(o.updates[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseValidatorUpdates();
        message.updates =
            object.updates?.map(e => types_2.ValidatorUpdate.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseValidatorUpdates();
        message.updates =
            object.updates?.map(e => types_2.ValidatorUpdate.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
