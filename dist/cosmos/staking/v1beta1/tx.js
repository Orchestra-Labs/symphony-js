...
exports.MsgCreateValidator = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateValidator.typeUrl ||
                (staking_1.Description.is(o.description) &&
                    staking_1.CommissionRates.is(o.commission) &&
                    typeof o.minSelfDelegation === 'string' &&
                    typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
                    coin_1.Coin.is(o.value))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateValidator.typeUrl ||
                (staking_1.Description.isSDK(o.description) &&
                    staking_1.CommissionRates.isSDK(o.commission) &&
                    typeof o.min_self_delegation === 'string' &&
                    typeof o.delegator_address === 'string' &&
                    typeof o.validator_address === 'string' &&
                    coin_1.Coin.isSDK(o.value))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateValidator.typeUrl ||
                (staking_1.Description.isAmino(o.description) &&
                    staking_1.CommissionRates.isAmino(o.commission) &&
                    typeof o.min_self_delegation === 'string' &&
                    typeof o.delegator_address === 'string' &&
                    typeof o.validator_address === 'string' &&
                    coin_1.Coin.isAmino(o.value))));
    },
    ...
    fromPartial(object) {
        ...
        message.pubkey =
            object.pubkey !== undefined && object.pubkey !== null
                ? registry_1.GlobalDecoderRegistry.fromPartial(object.pubkey)
                : undefined;
        message.value =
    ...
    toAmino(message) {
        ...
        obj.description = message.description
            ? staking_1.Description.toAmino(message.description)
            : staking_1.Description.toAmino(staking_1.Description.fromPartial({}));
        obj.commission = message.commission
            ? staking_1.CommissionRates.toAmino(message.commission)
            : staking_1.CommissionRates.toAmino(staking_1.CommissionRates.fromPartial({}));
        ...
        obj.value = message.value
            ? coin_1.Coin.toAmino(message.value)
...
exports.MsgEditValidator = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgEditValidator.typeUrl ||
                (staking_1.Description.is(o.description) &&
                    typeof o.validatorAddress === 'string' &&
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.commissionRate !== '') {
            writer
                .uint32(26)
                .string(math_1.Decimal.fromUserInput(message.commissionRate, 18).atomics);
        }
        if (message.minSelfDelegation !== '') {
...
exports.MsgDelegate = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgDelegate.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
...
exports.MsgBeginRedelegate = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgBeginRedelegate.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
...
exports.MsgBeginRedelegateResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgBeginRedelegateResponse.typeUrl ||
...
exports.MsgUndelegate = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUndelegate.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
                    coin_1.Coin.is(o.amount))));
    },
...
exports.MsgUndelegateResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUndelegateResponse.typeUrl ||
                timestamp_1.Timestamp.is(o.completionTime)));
    },
    isSDK(o) {
        return (o &&
...
exports.MsgCancelUnbondingDelegation = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCancelUnbondingDelegation.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
                    coin_1.Coin.is(o.amount) &&
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && staking_1.Params.is(o.params))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && staking_1.Params.isSDK(o.params))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && staking_1.Params.isAmino(o.params))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
