    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && auth_1.Params.is(o.params))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && auth_1.Params.isSDK(o.params))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && auth_1.Params.isAmino(o.params))));
    },
