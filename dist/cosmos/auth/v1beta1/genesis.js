...
exports.GenesisState = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (auth_1.Params.is(o.params) &&
                    Array.isArray(o.accounts) &&
                    (!o.accounts.length || any_1.Any.is(o.accounts[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (auth_1.Params.isSDK(o.params) &&
                    Array.isArray(o.accounts) &&
                    (!o.accounts.length || any_1.Any.isSDK(o.accounts[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (auth_1.Params.isAmino(o.params) &&
                    Array.isArray(o.accounts) &&
                    (!o.accounts.length || any_1.Any.isAmino(o.accounts[0])))));
    },
    ...
    toAmino(message) {
        ...
        obj.params = message.params
            ? auth_1.Params.toAmino(message.params)
            : auth_1.Params.toAmino(auth_1.Params.fromPartial({}));
        if (message.accounts) {
