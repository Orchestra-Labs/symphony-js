...
exports.QueryAccountsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        auth_1.BaseAccount.is(o.accounts[0]) ||
                        any_1.Any.is(o.accounts[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        auth_1.BaseAccount.isSDK(o.accounts[0]) ||
                        any_1.Any.isSDK(o.accounts[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        auth_1.BaseAccount.isAmino(o.accounts[0]) ||
                        any_1.Any.isAmino(o.accounts[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryAccountsResponse();
        message.accounts =
            object.accounts?.map(e => registry_1.GlobalDecoderRegistry.fromPartial(e)) ||
                [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
    ...
    fromAmino(object) {
        const message = createBaseQueryAccountsResponse();
        message.accounts =
            object.accounts?.map(e => registry_1.GlobalDecoderRegistry.fromAminoMsg(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryAccountRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountRequest.typeUrl ||
...
exports.QueryAccountResponse = {
    ...
    fromPartial(object) {
        ...
        message.account =
            object.account !== undefined && object.account !== null
                ? registry_1.GlobalDecoderRegistry.fromPartial(object.account)
                : undefined;
        return message;
    },
    fromAmino(object) {
    ...
    toAmino(message) {
        ...
        obj.account = message.account
            ? registry_1.GlobalDecoderRegistry.toAminoMsg(message.account)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryParamsResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || auth_1.Params.isSDK(o.params)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || auth_1.Params.isAmino(o.params)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryModuleAccountsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        auth_1.ModuleAccount.is(o.accounts[0]) ||
                        any_1.Any.is(o.accounts[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        auth_1.ModuleAccount.isSDK(o.accounts[0]) ||
                        any_1.Any.isSDK(o.accounts[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        auth_1.ModuleAccount.isAmino(o.accounts[0]) ||
                        any_1.Any.isAmino(o.accounts[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        for (const v of message.accounts) {
...
exports.QueryModuleAccountByNameRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleAccountByNameRequest.typeUrl ||
...
exports.Bech32PrefixResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Bech32PrefixResponse.typeUrl ||
...
exports.AddressBytesToStringRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AddressBytesToStringRequest.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.address_bytes = message.addressBytes
            ? (0, helpers_1.base64FromBytes)(message.addressBytes)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.AddressBytesToStringResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AddressBytesToStringResponse.typeUrl ||
...
exports.AddressStringToBytesRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AddressStringToBytesRequest.typeUrl ||
                typeof o.addressString === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.AddressStringToBytesResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AddressStringToBytesResponse.typeUrl ||
                o.addressBytes instanceof Uint8Array ||
                typeof o.addressBytes === 'string'));
    },
    isSDK(o) {
...
exports.QueryAccountAddressByIDRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountAddressByIDRequest.typeUrl ||
...
exports.QueryAccountAddressByIDResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountAddressByIDResponse.typeUrl ||
...
exports.QueryAccountInfoRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAccountInfoRequest.typeUrl ||
                typeof o.address === 'string'));
    },
    isSDK(o) {
        return (o &&
