...
exports.BaseAccount = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.BaseAccount.typeUrl ||
...
exports.ModuleAccount = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleAccount.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.base_account = message.baseAccount
            ? exports.BaseAccount.toAmino(message.baseAccount)
            : undefined;
...
exports.ModuleCredential = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleCredential.typeUrl ||
    ...
    fromAmino(object) {
        ...
        message.derivationKeys =
            object.derivation_keys?.map(e => (0, helpers_1.bytesFromBase64)(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
