...
exports.SignatureDescriptors = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptors.typeUrl ||
                (Array.isArray(o.signatures) &&
                    (!o.signatures.length || exports.SignatureDescriptor.is(o.signatures[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptors.typeUrl ||
                (Array.isArray(o.signatures) &&
                    (!o.signatures.length || exports.SignatureDescriptor.isSDK(o.signatures[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptors.typeUrl ||
                (Array.isArray(o.signatures) &&
                    (!o.signatures.length ||
                        exports.SignatureDescriptor.isAmino(o.signatures[0])))));
    },
    ...
    fromPartial(object) {
        const message = createBaseSignatureDescriptors();
        message.signatures =
            object.signatures?.map(e => exports.SignatureDescriptor.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseSignatureDescriptors();
        message.signatures =
            object.signatures?.map(e => exports.SignatureDescriptor.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.SignatureDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptor.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.data = message.data
            ? exports.SignatureDescriptor_Data.toAmino(message.data)
            : undefined;
        obj.sequence =
...
exports.SignatureDescriptor_Data = {
    ...
    toAmino(message) {
        ...
        obj.single = message.single
            ? exports.SignatureDescriptor_Data_Single.toAmino(message.single)
            : undefined;
        obj.multi = message.multi
            ? exports.SignatureDescriptor_Data_Multi.toAmino(message.multi)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.SignatureDescriptor_Data_Single = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptor_Data_Single.typeUrl ||
...
exports.SignatureDescriptor_Data_Multi = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptor_Data_Multi.typeUrl ||
                (Array.isArray(o.signatures) &&
                    (!o.signatures.length ||
                        exports.SignatureDescriptor_Data.is(o.signatures[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptor_Data_Multi.typeUrl ||
                (Array.isArray(o.signatures) &&
                    (!o.signatures.length ||
                        exports.SignatureDescriptor_Data.isSDK(o.signatures[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.SignatureDescriptor_Data_Multi.typeUrl ||
                (Array.isArray(o.signatures) &&
                    (!o.signatures.length ||
                        exports.SignatureDescriptor_Data.isAmino(o.signatures[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.bitarray =
            object.bitarray !== undefined && object.bitarray !== null
                ...
                : undefined;
        message.signatures =
            object.signatures?.map(e => exports.SignatureDescriptor_Data.fromPartial(e)) ||
                [];
        return message;
    },
    fromAmino(object) {
        ...
        message.signatures =
            object.signatures?.map(e => exports.SignatureDescriptor_Data.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
