...
exports.GetTxsEventRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GetTxsEventRequest.typeUrl ||
                (Array.isArray(o.events) &&
                    (!o.events.length || typeof o.events[0] === 'string') &&
                    (0, helpers_1.isSet)(o.orderBy) &&
...
exports.GetTxsEventResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GetTxsEventResponse.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length || tx_1.Tx.is(o.txs[0])) &&
                    Array.isArray(o.txResponses) &&
                    (!o.txResponses.length || abci_1.TxResponse.is(o.txResponses[0])) &&
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GetTxsEventResponse.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length || tx_1.Tx.isSDK(o.txs[0])) &&
                    Array.isArray(o.tx_responses) &&
                    (!o.tx_responses.length || abci_1.TxResponse.isSDK(o.tx_responses[0])) &&
                    typeof o.total === 'bigint')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GetTxsEventResponse.typeUrl ||
                (Array.isArray(o.txs) &&
                    (!o.txs.length || tx_1.Tx.isAmino(o.txs[0])) &&
                    Array.isArray(o.tx_responses) &&
                    (!o.tx_responses.length || abci_1.TxResponse.isAmino(o.tx_responses[0])) &&
                    typeof o.total === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.txResponses =
            object.txResponses?.map(e => abci_1.TxResponse.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
    ...
    fromAmino(object) {
        ...
        message.txResponses =
            object.tx_responses?.map(e => abci_1.TxResponse.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.BroadcastTxRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.BroadcastTxRequest.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.tx_bytes = message.txBytes
            ? (0, helpers_1.base64FromBytes)(message.txBytes)
            : undefined;
...
exports.BroadcastTxResponse = {
    ...
    toAmino(message) {
        ...
        obj.tx_response = message.txResponse
            ? abci_1.TxResponse.toAmino(message.txResponse)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.SimulateRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SimulateRequest.typeUrl ||
...
exports.SimulateResponse = {
    ...
    toAmino(message) {
        ...
        obj.gas_info = message.gasInfo
            ? abci_1.GasInfo.toAmino(message.gasInfo)
            : undefined;
...
exports.GetBlockWithTxsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GetBlockWithTxsRequest.typeUrl ||
...
exports.GetBlockWithTxsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GetBlockWithTxsResponse.typeUrl ||
                (Array.isArray(o.txs) && (!o.txs.length || tx_1.Tx.is(o.txs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GetBlockWithTxsResponse.typeUrl ||
                (Array.isArray(o.txs) && (!o.txs.length || tx_1.Tx.isSDK(o.txs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GetBlockWithTxsResponse.typeUrl ||
                (Array.isArray(o.txs) && (!o.txs.length || tx_1.Tx.isAmino(o.txs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        for (const v of message.txs) {
            tx_1.Tx.encode(v, writer.uint32(10).fork()).ldelim();
    ...
    toAmino(message) {
        ...
        obj.block_id = message.blockId
            ? types_1.BlockID.toAmino(message.blockId)
            : undefined;
...
exports.TxDecodeRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxDecodeRequest.typeUrl ||
                o.txBytes instanceof Uint8Array ||
                typeof o.txBytes === 'string'));
    },
    isSDK(o) {
...
exports.TxEncodeResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxEncodeResponse.typeUrl ||
                o.txBytes instanceof Uint8Array ||
                typeof o.txBytes === 'string'));
    },
    isSDK(o) {
...
exports.TxEncodeAminoRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxEncodeAminoRequest.typeUrl ||
...
exports.TxEncodeAminoResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxEncodeAminoResponse.typeUrl ||
...
exports.TxDecodeAminoRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxDecodeAminoRequest.typeUrl ||
                o.aminoBinary instanceof Uint8Array ||
                typeof o.aminoBinary === 'string'));
    },
    isSDK(o) {
...
exports.TxDecodeAminoResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxDecodeAminoResponse.typeUrl ||
                typeof o.aminoJson === 'string'));
    },
    isSDK(o) {
        return (o &&
