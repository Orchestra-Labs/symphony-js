...
exports.Tx = {
    ...
    toAmino(message) {
        ...
        obj.auth_info = message.authInfo
            ? exports.AuthInfo.toAmino(message.authInfo)
            : undefined;
...
exports.TxRaw = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxRaw.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.body_bytes = message.bodyBytes
            ? (0, helpers_1.base64FromBytes)(message.bodyBytes)
            : undefined;
        obj.auth_info_bytes = message.authInfoBytes
            ? (0, helpers_1.base64FromBytes)(message.authInfoBytes)
            : undefined;
        if (message.signatures) {
            obj.signatures = message.signatures.map(e => (0, helpers_1.base64FromBytes)(e));
        }
...
exports.SignDoc = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SignDoc.typeUrl ||
                ((o.bodyBytes instanceof Uint8Array ||
                    typeof o.bodyBytes === 'string') &&
                    (o.authInfoBytes instanceof Uint8Array ||
                        typeof o.authInfoBytes === 'string') &&
...
exports.SignDocDirectAux = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SignDocDirectAux.typeUrl ||
                ((o.bodyBytes instanceof Uint8Array ||
                    typeof o.bodyBytes === 'string') &&
                    typeof o.chainId === 'string' &&
                    typeof o.accountNumber === 'bigint' &&
    ...
    toAmino(message) {
        ...
        obj.public_key = message.publicKey
            ? any_1.Any.toAmino(message.publicKey)
            : undefined;
        obj.chain_id = message.chainId === '' ? undefined : message.chainId;
        obj.account_number =
            message.accountNumber !== BigInt(0)
...
exports.TxBody = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxBody.typeUrl ||
                (Array.isArray(o.messages) &&
                    (!o.messages.length || any_1.Any.is(o.messages[0])) &&
                    typeof o.memo === 'string' &&
                    typeof o.timeoutHeight === 'bigint' &&
                    Array.isArray(o.extensionOptions) &&
                    (!o.extensionOptions.length || any_1.Any.is(o.extensionOptions[0])) &&
                    Array.isArray(o.nonCriticalExtensionOptions) &&
                    (!o.nonCriticalExtensionOptions.length ||
                        any_1.Any.is(o.nonCriticalExtensionOptions[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.TxBody.typeUrl ||
                (Array.isArray(o.messages) &&
                    (!o.messages.length || any_1.Any.isSDK(o.messages[0])) &&
                    typeof o.memo === 'string' &&
                    typeof o.timeout_height === 'bigint' &&
                    Array.isArray(o.extension_options) &&
                    (!o.extension_options.length || any_1.Any.isSDK(o.extension_options[0])) &&
                    Array.isArray(o.non_critical_extension_options) &&
                    (!o.non_critical_extension_options.length ||
                        any_1.Any.isSDK(o.non_critical_extension_options[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.TxBody.typeUrl ||
                (Array.isArray(o.messages) &&
                    (!o.messages.length || any_1.Any.isAmino(o.messages[0])) &&
                    typeof o.memo === 'string' &&
                    typeof o.timeout_height === 'bigint' &&
                    Array.isArray(o.extension_options) &&
                    (!o.extension_options.length ||
                        any_1.Any.isAmino(o.extension_options[0])) &&
                    Array.isArray(o.non_critical_extension_options) &&
                    (!o.non_critical_extension_options.length ||
                        any_1.Any.isAmino(o.non_critical_extension_options[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.extensionOptions =
            object.extensionOptions?.map(e => any_1.Any.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.extensionOptions =
            object.extension_options?.map(e => any_1.Any.fromAmino(e)) || [];
        message.nonCriticalExtensionOptions =
            object.non_critical_extension_options?.map(e => any_1.Any.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.nonCriticalExtensionOptions) {
            obj.non_critical_extension_options =
                message.nonCriticalExtensionOptions.map(e => e ? any_1.Any.toAmino(e) : undefined);
        }
        else {
...
exports.AuthInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AuthInfo.typeUrl ||
                (Array.isArray(o.signerInfos) &&
                    (!o.signerInfos.length || exports.SignerInfo.is(o.signerInfos[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AuthInfo.typeUrl ||
                (Array.isArray(o.signer_infos) &&
                    (!o.signer_infos.length || exports.SignerInfo.isSDK(o.signer_infos[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AuthInfo.typeUrl ||
                (Array.isArray(o.signer_infos) &&
                    (!o.signer_infos.length || exports.SignerInfo.isAmino(o.signer_infos[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseAuthInfo();
        message.signerInfos =
            object.signerInfos?.map(e => exports.SignerInfo.fromPartial(e)) || [];
        message.fee =
    ...
    fromAmino(object) {
        const message = createBaseAuthInfo();
        message.signerInfos =
            object.signer_infos?.map(e => exports.SignerInfo.fromAmino(e)) || [];
...
exports.SignerInfo = {
    ...
    toAmino(message) {
        ...
        obj.mode_info = message.modeInfo
            ? exports.ModeInfo.toAmino(message.modeInfo)
            : undefined;
        obj.sequence =
            message.sequence !== BigInt(0) ? message.sequence.toString() : undefined;
        return obj;
...
exports.ModeInfo = {
    ...
    toAmino(message) {
        ...
        obj.single = message.single
            ? exports.ModeInfo_Single.toAmino(message.single)
            : undefined;
        obj.multi = message.multi
            ? exports.ModeInfo_Multi.toAmino(message.multi)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ModeInfo_Multi = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModeInfo_Multi.typeUrl ||
                (Array.isArray(o.modeInfos) &&
                    (!o.modeInfos.length || exports.ModeInfo.is(o.modeInfos[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ModeInfo_Multi.typeUrl ||
                (Array.isArray(o.mode_infos) &&
                    (!o.mode_infos.length || exports.ModeInfo.isSDK(o.mode_infos[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ModeInfo_Multi.typeUrl ||
                (Array.isArray(o.mode_infos) &&
                    (!o.mode_infos.length || exports.ModeInfo.isAmino(o.mode_infos[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.bitarray =
            object.bitarray !== undefined && object.bitarray !== null
                ...
                : undefined;
        message.modeInfos =
            object.modeInfos?.map(e => exports.ModeInfo.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseModeInfo_Multi();
        ...
        message.modeInfos =
            object.mode_infos?.map(e => exports.ModeInfo.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.bitarray = message.bitarray
            ? multisig_1.CompactBitArray.toAmino(message.bitarray)
            : undefined;
...
exports.AuxSignerData = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AuxSignerData.typeUrl ||
                (typeof o.address === 'string' &&
                    (0, helpers_1.isSet)(o.mode) &&
    ...
    toAmino(message) {
        ...
        obj.sign_doc = message.signDoc
            ? exports.SignDocDirectAux.toAmino(message.signDoc)
            : undefined;
        obj.mode = message.mode === 0 ? undefined : message.mode;
