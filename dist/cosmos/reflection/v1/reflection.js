...
exports.FileDescriptorsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.FileDescriptorsResponse.typeUrl ||
                (Array.isArray(o.files) &&
                    (!o.files.length || descriptor_1.FileDescriptorProto.is(o.files[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.FileDescriptorsResponse.typeUrl ||
                (Array.isArray(o.files) &&
                    (!o.files.length || descriptor_1.FileDescriptorProto.isSDK(o.files[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.FileDescriptorsResponse.typeUrl ||
                (Array.isArray(o.files) &&
                    (!o.files.length || descriptor_1.FileDescriptorProto.isAmino(o.files[0])))));
    },
    ...
    fromPartial(object) {
        const message = createBaseFileDescriptorsResponse();
        message.files =
            object.files?.map(e => descriptor_1.FileDescriptorProto.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseFileDescriptorsResponse();
        message.files =
            object.files?.map(e => descriptor_1.FileDescriptorProto.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
