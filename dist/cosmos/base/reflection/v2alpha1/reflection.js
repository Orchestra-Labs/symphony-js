...
exports.AppDescriptor = {
    ...
    toAmino(message) {
        ...
        obj.authn = message.authn
            ? exports.AuthnDescriptor.toAmino(message.authn)
            : undefined;
        obj.chain = message.chain
            ? exports.ChainDescriptor.toAmino(message.chain)
            : undefined;
        obj.codec = message.codec
            ? exports.CodecDescriptor.toAmino(message.codec)
            : undefined;
        obj.configuration = message.configuration
            ? exports.ConfigurationDescriptor.toAmino(message.configuration)
            : undefined;
        obj.query_services = message.queryServices
            ? exports.QueryServicesDescriptor.toAmino(message.queryServices)
            : undefined;
...
exports.TxDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    Array.isArray(o.msgs) &&
                    (!o.msgs.length || exports.MsgDescriptor.is(o.msgs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.TxDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    Array.isArray(o.msgs) &&
                    (!o.msgs.length || exports.MsgDescriptor.isSDK(o.msgs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.TxDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    Array.isArray(o.msgs) &&
                    (!o.msgs.length || exports.MsgDescriptor.isAmino(o.msgs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.fullname !== '') {
...
exports.AuthnDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AuthnDescriptor.typeUrl ||
                (Array.isArray(o.signModes) &&
                    (!o.signModes.length || exports.SigningModeDescriptor.is(o.signModes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AuthnDescriptor.typeUrl ||
                (Array.isArray(o.sign_modes) &&
                    (!o.sign_modes.length ||
                        exports.SigningModeDescriptor.isSDK(o.sign_modes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AuthnDescriptor.typeUrl ||
                (Array.isArray(o.sign_modes) &&
                    (!o.sign_modes.length ||
                        exports.SigningModeDescriptor.isAmino(o.sign_modes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseAuthnDescriptor();
        message.signModes =
            object.signModes?.map(e => exports.SigningModeDescriptor.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseAuthnDescriptor();
        message.signModes =
            object.sign_modes?.map(e => exports.SigningModeDescriptor.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.SigningModeDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SigningModeDescriptor.typeUrl ||
...
exports.CodecDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CodecDescriptor.typeUrl ||
                (Array.isArray(o.interfaces) &&
                    (!o.interfaces.length || exports.InterfaceDescriptor.is(o.interfaces[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.CodecDescriptor.typeUrl ||
                (Array.isArray(o.interfaces) &&
                    (!o.interfaces.length || exports.InterfaceDescriptor.isSDK(o.interfaces[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.CodecDescriptor.typeUrl ||
                (Array.isArray(o.interfaces) &&
                    (!o.interfaces.length ||
                        exports.InterfaceDescriptor.isAmino(o.interfaces[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseCodecDescriptor();
        message.interfaces =
            object.interfaces?.map(e => exports.InterfaceDescriptor.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseCodecDescriptor();
        message.interfaces =
            object.interfaces?.map(e => exports.InterfaceDescriptor.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.InterfaceDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.InterfaceDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    Array.isArray(o.interfaceAcceptingMessages) &&
                    (!o.interfaceAcceptingMessages.length ||
                        exports.InterfaceAcceptingMessageDescriptor.is(o.interfaceAcceptingMessages[0])) &&
                    Array.isArray(o.interfaceImplementers) &&
                    (!o.interfaceImplementers.length ||
                        exports.InterfaceImplementerDescriptor.is(o.interfaceImplementers[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.InterfaceDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    ...
                    (!o.interface_accepting_messages.length ||
                        exports.InterfaceAcceptingMessageDescriptor.isSDK(o.interface_accepting_messages[0])) &&
                    Array.isArray(o.interface_implementers) &&
                    (!o.interface_implementers.length ||
                        exports.InterfaceImplementerDescriptor.isSDK(o.interface_implementers[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.InterfaceDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    Array.isArray(o.interface_accepting_messages) &&
                    (!o.interface_accepting_messages.length ||
                        exports.InterfaceAcceptingMessageDescriptor.isAmino(o.interface_accepting_messages[0])) &&
                    Array.isArray(o.interface_implementers) &&
                    (!o.interface_implementers.length ||
                        exports.InterfaceImplementerDescriptor.isAmino(o.interface_implementers[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.fullname !== '') {
            writer.uint32(10).string(message.fullname);
    ...
    fromAmino(object) {
        ...
        message.interfaceAcceptingMessages =
            object.interface_accepting_messages?.map(e => exports.InterfaceAcceptingMessageDescriptor.fromAmino(e)) || [];
        message.interfaceImplementers =
            object.interface_implementers?.map(e => exports.InterfaceImplementerDescriptor.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.InterfaceImplementerDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.InterfaceImplementerDescriptor.typeUrl ||
...
exports.InterfaceAcceptingMessageDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.InterfaceAcceptingMessageDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
...
exports.ConfigurationDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ConfigurationDescriptor.typeUrl ||
...
exports.MsgDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgDescriptor.typeUrl || typeof o.msgTypeUrl === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgDescriptor.typeUrl ||
...
exports.GetConfigurationDescriptorResponse = {
    ...
    toAmino(message) {
        ...
        obj.config = message.config
            ? exports.ConfigurationDescriptor.toAmino(message.config)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GetQueryServicesDescriptorResponse = {
    ...
    toAmino(message) {
        ...
        obj.queries = message.queries
            ? exports.QueryServicesDescriptor.toAmino(message.queries)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryServicesDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryServicesDescriptor.typeUrl ||
                (Array.isArray(o.queryServices) &&
                    (!o.queryServices.length ||
                        exports.QueryServiceDescriptor.is(o.queryServices[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryServicesDescriptor.typeUrl ||
                (Array.isArray(o.query_services) &&
                    (!o.query_services.length ||
                        exports.QueryServiceDescriptor.isSDK(o.query_services[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryServicesDescriptor.typeUrl ||
                (Array.isArray(o.query_services) &&
                    (!o.query_services.length ||
                        exports.QueryServiceDescriptor.isAmino(o.query_services[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryServicesDescriptor();
        message.queryServices =
            object.queryServices?.map(e => exports.QueryServiceDescriptor.fromPartial(e)) ||
                [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseQueryServicesDescriptor();
        message.queryServices =
            object.query_services?.map(e => exports.QueryServiceDescriptor.fromAmino(e)) ||
                [];
        return message;
    },
    toAmino(message) {
...
exports.QueryServiceDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryServiceDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    typeof o.isModule === 'boolean' &&
                    Array.isArray(o.methods) &&
                    (!o.methods.length || exports.QueryMethodDescriptor.is(o.methods[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryServiceDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    ...
                    Array.isArray(o.methods) &&
                    (!o.methods.length || exports.QueryMethodDescriptor.isSDK(o.methods[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryServiceDescriptor.typeUrl ||
                (typeof o.fullname === 'string' &&
                    typeof o.is_module === 'boolean' &&
                    Array.isArray(o.methods) &&
                    (!o.methods.length || exports.QueryMethodDescriptor.isAmino(o.methods[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.fullname !== '') {
            writer.uint32(10).string(message.fullname);
    ...
    fromPartial(object) {
        ...
        message.methods =
            object.methods?.map(e => exports.QueryMethodDescriptor.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseQueryServiceDescriptor();
        ...
        message.methods =
            object.methods?.map(e => exports.QueryMethodDescriptor.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryMethodDescriptor = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryMethodDescriptor.typeUrl ||
