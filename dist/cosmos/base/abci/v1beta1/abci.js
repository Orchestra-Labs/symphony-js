...
exports.TxResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxResponse.typeUrl ||
                (typeof o.height === 'bigint' &&
                    ...
                    (!o.logs.length || exports.ABCIMessageLog.is(o.logs[0])) &&
                    typeof o.info === 'string' &&
                    typeof o.gasWanted === 'bigint' &&
                    typeof o.gasUsed === 'bigint' &&
                    typeof o.timestamp === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || types_1.Event.is(o.events[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.TxResponse.typeUrl ||
                (typeof o.height === 'bigint' &&
                    ...
                    Array.isArray(o.logs) &&
                    (!o.logs.length || exports.ABCIMessageLog.isSDK(o.logs[0])) &&
                    typeof o.info === 'string' &&
                    typeof o.gas_wanted === 'bigint' &&
                    typeof o.gas_used === 'bigint' &&
                    typeof o.timestamp === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || types_1.Event.isSDK(o.events[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.TxResponse.typeUrl ||
                (typeof o.height === 'bigint' &&
                    ...
                    typeof o.raw_log === 'string' &&
                    Array.isArray(o.logs) &&
                    (!o.logs.length || exports.ABCIMessageLog.isAmino(o.logs[0])) &&
                    typeof o.info === 'string' &&
                    typeof o.gas_wanted === 'bigint' &&
                    typeof o.gas_used === 'bigint' &&
                    typeof o.timestamp === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || types_1.Event.isAmino(o.events[0])))));
    },
...
exports.ABCIMessageLog = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ABCIMessageLog.typeUrl ||
                (typeof o.msgIndex === 'number' &&
                    typeof o.log === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || exports.StringEvent.is(o.events[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ABCIMessageLog.typeUrl ||
                (typeof o.msg_index === 'number' &&
                    typeof o.log === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || exports.StringEvent.isSDK(o.events[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ABCIMessageLog.typeUrl ||
                (typeof o.msg_index === 'number' &&
                    typeof o.log === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || exports.StringEvent.isAmino(o.events[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.StringEvent = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.StringEvent.typeUrl ||
                (typeof o.type === 'string' &&
                    Array.isArray(o.attributes) &&
                    (!o.attributes.length || exports.Attribute.is(o.attributes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.StringEvent.typeUrl ||
                (typeof o.type === 'string' &&
                    Array.isArray(o.attributes) &&
                    (!o.attributes.length || exports.Attribute.isSDK(o.attributes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.StringEvent.typeUrl ||
                (typeof o.type === 'string' &&
                    Array.isArray(o.attributes) &&
                    (!o.attributes.length || exports.Attribute.isAmino(o.attributes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.type !== '') {
    ...
    fromPartial(object) {
        ...
        message.attributes =
            object.attributes?.map(e => exports.Attribute.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseStringEvent();
        ...
        message.attributes =
            object.attributes?.map(e => exports.Attribute.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.Attribute = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Attribute.typeUrl ||
...
exports.GasInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GasInfo.typeUrl ||
...
exports.Result = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Result.typeUrl ||
                ((o.data instanceof Uint8Array || typeof o.data === 'string') &&
                    typeof o.log === 'string' &&
                    Array.isArray(o.events) &&
                    (!o.events.length || types_1.Event.is(o.events[0])) &&
                    Array.isArray(o.msgResponses) &&
                    (!o.msgResponses.length || any_1.Any.is(o.msgResponses[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Result.typeUrl ||
                ((o.data instanceof Uint8Array || typeof o.data === 'string') &&
                    ...
                    (!o.msg_responses.length || any_1.Any.isSDK(o.msg_responses[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Result.typeUrl ||
                ((o.data instanceof Uint8Array || typeof o.data === 'string') &&
                    ...
                    (!o.events.length || types_1.Event.isAmino(o.events[0])) &&
                    Array.isArray(o.msg_responses) &&
                    (!o.msg_responses.length || any_1.Any.isAmino(o.msg_responses[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.msgResponses =
            object.msgResponses?.map(e => any_1.Any.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseResult();
        ...
        message.events = object.events?.map(e => types_1.Event.fromAmino(e)) || [];
        message.msgResponses =
            object.msg_responses?.map(e => any_1.Any.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.SimulationResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.SimulationResponse.typeUrl || exports.GasInfo.isSDK(o.gas_info)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.SimulationResponse.typeUrl || exports.GasInfo.isAmino(o.gas_info)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.gas_info = message.gasInfo
            ? exports.GasInfo.toAmino(message.gasInfo)
            : undefined;
...
exports.MsgData = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgData.typeUrl ||
...
exports.TxMsgData = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TxMsgData.typeUrl ||
                (Array.isArray(o.data) &&
                    (!o.data.length || exports.MsgData.is(o.data[0])) &&
                    Array.isArray(o.msgResponses) &&
                    (!o.msgResponses.length || any_1.Any.is(o.msgResponses[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.TxMsgData.typeUrl ||
                (Array.isArray(o.data) &&
                    (!o.data.length || exports.MsgData.isSDK(o.data[0])) &&
                    Array.isArray(o.msg_responses) &&
                    (!o.msg_responses.length || any_1.Any.isSDK(o.msg_responses[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.TxMsgData.typeUrl ||
                (Array.isArray(o.data) &&
                    (!o.data.length || exports.MsgData.isAmino(o.data[0])) &&
                    Array.isArray(o.msg_responses) &&
                    (!o.msg_responses.length || any_1.Any.isAmino(o.msg_responses[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.SearchTxsResult = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SearchTxsResult.typeUrl ||
                (typeof o.totalCount === 'bigint' &&
                    ...
                    Array.isArray(o.txs) &&
                    (!o.txs.length || exports.TxResponse.is(o.txs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.SearchTxsResult.typeUrl ||
                (typeof o.total_count === 'bigint' &&
                    ...
                    typeof o.limit === 'bigint' &&
                    Array.isArray(o.txs) &&
                    (!o.txs.length || exports.TxResponse.isSDK(o.txs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.SearchTxsResult.typeUrl ||
                (typeof o.total_count === 'bigint' &&
                    ...
                    typeof o.limit === 'bigint' &&
                    Array.isArray(o.txs) &&
                    (!o.txs.length || exports.TxResponse.isAmino(o.txs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
