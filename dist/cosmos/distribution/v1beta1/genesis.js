...
exports.DelegatorWithdrawInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DelegatorWithdrawInfo.typeUrl ||
...
exports.ValidatorOutstandingRewardsRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorOutstandingRewardsRecord.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
                    Array.isArray(o.outstandingRewards) &&
                    (!o.outstandingRewards.length ||
                        coin_1.DecCoin.is(o.outstandingRewards[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorOutstandingRewardsRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    ...
                    (!o.outstanding_rewards.length ||
                        coin_1.DecCoin.isSDK(o.outstanding_rewards[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorOutstandingRewardsRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    Array.isArray(o.outstanding_rewards) &&
                    (!o.outstanding_rewards.length ||
                        coin_1.DecCoin.isAmino(o.outstanding_rewards[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.outstandingRewards =
            object.outstandingRewards?.map(e => coin_1.DecCoin.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseValidatorOutstandingRewardsRecord();
        ...
        message.outstandingRewards =
            object.outstanding_rewards?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.ValidatorAccumulatedCommissionRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorAccumulatedCommissionRecord.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
                    distribution_1.ValidatorAccumulatedCommission.is(o.accumulated))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorAccumulatedCommissionRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    distribution_1.ValidatorAccumulatedCommission.isSDK(o.accumulated))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorAccumulatedCommissionRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    distribution_1.ValidatorAccumulatedCommission.isAmino(o.accumulated))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.validatorAddress !== '') {
            writer.uint32(10).string(message.validatorAddress);
    ...
    toAmino(message) {
        ...
        obj.accumulated = message.accumulated
            ? distribution_1.ValidatorAccumulatedCommission.toAmino(message.accumulated)
            : distribution_1.ValidatorAccumulatedCommission.toAmino(distribution_1.ValidatorAccumulatedCommission.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ValidatorHistoricalRewardsRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorHistoricalRewardsRecord.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
                    typeof o.period === 'bigint' &&
                    distribution_1.ValidatorHistoricalRewards.is(o.rewards))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorHistoricalRewardsRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    typeof o.period === 'bigint' &&
                    distribution_1.ValidatorHistoricalRewards.isSDK(o.rewards))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorHistoricalRewardsRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    typeof o.period === 'bigint' &&
                    distribution_1.ValidatorHistoricalRewards.isAmino(o.rewards))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.validatorAddress !== '') {
            writer.uint32(10).string(message.validatorAddress);
    ...
    toAmino(message) {
        ...
        obj.rewards = message.rewards
            ? distribution_1.ValidatorHistoricalRewards.toAmino(message.rewards)
            : distribution_1.ValidatorHistoricalRewards.toAmino(distribution_1.ValidatorHistoricalRewards.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ValidatorCurrentRewardsRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorCurrentRewardsRecord.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
                    distribution_1.ValidatorCurrentRewards.is(o.rewards))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorCurrentRewardsRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    distribution_1.ValidatorCurrentRewards.isSDK(o.rewards))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorCurrentRewardsRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    distribution_1.ValidatorCurrentRewards.isAmino(o.rewards))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.validatorAddress !== '') {
            writer.uint32(10).string(message.validatorAddress);
    ...
    toAmino(message) {
        ...
        obj.validator_address =
            message.validatorAddress === '' ? undefined : message.validatorAddress;
        obj.rewards = message.rewards
            ? distribution_1.ValidatorCurrentRewards.toAmino(message.rewards)
            : distribution_1.ValidatorCurrentRewards.toAmino(distribution_1.ValidatorCurrentRewards.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.DelegatorStartingInfoRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DelegatorStartingInfoRecord.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
                    typeof o.validatorAddress === 'string' &&
                    distribution_1.DelegatorStartingInfo.is(o.startingInfo))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DelegatorStartingInfoRecord.typeUrl ||
                (typeof o.delegator_address === 'string' &&
                    typeof o.validator_address === 'string' &&
                    distribution_1.DelegatorStartingInfo.isSDK(o.starting_info))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DelegatorStartingInfoRecord.typeUrl ||
                (typeof o.delegator_address === 'string' &&
                    typeof o.validator_address === 'string' &&
                    distribution_1.DelegatorStartingInfo.isAmino(o.starting_info))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.delegatorAddress !== '') {
            writer.uint32(10).string(message.delegatorAddress);
    ...
    toAmino(message) {
        ...
        obj.starting_info = message.startingInfo
            ...
            : distribution_1.DelegatorStartingInfo.toAmino(distribution_1.DelegatorStartingInfo.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ValidatorSlashEventRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEventRecord.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
                    typeof o.height === 'bigint' &&
                    typeof o.period === 'bigint' &&
                    distribution_1.ValidatorSlashEvent.is(o.validatorSlashEvent))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEventRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    typeof o.height === 'bigint' &&
                    typeof o.period === 'bigint' &&
                    distribution_1.ValidatorSlashEvent.isSDK(o.validator_slash_event))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEventRecord.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    typeof o.height === 'bigint' &&
                    typeof o.period === 'bigint' &&
                    distribution_1.ValidatorSlashEvent.isAmino(o.validator_slash_event))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.validatorAddress !== '') {
            writer.uint32(10).string(message.validatorAddress);
    ...
    toAmino(message) {
        ...
        obj.validator_slash_event = message.validatorSlashEvent
            ? distribution_1.ValidatorSlashEvent.toAmino(message.validatorSlashEvent)
            : distribution_1.ValidatorSlashEvent.toAmino(distribution_1.ValidatorSlashEvent.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GenesisState = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (distribution_1.Params.is(o.params) &&
                    distribution_1.FeePool.is(o.feePool) &&
                    Array.isArray(o.delegatorWithdrawInfos) &&
                    (!o.delegatorWithdrawInfos.length ||
                        exports.DelegatorWithdrawInfo.is(o.delegatorWithdrawInfos[0])) &&
                    typeof o.previousProposer === 'string' &&
                    Array.isArray(o.outstandingRewards) &&
                    (!o.outstandingRewards.length ||
                        exports.ValidatorOutstandingRewardsRecord.is(o.outstandingRewards[0])) &&
                    Array.isArray(o.validatorAccumulatedCommissions) &&
                    (!o.validatorAccumulatedCommissions.length ||
                        exports.ValidatorAccumulatedCommissionRecord.is(o.validatorAccumulatedCommissions[0])) &&
                    Array.isArray(o.validatorHistoricalRewards) &&
                    (!o.validatorHistoricalRewards.length ||
                        exports.ValidatorHistoricalRewardsRecord.is(o.validatorHistoricalRewards[0])) &&
                    Array.isArray(o.validatorCurrentRewards) &&
                    (!o.validatorCurrentRewards.length ||
                        exports.ValidatorCurrentRewardsRecord.is(o.validatorCurrentRewards[0])) &&
                    Array.isArray(o.delegatorStartingInfos) &&
                    (!o.delegatorStartingInfos.length ||
                        exports.DelegatorStartingInfoRecord.is(o.delegatorStartingInfos[0])) &&
                    Array.isArray(o.validatorSlashEvents) &&
                    (!o.validatorSlashEvents.length ||
                        exports.ValidatorSlashEventRecord.is(o.validatorSlashEvents[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (distribution_1.Params.isSDK(o.params) &&
                    distribution_1.FeePool.isSDK(o.fee_pool) &&
                    Array.isArray(o.delegator_withdraw_infos) &&
                    (!o.delegator_withdraw_infos.length ||
                        exports.DelegatorWithdrawInfo.isSDK(o.delegator_withdraw_infos[0])) &&
                    typeof o.previous_proposer === 'string' &&
                    Array.isArray(o.outstanding_rewards) &&
                    (!o.outstanding_rewards.length ||
                        exports.ValidatorOutstandingRewardsRecord.isSDK(o.outstanding_rewards[0])) &&
                    Array.isArray(o.validator_accumulated_commissions) &&
                    (!o.validator_accumulated_commissions.length ||
                        exports.ValidatorAccumulatedCommissionRecord.isSDK(o.validator_accumulated_commissions[0])) &&
                    Array.isArray(o.validator_historical_rewards) &&
                    (!o.validator_historical_rewards.length ||
                        exports.ValidatorHistoricalRewardsRecord.isSDK(o.validator_historical_rewards[0])) &&
                    Array.isArray(o.validator_current_rewards) &&
                    (!o.validator_current_rewards.length ||
                        exports.ValidatorCurrentRewardsRecord.isSDK(o.validator_current_rewards[0])) &&
                    Array.isArray(o.delegator_starting_infos) &&
                    (!o.delegator_starting_infos.length ||
                        exports.DelegatorStartingInfoRecord.isSDK(o.delegator_starting_infos[0])) &&
                    Array.isArray(o.validator_slash_events) &&
                    (!o.validator_slash_events.length ||
                        exports.ValidatorSlashEventRecord.isSDK(o.validator_slash_events[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (distribution_1.Params.isAmino(o.params) &&
                    distribution_1.FeePool.isAmino(o.fee_pool) &&
                    Array.isArray(o.delegator_withdraw_infos) &&
                    (!o.delegator_withdraw_infos.length ||
                        exports.DelegatorWithdrawInfo.isAmino(o.delegator_withdraw_infos[0])) &&
                    typeof o.previous_proposer === 'string' &&
                    Array.isArray(o.outstanding_rewards) &&
                    (!o.outstanding_rewards.length ||
                        exports.ValidatorOutstandingRewardsRecord.isAmino(o.outstanding_rewards[0])) &&
                    Array.isArray(o.validator_accumulated_commissions) &&
                    (!o.validator_accumulated_commissions.length ||
                        exports.ValidatorAccumulatedCommissionRecord.isAmino(o.validator_accumulated_commissions[0])) &&
                    Array.isArray(o.validator_historical_rewards) &&
                    (!o.validator_historical_rewards.length ||
                        exports.ValidatorHistoricalRewardsRecord.isAmino(o.validator_historical_rewards[0])) &&
                    Array.isArray(o.validator_current_rewards) &&
                    (!o.validator_current_rewards.length ||
                        exports.ValidatorCurrentRewardsRecord.isAmino(o.validator_current_rewards[0])) &&
                    Array.isArray(o.delegator_starting_infos) &&
                    (!o.delegator_starting_infos.length ||
                        exports.DelegatorStartingInfoRecord.isAmino(o.delegator_starting_infos[0])) &&
                    Array.isArray(o.validator_slash_events) &&
                    (!o.validator_slash_events.length ||
                        exports.ValidatorSlashEventRecord.isAmino(o.validator_slash_events[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        ...
        message.delegatorWithdrawInfos =
            object.delegator_withdraw_infos?.map(e => exports.DelegatorWithdrawInfo.fromAmino(e)) || [];
        if (object.previous_proposer !== undefined &&
            object.previous_proposer !== null) {
            message.previousProposer = object.previous_proposer;
        }
        message.outstandingRewards =
            object.outstanding_rewards?.map(e => exports.ValidatorOutstandingRewardsRecord.fromAmino(e)) || [];
        message.validatorAccumulatedCommissions =
            object.validator_accumulated_commissions?.map(e => exports.ValidatorAccumulatedCommissionRecord.fromAmino(e)) || [];
        message.validatorHistoricalRewards =
            object.validator_historical_rewards?.map(e => exports.ValidatorHistoricalRewardsRecord.fromAmino(e)) || [];
        message.validatorCurrentRewards =
            object.validator_current_rewards?.map(e => exports.ValidatorCurrentRewardsRecord.fromAmino(e)) || [];
        message.delegatorStartingInfos =
            object.delegator_starting_infos?.map(e => exports.DelegatorStartingInfoRecord.fromAmino(e)) || [];
        message.validatorSlashEvents =
            object.validator_slash_events?.map(e => exports.ValidatorSlashEventRecord.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.params = message.params
            ? distribution_1.Params.toAmino(message.params)
            : distribution_1.Params.toAmino(distribution_1.Params.fromPartial({}));
        obj.fee_pool = message.feePool
            ? distribution_1.FeePool.toAmino(message.feePool)
            : distribution_1.FeePool.toAmino(distribution_1.FeePool.fromPartial({}));
        ...
        if (message.validatorAccumulatedCommissions) {
            obj.validator_accumulated_commissions =
                message.validatorAccumulatedCommissions.map(e => e ? exports.ValidatorAccumulatedCommissionRecord.toAmino(e) : undefined);
        }
        else {
            obj.validator_accumulated_commissions =
                message.validatorAccumulatedCommissions;
