...
exports.Params = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.communityTax !== '') {
            writer
                .uint32(10)
                .string(math_1.Decimal.fromUserInput(message.communityTax, 18).atomics);
        }
        if (message.baseProposerReward !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.baseProposerReward, 18).atomics);
        }
        if (message.bonusProposerReward !== '') {
            writer
                .uint32(26)
                .string(math_1.Decimal.fromUserInput(message.bonusProposerReward, 18).atomics);
        }
...
exports.ValidatorHistoricalRewards = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorHistoricalRewards.typeUrl ||
                (Array.isArray(o.cumulativeRewardRatio) &&
                    (!o.cumulativeRewardRatio.length ||
                        coin_1.DecCoin.is(o.cumulativeRewardRatio[0])) &&
            ...
            (o.$typeUrl === exports.ValidatorHistoricalRewards.typeUrl ||
                (Array.isArray(o.cumulative_reward_ratio) &&
                    (!o.cumulative_reward_ratio.length ||
                        coin_1.DecCoin.isSDK(o.cumulative_reward_ratio[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorHistoricalRewards.typeUrl ||
                (Array.isArray(o.cumulative_reward_ratio) &&
                    (!o.cumulative_reward_ratio.length ||
                        coin_1.DecCoin.isAmino(o.cumulative_reward_ratio[0])) &&
                    typeof o.reference_count === 'number')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.cumulativeRewardRatio =
            object.cumulativeRewardRatio?.map(e => coin_1.DecCoin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        const message = createBaseValidatorHistoricalRewards();
        message.cumulativeRewardRatio =
            object.cumulative_reward_ratio?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
...
exports.ValidatorCurrentRewards = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorCurrentRewards.typeUrl ||
...
exports.ValidatorAccumulatedCommission = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorAccumulatedCommission.typeUrl ||
...
exports.ValidatorOutstandingRewards = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorOutstandingRewards.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length || coin_1.DecCoin.is(o.rewards[0])))));
    },
    isSDK(o) {
...
exports.ValidatorSlashEvent = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEvent.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.fraction !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.fraction, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.ValidatorSlashEvents = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEvents.typeUrl ||
                (Array.isArray(o.validatorSlashEvents) &&
                    (!o.validatorSlashEvents.length ||
                        exports.ValidatorSlashEvent.is(o.validatorSlashEvents[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEvents.typeUrl ||
                (Array.isArray(o.validator_slash_events) &&
                    (!o.validator_slash_events.length ||
                        exports.ValidatorSlashEvent.isSDK(o.validator_slash_events[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSlashEvents.typeUrl ||
                (Array.isArray(o.validator_slash_events) &&
                    (!o.validator_slash_events.length ||
                        exports.ValidatorSlashEvent.isAmino(o.validator_slash_events[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseValidatorSlashEvents();
        message.validatorSlashEvents =
            object.validator_slash_events?.map(e => exports.ValidatorSlashEvent.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.FeePool = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.FeePool.typeUrl ||
                (Array.isArray(o.communityPool) &&
                    (!o.communityPool.length || coin_1.DecCoin.is(o.communityPool[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.FeePool.typeUrl ||
                (Array.isArray(o.community_pool) &&
                    (!o.community_pool.length || coin_1.DecCoin.isSDK(o.community_pool[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.FeePool.typeUrl ||
                (Array.isArray(o.community_pool) &&
                    (!o.community_pool.length || coin_1.DecCoin.isAmino(o.community_pool[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.communityPool =
            object.communityPool?.map(e => coin_1.DecCoin.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseFeePool();
        message.communityPool =
            object.community_pool?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.CommunityPoolSpendProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CommunityPoolSpendProposal.typeUrl ||
...
exports.DelegatorStartingInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DelegatorStartingInfo.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.stake !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.stake, 18).atomics);
        }
...
exports.DelegationDelegatorReward = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DelegationDelegatorReward.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
                    Array.isArray(o.reward) &&
                    (!o.reward.length || coin_1.DecCoin.is(o.reward[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DelegationDelegatorReward.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    Array.isArray(o.reward) &&
                    (!o.reward.length || coin_1.DecCoin.isSDK(o.reward[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DelegationDelegatorReward.typeUrl ||
                (typeof o.validator_address === 'string' &&
                    Array.isArray(o.reward) &&
                    (!o.reward.length || coin_1.DecCoin.isAmino(o.reward[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.CommunityPoolSpendProposalWithDeposit = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CommunityPoolSpendProposalWithDeposit.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    typeof o.recipient === 'string' &&
