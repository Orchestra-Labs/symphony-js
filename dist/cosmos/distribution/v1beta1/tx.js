...
exports.MsgSetWithdrawAddress = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSetWithdrawAddress.typeUrl ||
...
exports.MsgWithdrawDelegatorReward = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgWithdrawDelegatorReward.typeUrl ||
                (typeof o.delegatorAddress === 'string' &&
...
exports.MsgWithdrawDelegatorRewardResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgWithdrawDelegatorRewardResponse.typeUrl ||
...
exports.MsgWithdrawValidatorCommission = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgWithdrawValidatorCommission.typeUrl ||
                typeof o.validatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.MsgWithdrawValidatorCommissionResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgWithdrawValidatorCommissionResponse.typeUrl ||
                (Array.isArray(o.amount) && (!o.amount.length || coin_1.Coin.is(o.amount[0])))));
    },
    isSDK(o) {
        return (o &&
...
exports.MsgFundCommunityPool = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgFundCommunityPool.typeUrl ||
                (Array.isArray(o.amount) &&
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && distribution_1.Params.is(o.params))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && distribution_1.Params.isSDK(o.params))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgUpdateParams.typeUrl ||
                (typeof o.authority === 'string' && distribution_1.Params.isAmino(o.params))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.MsgCommunityPoolSpend = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCommunityPoolSpend.typeUrl ||
