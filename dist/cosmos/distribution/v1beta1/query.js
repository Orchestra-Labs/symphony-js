...
exports.QueryParamsResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || distribution_1.Params.isSDK(o.params)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || distribution_1.Params.isAmino(o.params)));
    },
...
exports.QueryValidatorDistributionInfoRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDistributionInfoRequest.typeUrl ||
...
exports.QueryValidatorDistributionInfoResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDistributionInfoResponse.typeUrl ||
                (typeof o.operatorAddress === 'string' &&
                    Array.isArray(o.selfBondRewards) &&
                    (!o.selfBondRewards.length || coin_1.DecCoin.is(o.selfBondRewards[0])) &&
                    Array.isArray(o.commission) &&
                    (!o.commission.length || coin_1.DecCoin.is(o.commission[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDistributionInfoResponse.typeUrl ||
                (typeof o.operator_address === 'string' &&
                    ...
                    (!o.self_bond_rewards.length ||
                        coin_1.DecCoin.isSDK(o.self_bond_rewards[0])) &&
                    Array.isArray(o.commission) &&
                    (!o.commission.length || coin_1.DecCoin.isSDK(o.commission[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorDistributionInfoResponse.typeUrl ||
                (typeof o.operator_address === 'string' &&
                    Array.isArray(o.self_bond_rewards) &&
                    (!o.self_bond_rewards.length ||
                        coin_1.DecCoin.isAmino(o.self_bond_rewards[0])) &&
                    Array.isArray(o.commission) &&
                    (!o.commission.length || coin_1.DecCoin.isAmino(o.commission[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.selfBondRewards =
            object.selfBondRewards?.map(e => coin_1.DecCoin.fromPartial(e)) || [];
        message.commission =
            object.commission?.map(e => coin_1.DecCoin.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseQueryValidatorDistributionInfoResponse();
        ...
        message.selfBondRewards =
            object.self_bond_rewards?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
        message.commission =
            object.commission?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryValidatorOutstandingRewardsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorOutstandingRewardsRequest.typeUrl ||
                typeof o.validatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryValidatorOutstandingRewardsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorOutstandingRewardsResponse.typeUrl ||
                distribution_1.ValidatorOutstandingRewards.is(o.rewards)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorOutstandingRewardsResponse.typeUrl ||
                distribution_1.ValidatorOutstandingRewards.isSDK(o.rewards)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorOutstandingRewardsResponse.typeUrl ||
                distribution_1.ValidatorOutstandingRewards.isAmino(o.rewards)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        ...
        obj.rewards = message.rewards
            ? distribution_1.ValidatorOutstandingRewards.toAmino(message.rewards)
            : distribution_1.ValidatorOutstandingRewards.toAmino(distribution_1.ValidatorOutstandingRewards.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryValidatorCommissionRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorCommissionRequest.typeUrl ||
                typeof o.validatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryValidatorCommissionResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorCommissionResponse.typeUrl ||
                distribution_1.ValidatorAccumulatedCommission.is(o.commission)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorCommissionResponse.typeUrl ||
                distribution_1.ValidatorAccumulatedCommission.isSDK(o.commission)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorCommissionResponse.typeUrl ||
                distribution_1.ValidatorAccumulatedCommission.isAmino(o.commission)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    toAmino(message) {
        const obj = {};
        obj.commission = message.commission
            ? distribution_1.ValidatorAccumulatedCommission.toAmino(message.commission)
...
exports.QueryValidatorSlashesRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorSlashesRequest.typeUrl ||
                (typeof o.validatorAddress === 'string' &&
...
exports.QueryValidatorSlashesResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorSlashesResponse.typeUrl ||
                (Array.isArray(o.slashes) &&
                    (!o.slashes.length || distribution_1.ValidatorSlashEvent.is(o.slashes[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorSlashesResponse.typeUrl ||
                (Array.isArray(o.slashes) &&
                    (!o.slashes.length || distribution_1.ValidatorSlashEvent.isSDK(o.slashes[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryValidatorSlashesResponse.typeUrl ||
                (Array.isArray(o.slashes) &&
                    (!o.slashes.length || distribution_1.ValidatorSlashEvent.isAmino(o.slashes[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseQueryValidatorSlashesResponse();
        message.slashes =
            object.slashes?.map(e => distribution_1.ValidatorSlashEvent.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
    ...
    fromAmino(object) {
        const message = createBaseQueryValidatorSlashesResponse();
        message.slashes =
            object.slashes?.map(e => distribution_1.ValidatorSlashEvent.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryDelegationRewardsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationRewardsRequest.typeUrl ||
...
exports.QueryDelegationRewardsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationRewardsResponse.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length || coin_1.DecCoin.is(o.rewards[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationRewardsResponse.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length || coin_1.DecCoin.isSDK(o.rewards[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationRewardsResponse.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length || coin_1.DecCoin.isAmino(o.rewards[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryDelegationTotalRewardsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationTotalRewardsRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDelegationTotalRewardsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationTotalRewardsResponse.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length || distribution_1.DelegationDelegatorReward.is(o.rewards[0])) &&
                    Array.isArray(o.total) &&
                    (!o.total.length || coin_1.DecCoin.is(o.total[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationTotalRewardsResponse.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length ||
                        distribution_1.DelegationDelegatorReward.isSDK(o.rewards[0])) &&
                    Array.isArray(o.total) &&
                    (!o.total.length || coin_1.DecCoin.isSDK(o.total[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegationTotalRewardsResponse.typeUrl ||
                (Array.isArray(o.rewards) &&
                    (!o.rewards.length ||
                        distribution_1.DelegationDelegatorReward.isAmino(o.rewards[0])) &&
                    Array.isArray(o.total) &&
                    (!o.total.length || coin_1.DecCoin.isAmino(o.total[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        for (const v of message.rewards) {
    ...
    fromPartial(object) {
        const message = createBaseQueryDelegationTotalRewardsResponse();
        message.rewards =
            object.rewards?.map(e => distribution_1.DelegationDelegatorReward.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        const message = createBaseQueryDelegationTotalRewardsResponse();
        message.rewards =
            object.rewards?.map(e => distribution_1.DelegationDelegatorReward.fromAmino(e)) || [];
...
exports.QueryDelegatorValidatorsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorValidatorsRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDelegatorValidatorsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorValidatorsResponse.typeUrl ||
...
exports.QueryDelegatorWithdrawAddressRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorWithdrawAddressRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDelegatorWithdrawAddressResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDelegatorWithdrawAddressResponse.typeUrl ||
...
exports.QueryCommunityPoolResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryCommunityPoolResponse.typeUrl ||
                (Array.isArray(o.pool) && (!o.pool.length || coin_1.DecCoin.is(o.pool[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryCommunityPoolResponse.typeUrl ||
                (Array.isArray(o.pool) && (!o.pool.length || coin_1.DecCoin.isSDK(o.pool[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryCommunityPoolResponse.typeUrl ||
                (Array.isArray(o.pool) &&
                    (!o.pool.length || coin_1.DecCoin.isAmino(o.pool[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
