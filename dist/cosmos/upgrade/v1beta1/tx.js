...
exports.MsgSoftwareUpgrade = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSoftwareUpgrade.typeUrl ||
                (typeof o.authority === 'string' && upgrade_1.Plan.is(o.plan))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSoftwareUpgrade.typeUrl ||
                (typeof o.authority === 'string' && upgrade_1.Plan.isSDK(o.plan))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgSoftwareUpgrade.typeUrl ||
                (typeof o.authority === 'string' && upgrade_1.Plan.isAmino(o.plan))));
    },
    ...
    toAmino(message) {
        ...
        obj.plan = message.plan
            ? upgrade_1.Plan.toAmino(message.plan)
            : upgrade_1.Plan.toAmino(upgrade_1.Plan.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.MsgCancelUpgrade = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCancelUpgrade.typeUrl ||
