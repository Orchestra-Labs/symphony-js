...
exports.QueryAppliedPlanRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAppliedPlanRequest.typeUrl ||
...
exports.QueryAppliedPlanResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAppliedPlanResponse.typeUrl ||
...
exports.QueryUpgradedConsensusStateRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUpgradedConsensusStateRequest.typeUrl ||
...
exports.QueryUpgradedConsensusStateResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUpgradedConsensusStateResponse.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.upgraded_consensus_state = message.upgradedConsensusState
            ? (0, helpers_1.base64FromBytes)(message.upgradedConsensusState)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryModuleVersionsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleVersionsRequest.typeUrl ||
...
exports.QueryModuleVersionsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleVersionsResponse.typeUrl ||
                (Array.isArray(o.moduleVersions) &&
                    (!o.moduleVersions.length || upgrade_1.ModuleVersion.is(o.moduleVersions[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleVersionsResponse.typeUrl ||
                (Array.isArray(o.module_versions) &&
                    (!o.module_versions.length ||
                        upgrade_1.ModuleVersion.isSDK(o.module_versions[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryModuleVersionsResponse.typeUrl ||
                (Array.isArray(o.module_versions) &&
                    (!o.module_versions.length ||
                        upgrade_1.ModuleVersion.isAmino(o.module_versions[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.moduleVersions =
            object.moduleVersions?.map(e => upgrade_1.ModuleVersion.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseQueryModuleVersionsResponse();
        message.moduleVersions =
            object.module_versions?.map(e => upgrade_1.ModuleVersion.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryAuthorityResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryAuthorityResponse.typeUrl ||
