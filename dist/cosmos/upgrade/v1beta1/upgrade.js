...
exports.Plan = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Plan.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.upgraded_client_state = message.upgradedClientState
            ? any_1.Any.toAmino(message.upgradedClientState)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.SoftwareUpgradeProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SoftwareUpgradeProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    exports.Plan.is(o.plan))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.SoftwareUpgradeProposal.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.plan = message.plan
            ? exports.Plan.toAmino(message.plan)
            : exports.Plan.toAmino(exports.Plan.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
...
exports.CancelSoftwareUpgradeProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.CancelSoftwareUpgradeProposal.typeUrl ||
...
exports.ModuleVersion = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleVersion.typeUrl ||
