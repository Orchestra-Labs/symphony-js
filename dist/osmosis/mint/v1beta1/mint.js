...
exports.Minter = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Minter.typeUrl || typeof o.epochProvisions === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Minter.typeUrl || typeof o.epoch_provisions === 'string'));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Minter.typeUrl || typeof o.epoch_provisions === 'string'));
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.epochProvisions !== '') {
            writer
                .uint32(10)
                .string(math_1.Decimal.fromUserInput(message.epochProvisions, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.WeightedAddress = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.WeightedAddress.typeUrl ||
...
exports.DistributionProportions = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DistributionProportions.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.staking !== '') {
            writer
                .uint32(10)
                .string(math_1.Decimal.fromUserInput(message.staking, 18).atomics);
        }
        if (message.poolIncentives !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.poolIncentives, 18).atomics);
        }
        if (message.developerRewards !== '') {
            writer
                .uint32(26)
                .string(math_1.Decimal.fromUserInput(message.developerRewards, 18).atomics);
        }
    ...
    fromAmino(object) {
        ...
        if (object.pool_incentives !== undefined &&
            object.pool_incentives !== null) {
            message.poolIncentives = object.pool_incentives;
        }
        if (object.developer_rewards !== undefined &&
...
exports.Params = {
        ...
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (typeof o.mintDenom === 'string' &&
                    ...
                    exports.DistributionProportions.is(o.distributionProportions) &&
                    Array.isArray(o.weightedDeveloperRewardsReceivers) &&
                    (!o.weightedDeveloperRewardsReceivers.length ||
                        exports.WeightedAddress.is(o.weightedDeveloperRewardsReceivers[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (typeof o.mint_denom === 'string' &&
                    ...
                    exports.DistributionProportions.isSDK(o.distribution_proportions) &&
                    Array.isArray(o.weighted_developer_rewards_receivers) &&
                    (!o.weighted_developer_rewards_receivers.length ||
                        exports.WeightedAddress.isSDK(o.weighted_developer_rewards_receivers[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (typeof o.mint_denom === 'string' &&
                    ...
                    typeof o.reduction_period_in_epochs === 'bigint' &&
                    typeof o.reduction_factor === 'string' &&
                    exports.DistributionProportions.isAmino(o.distribution_proportions) &&
                    Array.isArray(o.weighted_developer_rewards_receivers) &&
                    (!o.weighted_developer_rewards_receivers.length ||
                        exports.WeightedAddress.isAmino(o.weighted_developer_rewards_receivers[0])) &&
                    typeof o.minting_rewards_distribution_start_epoch === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.genesisEpochProvisions !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.genesisEpochProvisions, 18).atomics);
        }
        ...
        if (message.reductionFactor !== '') {
            writer
                .uint32(42)
                .string(math_1.Decimal.fromUserInput(message.reductionFactor, 18).atomics);
        }
    ...
    fromPartial(object) {
        ...
        message.distributionProportions =
            object.distributionProportions !== undefined &&
                ...
                ? exports.DistributionProportions.fromPartial(object.distributionProportions)
                : undefined;
    ...
    fromAmino(object) {
        ...
        message.weightedDeveloperRewardsReceivers =
            object.weighted_developer_rewards_receivers?.map(e => exports.WeightedAddress.fromAmino(e)) || [];
        if (object.minting_rewards_distribution_start_epoch !== undefined &&
    ...
    toAmino(message) {
        ...
        obj.distribution_proportions = message.distributionProportions
            ? exports.DistributionProportions.toAmino(message.distributionProportions)
            : undefined;
        if (message.weightedDeveloperRewardsReceivers) {
            obj.weighted_developer_rewards_receivers =
                message.weightedDeveloperRewardsReceivers.map(e => e ? exports.WeightedAddress.toAmino(e) : undefined);
        }
        else {
            obj.weighted_developer_rewards_receivers =
                message.weightedDeveloperRewardsReceivers;
