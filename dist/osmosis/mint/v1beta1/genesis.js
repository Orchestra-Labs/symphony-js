...
exports.GenesisState = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (mint_1.Minter.is(o.minter) &&
                    mint_1.Params.is(o.params) &&
                    typeof o.reductionStartedEpoch === 'bigint')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (mint_1.Minter.isSDK(o.minter) &&
                    mint_1.Params.isSDK(o.params) &&
                    typeof o.reduction_started_epoch === 'bigint')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (mint_1.Minter.isAmino(o.minter) &&
                    mint_1.Params.isAmino(o.params) &&
                    typeof o.reduction_started_epoch === 'bigint')));
    },
    ...
    fromAmino(object) {
        ...
        if (object.reduction_started_epoch !== undefined &&
