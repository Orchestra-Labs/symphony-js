...
exports.QueryParamsResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || mint_1.Params.isSDK(o.params)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || mint_1.Params.isAmino(o.params)));
    },
...
exports.QueryEpochProvisionsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryEpochProvisionsResponse.typeUrl ||
    ...
    toAmino(message) {
        ...
        obj.epoch_provisions = message.epochProvisions
            ? (0, helpers_1.base64FromBytes)(message.epochProvisions)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
