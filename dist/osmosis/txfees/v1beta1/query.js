...
exports.QueryFeeTokensResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryFeeTokensResponse.typeUrl ||
        ...
        return (o &&
            (o.$typeUrl === exports.QueryFeeTokensResponse.typeUrl ||
                (Array.isArray(o.fee_tokens) &&
                    (!o.fee_tokens.length || feetoken_1.FeeToken.isSDK(o.fee_tokens[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryFeeTokensResponse.typeUrl ||
                (Array.isArray(o.fee_tokens) &&
                    (!o.fee_tokens.length || feetoken_1.FeeToken.isAmino(o.fee_tokens[0])))));
    },
    ...
    fromAmino(object) {
        const message = createBaseQueryFeeTokensResponse();
        message.feeTokens =
            object.fee_tokens?.map(e => feetoken_1.FeeToken.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryDenomSpotPriceRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomSpotPriceRequest.typeUrl ||
...
exports.QueryDenomSpotPriceResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomSpotPriceResponse.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.spotPrice !== '') {
            writer
                .uint32(18)
                .string(math_1.Decimal.fromUserInput(message.spotPrice, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.QueryDenomPoolIdRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomPoolIdRequest.typeUrl ||
                typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryDenomPoolIdResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDenomPoolIdResponse.typeUrl ||
...
exports.QueryBaseDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryBaseDenomResponse.typeUrl ||
...
exports.QueryEipBaseFeeResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryEipBaseFeeResponse.typeUrl ||
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.baseFee !== '') {
            writer
                .uint32(10)
                .string(math_1.Decimal.fromUserInput(message.baseFee, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
