...
exports.Node = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Node.typeUrl ||
                (Array.isArray(o.children) &&
                    (!o.children.length || exports.Child.is(o.children[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Node.typeUrl ||
                (Array.isArray(o.children) &&
                    (!o.children.length || exports.Child.isSDK(o.children[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Node.typeUrl ||
                (Array.isArray(o.children) &&
                    (!o.children.length || exports.Child.isAmino(o.children[0])))));
    },
...
exports.Child = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Child.typeUrl ||
    ...
    fromPartial(object) {
        ...
        message.leaf =
            object.leaf !== undefined && object.leaf !== null
                ? exports.Child.fromPartial(object.leaf)
                : undefined;
        return message;
    },
    fromAmino(object) {
