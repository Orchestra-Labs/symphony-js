...
exports.ModuleBalanceResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleBalanceResponse.typeUrl ||
...
exports.ModuleLockedAmountResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ModuleLockedAmountResponse.typeUrl ||
                (Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.is(o.coins[0])))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountUnlockableCoinsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountUnlockableCoinsRequest.typeUrl ||
...
exports.AccountUnlockableCoinsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountUnlockableCoinsResponse.typeUrl ||
                (Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.is(o.coins[0])))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountUnlockingCoinsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountUnlockingCoinsRequest.typeUrl ||
                typeof o.owner === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountUnlockingCoinsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountUnlockingCoinsResponse.typeUrl ||
                (Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.is(o.coins[0])))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountLockedCoinsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedCoinsRequest.typeUrl ||
                typeof o.owner === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountLockedCoinsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedCoinsResponse.typeUrl ||
                (Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.is(o.coins[0])))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountLockedPastTimeRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeRequest.typeUrl ||
                (typeof o.owner === 'string' && timestamp_1.Timestamp.is(o.timestamp))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeRequest.typeUrl ||
                (typeof o.owner === 'string' && timestamp_1.Timestamp.isSDK(o.timestamp))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeRequest.typeUrl ||
                (typeof o.owner === 'string' && timestamp_1.Timestamp.isAmino(o.timestamp))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.owner !== '') {
            writer.uint32(10).string(message.owner);
...
exports.AccountLockedPastTimeResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeResponse.typeUrl ||
...
exports.AccountLockedPastTimeNotUnlockingOnlyRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeNotUnlockingOnlyRequest.typeUrl ||
                (typeof o.owner === 'string' && timestamp_1.Timestamp.is(o.timestamp))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountLockedPastTimeNotUnlockingOnlyResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeNotUnlockingOnlyResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
...
exports.AccountUnlockedBeforeTimeRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountUnlockedBeforeTimeRequest.typeUrl ||
                (typeof o.owner === 'string' && timestamp_1.Timestamp.is(o.timestamp))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountUnlockedBeforeTimeResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountUnlockedBeforeTimeResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
...
exports.AccountLockedPastTimeDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeDenomRequest.typeUrl ||
                (typeof o.owner === 'string' &&
...
exports.AccountLockedPastTimeDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedPastTimeDenomResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
...
exports.LockedDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LockedDenomRequest.typeUrl ||
                (typeof o.denom === 'string' && duration_1.Duration.is(o.duration))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.LockedDenomRequest.typeUrl ||
                (typeof o.denom === 'string' && duration_1.Duration.isSDK(o.duration))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.LockedDenomRequest.typeUrl ||
                (typeof o.denom === 'string' && duration_1.Duration.isAmino(o.duration))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.denom !== '') {
...
exports.LockedDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LockedDenomResponse.typeUrl ||
...
exports.LockedRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LockedRequest.typeUrl || typeof o.lockId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.LockedRequest.typeUrl || typeof o.lock_id === 'bigint'));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.LockedRequest.typeUrl || typeof o.lock_id === 'bigint'));
    ...
    fromPartial(object) {
        ...
        message.lock =
            object.lock !== undefined && object.lock !== null
                ? lock_1.PeriodLock.fromPartial(object.lock)
                : undefined;
        return message;
    },
    fromAmino(object) {
...
exports.LockRewardReceiverRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LockRewardReceiverRequest.typeUrl ||
...
exports.LockRewardReceiverResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LockRewardReceiverResponse.typeUrl ||
...
exports.NextLockIDResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.NextLockIDResponse.typeUrl ||
                typeof o.lockId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
...
exports.SyntheticLockupsByLockupIDRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SyntheticLockupsByLockupIDRequest.typeUrl ||
                typeof o.lockId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
...
exports.SyntheticLockupsByLockupIDResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SyntheticLockupsByLockupIDResponse.typeUrl ||
...
exports.SyntheticLockupByLockupIDRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SyntheticLockupByLockupIDRequest.typeUrl ||
                typeof o.lockId === 'bigint'));
    },
    isSDK(o) {
        return (o &&
...
exports.SyntheticLockupByLockupIDResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SyntheticLockupByLockupIDResponse.typeUrl ||
...
exports.AccountLockedLongerDurationRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedLongerDurationRequest.typeUrl ||
                (typeof o.owner === 'string' && duration_1.Duration.is(o.duration))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedLongerDurationRequest.typeUrl ||
                (typeof o.owner === 'string' && duration_1.Duration.isSDK(o.duration))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedLongerDurationRequest.typeUrl ||
                (typeof o.owner === 'string' && duration_1.Duration.isAmino(o.duration))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.owner !== '') {
            writer.uint32(10).string(message.owner);
...
exports.AccountLockedLongerDurationResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedLongerDurationResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
...
exports.AccountLockedDurationRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedDurationRequest.typeUrl ||
                (typeof o.owner === 'string' && duration_1.Duration.is(o.duration))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountLockedDurationResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedDurationResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
...
exports.AccountLockedLongerDurationNotUnlockingOnlyRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.AccountLockedLongerDurationNotUnlockingOnlyRequest.typeUrl ||
                (typeof o.owner === 'string' && duration_1.Duration.is(o.duration))));
    },
    isSDK(o) {
        return (o &&
...
exports.AccountLockedLongerDurationNotUnlockingOnlyResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.AccountLockedLongerDurationNotUnlockingOnlyResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
...
exports.AccountLockedLongerDurationDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedLongerDurationDenomRequest.typeUrl ||
                (typeof o.owner === 'string' &&
...
exports.AccountLockedLongerDurationDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AccountLockedLongerDurationDenomResponse.typeUrl ||
                (Array.isArray(o.locks) &&
                    (!o.locks.length || lock_1.PeriodLock.is(o.locks[0])))));
    },
    isSDK(o) {
