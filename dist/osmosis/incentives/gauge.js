...
exports.Gauge = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Gauge.typeUrl ||
                (typeof o.id === 'bigint' &&
                    ...
                    (!o.distributedCoins.length || coin_1.Coin.is(o.distributedCoins[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Gauge.typeUrl ||
                (typeof o.id === 'bigint' &&
                    ...
                    (!o.distributed_coins.length || coin_1.Coin.isSDK(o.distributed_coins[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Gauge.typeUrl ||
                (typeof o.id === 'bigint' &&
                    ...
                    (!o.distributed_coins.length ||
                        coin_1.Coin.isAmino(o.distributed_coins[0])))));
    },
    ...
    fromPartial(object) {
        ...
        message.distributedCoins =
            object.distributedCoins?.map(e => coin_1.Coin.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseGauge();
        ...
        message.distributedCoins =
            object.distributed_coins?.map(e => coin_1.Coin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
