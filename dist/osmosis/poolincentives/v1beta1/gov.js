...
exports.ReplacePoolIncentivesProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ReplacePoolIncentivesProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || incentives_1.DistrRecord.is(o.records[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ReplacePoolIncentivesProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || incentives_1.DistrRecord.isSDK(o.records[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ReplacePoolIncentivesProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || incentives_1.DistrRecord.isAmino(o.records[0])))));
    },
    ...
    fromPartial(object) {
        ...
        message.records =
            object.records?.map(e => incentives_1.DistrRecord.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseReplacePoolIncentivesProposal();
...
exports.UpdatePoolIncentivesProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.UpdatePoolIncentivesProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || incentives_1.DistrRecord.is(o.records[0])))));
