...
exports.LockableDurationsInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.LockableDurationsInfo.typeUrl ||
...
exports.DistrInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DistrInfo.typeUrl ||
                (typeof o.totalWeight === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || exports.DistrRecord.is(o.records[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.DistrInfo.typeUrl ||
                (typeof o.total_weight === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || exports.DistrRecord.isSDK(o.records[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.DistrInfo.typeUrl ||
                (typeof o.total_weight === 'string' &&
                    Array.isArray(o.records) &&
                    (!o.records.length || exports.DistrRecord.isAmino(o.records[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.records =
            object.records?.map(e => exports.DistrRecord.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseDistrInfo();
...
exports.DistrRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.DistrRecord.typeUrl ||
...
exports.PoolToGauge = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.PoolToGauge.typeUrl ||
...
exports.AnyPoolToInternalGauges = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AnyPoolToInternalGauges.typeUrl ||
                (Array.isArray(o.poolToGauge) &&
                    (!o.poolToGauge.length || exports.PoolToGauge.is(o.poolToGauge[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AnyPoolToInternalGauges.typeUrl ||
                (Array.isArray(o.pool_to_gauge) &&
                    (!o.pool_to_gauge.length || exports.PoolToGauge.isSDK(o.pool_to_gauge[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AnyPoolToInternalGauges.typeUrl ||
                (Array.isArray(o.pool_to_gauge) &&
                    (!o.pool_to_gauge.length || exports.PoolToGauge.isAmino(o.pool_to_gauge[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseAnyPoolToInternalGauges();
        message.poolToGauge =
            object.poolToGauge?.map(e => exports.PoolToGauge.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseAnyPoolToInternalGauges();
        message.poolToGauge =
            object.pool_to_gauge?.map(e => exports.PoolToGauge.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.ConcentratedPoolToNoLockGauges = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ConcentratedPoolToNoLockGauges.typeUrl ||
                (Array.isArray(o.poolToGauge) &&
                    (!o.poolToGauge.length || exports.PoolToGauge.is(o.poolToGauge[0])))));
    },
    isSDK(o) {
