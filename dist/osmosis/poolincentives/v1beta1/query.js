...
exports.QueryGaugeIdsRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGaugeIdsRequest.typeUrl ||
...
exports.QueryGaugeIdsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGaugeIdsResponse.typeUrl ||
                (Array.isArray(o.gaugeIdsWithDuration) &&
                    (!o.gaugeIdsWithDuration.length ||
                        exports.QueryGaugeIdsResponse_GaugeIdWithDuration.is(o.gaugeIdsWithDuration[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGaugeIdsResponse.typeUrl ||
                (Array.isArray(o.gauge_ids_with_duration) &&
                    (!o.gauge_ids_with_duration.length ||
                        exports.QueryGaugeIdsResponse_GaugeIdWithDuration.isSDK(o.gauge_ids_with_duration[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGaugeIdsResponse.typeUrl ||
                (Array.isArray(o.gauge_ids_with_duration) &&
                    (!o.gauge_ids_with_duration.length ||
                        exports.QueryGaugeIdsResponse_GaugeIdWithDuration.isAmino(o.gauge_ids_with_duration[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryGaugeIdsResponse();
        message.gaugeIdsWithDuration =
            object.gauge_ids_with_duration?.map(e => exports.QueryGaugeIdsResponse_GaugeIdWithDuration.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryGaugeIdsResponse_GaugeIdWithDuration = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryGaugeIdsResponse_GaugeIdWithDuration.typeUrl ||
    ...
    fromAmino(object) {
        ...
        if (object.gauge_incentive_percentage !== undefined &&
...
exports.QueryDistrInfoResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDistrInfoResponse.typeUrl ||
                incentives_1.DistrInfo.is(o.distrInfo)));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDistrInfoResponse.typeUrl ||
                incentives_1.DistrInfo.isSDK(o.distr_info)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryDistrInfoResponse.typeUrl ||
                incentives_1.DistrInfo.isAmino(o.distr_info)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryParamsResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || incentives_1.Params.isSDK(o.params)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryParamsResponse.typeUrl || incentives_1.Params.isAmino(o.params)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.IncentivizedPool = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.IncentivizedPool.typeUrl ||
                (typeof o.poolId === 'bigint' &&
                    duration_1.Duration.is(o.lockableDuration) &&
                    typeof o.gaugeId === 'bigint')));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.IncentivizedPool.typeUrl ||
                (typeof o.pool_id === 'bigint' &&
                    duration_1.Duration.isSDK(o.lockable_duration) &&
                    typeof o.gauge_id === 'bigint')));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.IncentivizedPool.typeUrl ||
                (typeof o.pool_id === 'bigint' &&
                    duration_1.Duration.isAmino(o.lockable_duration) &&
                    typeof o.gauge_id === 'bigint')));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.poolId !== BigInt(0)) {
    ...
    fromPartial(object) {
        ...
        message.lockableDuration =
            object.lockableDuration !== undefined && object.lockableDuration !== null
                ? duration_1.Duration.fromPartial(object.lockableDuration)
                : undefined;
        message.gaugeId =
            object.gaugeId !== undefined && object.gaugeId !== null
                ? BigInt(object.gaugeId.toString())
    ...
    fromAmino(object) {
        ...
        if (object.lockable_duration !== undefined &&
    ...
    toAmino(message) {
        ...
        obj.lockable_duration = message.lockableDuration
            ? duration_1.Duration.toAmino(message.lockableDuration)
            : undefined;
        obj.gauge_id =
            message.gaugeId !== BigInt(0) ? message.gaugeId.toString() : undefined;
        return obj;
...
exports.QueryIncentivizedPoolsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryIncentivizedPoolsResponse.typeUrl ||
                (Array.isArray(o.incentivizedPools) &&
                    (!o.incentivizedPools.length ||
                        exports.IncentivizedPool.is(o.incentivizedPools[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryIncentivizedPoolsResponse.typeUrl ||
                (Array.isArray(o.incentivized_pools) &&
                    (!o.incentivized_pools.length ||
                        exports.IncentivizedPool.isSDK(o.incentivized_pools[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryIncentivizedPoolsResponse.typeUrl ||
                (Array.isArray(o.incentivized_pools) &&
                    (!o.incentivized_pools.length ||
                        exports.IncentivizedPool.isAmino(o.incentivized_pools[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.incentivizedPools =
            object.incentivizedPools?.map(e => exports.IncentivizedPool.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseQueryIncentivizedPoolsResponse();
        message.incentivizedPools =
            object.incentivized_pools?.map(e => exports.IncentivizedPool.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryExternalIncentiveGaugesResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryExternalIncentiveGaugesResponse.typeUrl ||
