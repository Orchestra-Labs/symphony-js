...
const createRPCQueryClient = async ({ rpcEndpoint, }) => {
    ...
    return {
        ...
        osmosis: {
            bridge: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require('./bridge/v1beta1/query.rpc.Query')))).createRpcQueryExtension(client),
            },
            ...
            market: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require('./market/v1beta1/query.rpc.Query')))).createRpcQueryExtension(client),
            },
            mint: {
            ...
            treasury: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require('./treasury/v1beta1/query.rpc.Query')))).createRpcQueryExtension(client),
            },
            twap: {
