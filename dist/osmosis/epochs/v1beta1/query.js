...
exports.QueryEpochsInfoResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryEpochsInfoResponse.typeUrl ||
                (Array.isArray(o.epochs) &&
                    (!o.epochs.length || genesis_1.EpochInfo.is(o.epochs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryEpochsInfoResponse.typeUrl ||
                (Array.isArray(o.epochs) &&
                    (!o.epochs.length || genesis_1.EpochInfo.isSDK(o.epochs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryEpochsInfoResponse.typeUrl ||
                (Array.isArray(o.epochs) &&
                    (!o.epochs.length || genesis_1.EpochInfo.isAmino(o.epochs[0])))));
    },
...
exports.QueryCurrentEpochRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryCurrentEpochRequest.typeUrl ||
...
exports.QueryCurrentEpochResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryCurrentEpochResponse.typeUrl ||
