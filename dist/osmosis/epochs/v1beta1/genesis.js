...
exports.EpochInfo = {
        ...
        return (o &&
            (o.$typeUrl === exports.EpochInfo.typeUrl ||
                (typeof o.identifier === 'string' &&
                    ...
                    timestamp_1.Timestamp.isSDK(o.current_epoch_start_time) &&
        ...
        return (o &&
            (o.$typeUrl === exports.EpochInfo.typeUrl ||
                (typeof o.identifier === 'string' &&
                    ...
                    typeof o.current_epoch === 'bigint' &&
                    timestamp_1.Timestamp.isAmino(o.current_epoch_start_time) &&
                    typeof o.epoch_counting_started === 'boolean' &&
                    typeof o.current_epoch_start_height === 'bigint')));
    },
    ...
    fromAmino(object) {
        ...
        if (object.current_epoch_start_time !== undefined &&
    ...
    toAmino(message) {
        ...
        obj.current_epoch_start_time = message.currentEpochStartTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.currentEpochStartTime))
            : undefined;
        ...
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.epochs) &&
                    (!o.epochs.length || exports.EpochInfo.is(o.epochs[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.epochs) &&
                    (!o.epochs.length || exports.EpochInfo.isSDK(o.epochs[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.epochs) &&
                    (!o.epochs.length || exports.EpochInfo.isAmino(o.epochs[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
