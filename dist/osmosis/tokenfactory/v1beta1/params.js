...
exports.Params = {
        ...
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (Array.isArray(o.denomCreationFee) &&
                    (!o.denomCreationFee.length || coin_1.Coin.is(o.denomCreationFee[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (Array.isArray(o.denom_creation_fee) &&
                    (!o.denom_creation_fee.length ||
                        coin_1.Coin.isSDK(o.denom_creation_fee[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.Params.typeUrl ||
                (Array.isArray(o.denom_creation_fee) &&
                    (!o.denom_creation_fee.length ||
                        coin_1.Coin.isAmino(o.denom_creation_fee[0])))));
    },
    ...
    fromPartial(object) {
        ...
        message.denomCreationFee =
            object.denomCreationFee?.map(e => coin_1.Coin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        const message = createBaseParams();
        message.denomCreationFee =
            object.denom_creation_fee?.map(e => coin_1.Coin.fromAmino(e)) || [];
