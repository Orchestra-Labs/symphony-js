...
exports.AssetTypeRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AssetTypeRequest.typeUrl || typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AssetTypeRequest.typeUrl || typeof o.denom === 'string'));
...
exports.AllAssetsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AllAssetsResponse.typeUrl ||
                (Array.isArray(o.assets) &&
                    (!o.assets.length || superfluid_1.SuperfluidAsset.is(o.assets[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AllAssetsResponse.typeUrl ||
                (Array.isArray(o.assets) &&
                    (!o.assets.length || superfluid_1.SuperfluidAsset.isSDK(o.assets[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AllAssetsResponse.typeUrl ||
                (Array.isArray(o.assets) &&
                    (!o.assets.length || superfluid_1.SuperfluidAsset.isAmino(o.assets[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseAllAssetsResponse();
        message.assets =
            object.assets?.map(e => superfluid_1.SuperfluidAsset.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseAllAssetsResponse();
        message.assets =
            object.assets?.map(e => superfluid_1.SuperfluidAsset.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.AssetMultiplierRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AssetMultiplierRequest.typeUrl ||
            ...
            switch (tag >>> 3) {
                case 1:
                    message.osmoEquivalentMultiplier =
                        superfluid_1.OsmoEquivalentMultiplierRecord.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromPartial(object) {
        ...
        message.osmoEquivalentMultiplier =
            object.osmoEquivalentMultiplier !== undefined &&
                ...
                ? superfluid_1.OsmoEquivalentMultiplierRecord.fromPartial(object.osmoEquivalentMultiplier)
                : undefined;
        return message;
    },
    fromAmino(object) {
        ...
        if (object.osmo_equivalent_multiplier !== undefined &&
            ...
            message.osmoEquivalentMultiplier =
                superfluid_1.OsmoEquivalentMultiplierRecord.fromAmino(object.osmo_equivalent_multiplier);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.osmo_equivalent_multiplier = message.osmoEquivalentMultiplier
            ? superfluid_1.OsmoEquivalentMultiplierRecord.toAmino(message.osmoEquivalentMultiplier)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.SuperfluidIntermediaryAccountInfo = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidIntermediaryAccountInfo.typeUrl ||
                (typeof o.denom === 'string' &&
...
exports.AllIntermediaryAccountsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.AllIntermediaryAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        exports.SuperfluidIntermediaryAccountInfo.is(o.accounts[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.AllIntermediaryAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        exports.SuperfluidIntermediaryAccountInfo.isSDK(o.accounts[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.AllIntermediaryAccountsResponse.typeUrl ||
                (Array.isArray(o.accounts) &&
                    (!o.accounts.length ||
                        exports.SuperfluidIntermediaryAccountInfo.isAmino(o.accounts[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseAllIntermediaryAccountsResponse();
        message.accounts =
            object.accounts?.map(e => exports.SuperfluidIntermediaryAccountInfo.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
    ...
    fromAmino(object) {
        const message = createBaseAllIntermediaryAccountsResponse();
        message.accounts =
            object.accounts?.map(e => exports.SuperfluidIntermediaryAccountInfo.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.ConnectedIntermediaryAccountRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ConnectedIntermediaryAccountRequest.typeUrl ||
...
exports.ConnectedIntermediaryAccountResponse = {
    ...
    fromPartial(object) {
        ...
        message.account =
            object.account !== undefined && object.account !== null
                ? exports.SuperfluidIntermediaryAccountInfo.fromPartial(object.account)
                : undefined;
        return message;
    },
    fromAmino(object) {
    ...
    toAmino(message) {
        ...
        obj.account = message.account
            ? exports.SuperfluidIntermediaryAccountInfo.toAmino(message.account)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.QueryTotalDelegationByValidatorForDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByValidatorForDenomRequest.typeUrl ||
                typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryTotalDelegationByValidatorForDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByValidatorForDenomResponse.typeUrl ||
                (Array.isArray(o.assets) &&
                    (!o.assets.length || exports.Delegations.is(o.assets[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByValidatorForDenomResponse.typeUrl ||
                (Array.isArray(o.assets) &&
                    (!o.assets.length || exports.Delegations.isSDK(o.assets[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByValidatorForDenomResponse.typeUrl ||
                (Array.isArray(o.assets) &&
                    (!o.assets.length || exports.Delegations.isAmino(o.assets[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        for (const v of message.assets) {
...
exports.Delegations = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.Delegations.typeUrl ||
                (typeof o.valAddr === 'string' &&
...
exports.TotalSuperfluidDelegationsResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TotalSuperfluidDelegationsResponse.typeUrl ||
...
exports.SuperfluidDelegationAmountRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationAmountRequest.typeUrl ||
...
exports.SuperfluidDelegationAmountResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationAmountResponse.typeUrl ||
...
exports.SuperfluidDelegationsByDelegatorRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationsByDelegatorRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.SuperfluidDelegationsByDelegatorResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationsByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluidDelegationRecords) &&
                    (!o.superfluidDelegationRecords.length ||
                        superfluid_1.SuperfluidDelegationRecord.is(o.superfluidDelegationRecords[0])) &&
                    Array.isArray(o.totalDelegatedCoins) &&
                    (!o.totalDelegatedCoins.length ||
                        coin_1.Coin.is(o.totalDelegatedCoins[0])) &&
                    coin_1.Coin.is(o.totalEquivalentStakedAmount))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationsByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluid_delegation_records) &&
                    (!o.superfluid_delegation_records.length ||
                        superfluid_1.SuperfluidDelegationRecord.isSDK(o.superfluid_delegation_records[0])) &&
                    Array.isArray(o.total_delegated_coins) &&
                    (!o.total_delegated_coins.length ||
                        coin_1.Coin.isSDK(o.total_delegated_coins[0])) &&
                    coin_1.Coin.isSDK(o.total_equivalent_staked_amount))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationsByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluid_delegation_records) &&
                    (!o.superfluid_delegation_records.length ||
                        superfluid_1.SuperfluidDelegationRecord.isAmino(o.superfluid_delegation_records[0])) &&
                    Array.isArray(o.total_delegated_coins) &&
                    (!o.total_delegated_coins.length ||
                        coin_1.Coin.isAmino(o.total_delegated_coins[0])) &&
                    coin_1.Coin.isAmino(o.total_equivalent_staked_amount))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseSuperfluidDelegationsByDelegatorResponse();
        message.superfluidDelegationRecords =
            object.superfluid_delegation_records?.map(e => superfluid_1.SuperfluidDelegationRecord.fromAmino(e)) || [];
        message.totalDelegatedCoins =
            object.total_delegated_coins?.map(e => coin_1.Coin.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        if (message.superfluidDelegationRecords) {
            obj.superfluid_delegation_records =
                message.superfluidDelegationRecords.map(e => e ? superfluid_1.SuperfluidDelegationRecord.toAmino(e) : undefined);
        }
        else {
        ...
        obj.total_equivalent_staked_amount = message.totalEquivalentStakedAmount
            ? coin_1.Coin.toAmino(message.totalEquivalentStakedAmount)
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.SuperfluidUndelegationsByDelegatorRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidUndelegationsByDelegatorRequest.typeUrl ||
...
exports.SuperfluidUndelegationsByDelegatorResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidUndelegationsByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluidDelegationRecords) &&
                    (!o.superfluidDelegationRecords.length ||
                        superfluid_1.SuperfluidDelegationRecord.is(o.superfluidDelegationRecords[0])) &&
                    Array.isArray(o.totalUndelegatedCoins) &&
                    (!o.totalUndelegatedCoins.length ||
                        coin_1.Coin.is(o.totalUndelegatedCoins[0])) &&
            ...
            (o.$typeUrl === exports.SuperfluidUndelegationsByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluid_delegation_records) &&
                    ...
                    (!o.total_undelegated_coins.length ||
                        coin_1.Coin.isSDK(o.total_undelegated_coins[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.SuperfluidUndelegationsByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluid_delegation_records) &&
                    ...
                    Array.isArray(o.total_undelegated_coins) &&
                    (!o.total_undelegated_coins.length ||
                        coin_1.Coin.isAmino(o.total_undelegated_coins[0])) &&
                    Array.isArray(o.synthetic_locks) &&
                    (!o.synthetic_locks.length ||
    ...
    fromPartial(object) {
        ...
        message.totalUndelegatedCoins =
            object.totalUndelegatedCoins?.map(e => coin_1.Coin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.superfluidDelegationRecords =
            object.superfluid_delegation_records?.map(e => superfluid_1.SuperfluidDelegationRecord.fromAmino(e)) || [];
        message.totalUndelegatedCoins =
            object.total_undelegated_coins?.map(e => coin_1.Coin.fromAmino(e)) || [];
        message.syntheticLocks =
...
exports.SuperfluidDelegationsByValidatorDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationsByValidatorDenomRequest.typeUrl ||
...
exports.SuperfluidDelegationsByValidatorDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SuperfluidDelegationsByValidatorDenomResponse.typeUrl ||
                (Array.isArray(o.superfluidDelegationRecords) &&
                    (!o.superfluidDelegationRecords.length ||
                        superfluid_1.SuperfluidDelegationRecord.is(o.superfluidDelegationRecords[0])))));
    },
...
exports.EstimateSuperfluidDelegatedAmountByValidatorDenomRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.EstimateSuperfluidDelegatedAmountByValidatorDenomRequest.typeUrl ||
                (typeof o.validatorAddress === 'string' && typeof o.denom === 'string')));
    },
    isSDK(o) {
        return (o &&
...
exports.EstimateSuperfluidDelegatedAmountByValidatorDenomResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.EstimateSuperfluidDelegatedAmountByValidatorDenomResponse.typeUrl ||
                (Array.isArray(o.totalDelegatedCoins) &&
                    (!o.totalDelegatedCoins.length || coin_1.Coin.is(o.totalDelegatedCoins[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl ===
...
exports.QueryTotalDelegationByDelegatorRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByDelegatorRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryTotalDelegationByDelegatorResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluidDelegationRecords) &&
                    (!o.superfluidDelegationRecords.length ||
                        superfluid_1.SuperfluidDelegationRecord.is(o.superfluidDelegationRecords[0])) &&
                    Array.isArray(o.delegationResponse) &&
                    (!o.delegationResponse.length ||
                        staking_1.DelegationResponse.is(o.delegationResponse[0])) &&
                    Array.isArray(o.totalDelegatedCoins) &&
                    (!o.totalDelegatedCoins.length ||
                        coin_1.Coin.is(o.totalDelegatedCoins[0])) &&
                    coin_1.Coin.is(o.totalEquivalentStakedAmount))));
            ...
            (o.$typeUrl === exports.QueryTotalDelegationByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluid_delegation_records) &&
                    ...
                    (!o.delegation_response.length ||
                        staking_1.DelegationResponse.isSDK(o.delegation_response[0])) &&
                    Array.isArray(o.total_delegated_coins) &&
                    (!o.total_delegated_coins.length ||
                        coin_1.Coin.isSDK(o.total_delegated_coins[0])) &&
                    coin_1.Coin.isSDK(o.total_equivalent_staked_amount))));
        ...
        return (o &&
            (o.$typeUrl === exports.QueryTotalDelegationByDelegatorResponse.typeUrl ||
                (Array.isArray(o.superfluid_delegation_records) &&
                    ...
                    Array.isArray(o.delegation_response) &&
                    (!o.delegation_response.length ||
                        staking_1.DelegationResponse.isAmino(o.delegation_response[0])) &&
                    Array.isArray(o.total_delegated_coins) &&
                    (!o.total_delegated_coins.length ||
                        coin_1.Coin.isAmino(o.total_delegated_coins[0])) &&
                    coin_1.Coin.isAmino(o.total_equivalent_staked_amount))));
    ...
    fromAmino(object) {
        ...
        message.superfluidDelegationRecords =
            object.superfluid_delegation_records?.map(e => superfluid_1.SuperfluidDelegationRecord.fromAmino(e)) || [];
        message.delegationResponse =
            object.delegation_response?.map(e => staking_1.DelegationResponse.fromAmino(e)) ||
                [];
        message.totalDelegatedCoins =
            object.total_delegated_coins?.map(e => coin_1.Coin.fromAmino(e)) || [];
        if (object.total_equivalent_staked_amount !== undefined &&
...
exports.QueryUnpoolWhitelistResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryUnpoolWhitelistResponse.typeUrl ||
...
exports.UserConcentratedSuperfluidPositionsDelegatedRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.UserConcentratedSuperfluidPositionsDelegatedRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.UserConcentratedSuperfluidPositionsDelegatedResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.UserConcentratedSuperfluidPositionsDelegatedResponse.typeUrl ||
                (Array.isArray(o.clPoolUserPositionRecords) &&
                    (!o.clPoolUserPositionRecords.length ||
                        superfluid_1.ConcentratedPoolUserPositionRecord.is(o.clPoolUserPositionRecords[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl ===
                ...
                (Array.isArray(o.cl_pool_user_position_records) &&
                    (!o.cl_pool_user_position_records.length ||
                        superfluid_1.ConcentratedPoolUserPositionRecord.isSDK(o.cl_pool_user_position_records[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl ===
                ...
                (Array.isArray(o.cl_pool_user_position_records) &&
                    (!o.cl_pool_user_position_records.length ||
                        superfluid_1.ConcentratedPoolUserPositionRecord.isAmino(o.cl_pool_user_position_records[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseUserConcentratedSuperfluidPositionsDelegatedResponse();
        message.clPoolUserPositionRecords =
            object.cl_pool_user_position_records?.map(e => superfluid_1.ConcentratedPoolUserPositionRecord.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.UserConcentratedSuperfluidPositionsUndelegatingRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.UserConcentratedSuperfluidPositionsUndelegatingRequest.typeUrl ||
                typeof o.delegatorAddress === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.UserConcentratedSuperfluidPositionsUndelegatingResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl ===
                exports.UserConcentratedSuperfluidPositionsUndelegatingResponse.typeUrl ||
                (Array.isArray(o.clPoolUserPositionRecords) &&
                    (!o.clPoolUserPositionRecords.length ||
                        superfluid_1.ConcentratedPoolUserPositionRecord.is(o.clPoolUserPositionRecords[0])))));
    },
...
exports.QueryRestSupplyRequest = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRestSupplyRequest.typeUrl ||
                typeof o.denom === 'string'));
    },
    isSDK(o) {
        return (o &&
...
exports.QueryRestSupplyResponse = {
    ...
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRestSupplyResponse.typeUrl || coin_1.Coin.isSDK(o.amount)));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.QueryRestSupplyResponse.typeUrl || coin_1.Coin.isAmino(o.amount)));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
