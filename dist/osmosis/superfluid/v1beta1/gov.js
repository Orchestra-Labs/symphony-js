...
exports.SetSuperfluidAssetsProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.SetSuperfluidAssetsProposal.typeUrl ||
...
exports.RemoveSuperfluidAssetsProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.RemoveSuperfluidAssetsProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
...
exports.UpdateUnpoolWhiteListProposal = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.UpdateUnpoolWhiteListProposal.typeUrl ||
                (typeof o.title === 'string' &&
                    typeof o.description === 'string' &&
                    Array.isArray(o.ids) &&
