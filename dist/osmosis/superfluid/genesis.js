...
exports.GenesisState = {
            ...
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (params_1.Params.is(o.params) &&
                    ...
                    (!o.superfluidAssets.length ||
                        superfluid_1.SuperfluidAsset.is(o.superfluidAssets[0])) &&
                    Array.isArray(o.osmoEquivalentMultipliers) &&
                    (!o.osmoEquivalentMultipliers.length ||
                        superfluid_1.OsmoEquivalentMultiplierRecord.is(o.osmoEquivalentMultipliers[0])) &&
                    Array.isArray(o.intermediaryAccounts) &&
                    (!o.intermediaryAccounts.length ||
                        superfluid_1.SuperfluidIntermediaryAccount.is(o.intermediaryAccounts[0])) &&
                    Array.isArray(o.intemediaryAccountConnections) &&
                    (!o.intemediaryAccountConnections.length ||
                        superfluid_1.LockIdIntermediaryAccountConnection.is(o.intemediaryAccountConnections[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (params_1.Params.isSDK(o.params) &&
                    ...
                    (!o.superfluid_assets.length ||
                        superfluid_1.SuperfluidAsset.isSDK(o.superfluid_assets[0])) &&
                    Array.isArray(o.osmo_equivalent_multipliers) &&
                    (!o.osmo_equivalent_multipliers.length ||
                        superfluid_1.OsmoEquivalentMultiplierRecord.isSDK(o.osmo_equivalent_multipliers[0])) &&
                    Array.isArray(o.intermediary_accounts) &&
                    (!o.intermediary_accounts.length ||
                        superfluid_1.SuperfluidIntermediaryAccount.isSDK(o.intermediary_accounts[0])) &&
                    Array.isArray(o.intemediary_account_connections) &&
                    (!o.intemediary_account_connections.length ||
                        superfluid_1.LockIdIntermediaryAccountConnection.isSDK(o.intemediary_account_connections[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (params_1.Params.isAmino(o.params) &&
                    Array.isArray(o.superfluid_assets) &&
                    (!o.superfluid_assets.length ||
                        superfluid_1.SuperfluidAsset.isAmino(o.superfluid_assets[0])) &&
                    Array.isArray(o.osmo_equivalent_multipliers) &&
                    (!o.osmo_equivalent_multipliers.length ||
                        superfluid_1.OsmoEquivalentMultiplierRecord.isAmino(o.osmo_equivalent_multipliers[0])) &&
                    Array.isArray(o.intermediary_accounts) &&
                    (!o.intermediary_accounts.length ||
                        superfluid_1.SuperfluidIntermediaryAccount.isAmino(o.intermediary_accounts[0])) &&
                    Array.isArray(o.intemediary_account_connections) &&
                    (!o.intemediary_account_connections.length ||
                        superfluid_1.LockIdIntermediaryAccountConnection.isAmino(o.intemediary_account_connections[0])))));
    },
    ...
    fromPartial(object) {
        ...
        message.superfluidAssets =
            object.superfluidAssets?.map(e => superfluid_1.SuperfluidAsset.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.superfluidAssets =
            object.superfluid_assets?.map(e => superfluid_1.SuperfluidAsset.fromAmino(e)) || [];
        message.osmoEquivalentMultipliers =
            object.osmo_equivalent_multipliers?.map(e => superfluid_1.OsmoEquivalentMultiplierRecord.fromAmino(e)) || [];
        message.intermediaryAccounts =
            object.intermediary_accounts?.map(e => superfluid_1.SuperfluidIntermediaryAccount.fromAmino(e)) || [];
        message.intemediaryAccountConnections =
            object.intemediary_account_connections?.map(e => superfluid_1.LockIdIntermediaryAccountConnection.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.intemediaryAccountConnections) {
            obj.intemediary_account_connections =
                message.intemediaryAccountConnections.map(e => e ? superfluid_1.LockIdIntermediaryAccountConnection.toAmino(e) : undefined);
        }
        else {
            obj.intemediary_account_connections =
                message.intemediaryAccountConnections;
