...
exports.GenesisDowntimeEntry = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisDowntimeEntry.typeUrl ||
                ((0, helpers_1.isSet)(o.duration) && timestamp_1.Timestamp.is(o.lastDowntime))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisDowntimeEntry.typeUrl ||
                ((0, helpers_1.isSet)(o.duration) && timestamp_1.Timestamp.isSDK(o.last_downtime))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisDowntimeEntry.typeUrl ||
                ((0, helpers_1.isSet)(o.duration) && timestamp_1.Timestamp.isAmino(o.last_downtime))));
    },
    ...
    toAmino(message) {
        ...
        obj.last_downtime = message.lastDowntime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.lastDowntime))
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GenesisState = {
        ...
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.downtimes) &&
                    (!o.downtimes.length || exports.GenesisDowntimeEntry.is(o.downtimes[0])) &&
                    timestamp_1.Timestamp.is(o.lastBlockTime))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.downtimes) &&
                    (!o.downtimes.length || exports.GenesisDowntimeEntry.isSDK(o.downtimes[0])) &&
                    timestamp_1.Timestamp.isSDK(o.last_block_time))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.GenesisState.typeUrl ||
                (Array.isArray(o.downtimes) &&
                    (!o.downtimes.length ||
                        exports.GenesisDowntimeEntry.isAmino(o.downtimes[0])) &&
                    timestamp_1.Timestamp.isAmino(o.last_block_time))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseGenesisState();
        message.downtimes =
            object.downtimes?.map(e => exports.GenesisDowntimeEntry.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        const message = createBaseGenesisState();
        message.downtimes =
            object.downtimes?.map(e => exports.GenesisDowntimeEntry.fromAmino(e)) || [];
        if (object.last_block_time !== undefined &&
    ...
    toAmino(message) {
        ...
        obj.last_block_time = message.lastBlockTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.lastBlockTime))
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
