...
exports.registry = [
    ['/osmosis.gamm.v1beta1.MsgJoinPool', tx_1.MsgJoinPool],
    ['/osmosis.gamm.v1beta1.MsgExitPool', tx_1.MsgExitPool],
    ['/osmosis.gamm.v1beta1.MsgSwapExactAmountIn', tx_1.MsgSwapExactAmountIn],
    ['/osmosis.gamm.v1beta1.MsgSwapExactAmountOut', tx_1.MsgSwapExactAmountOut],
    [
    ...
    [
        ...
        tx_1.MsgJoinSwapShareAmountOut,
    ],
    [
        '/osmosis.gamm.v1beta1.MsgExitSwapExternAmountOut',
        tx_1.MsgExitSwapExternAmountOut,
    ],
    ['/osmosis.gamm.v1beta1.MsgExitSwapShareAmountIn', tx_1.MsgExitSwapShareAmountIn],
];
