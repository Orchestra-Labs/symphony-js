...
exports.MsgCreateStableswapPool = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateStableswapPool.typeUrl ||
                (typeof o.sender === 'string' &&
                    Array.isArray(o.initialPoolLiquidity) &&
                    (!o.initialPoolLiquidity.length ||
                        coin_1.Coin.is(o.initialPoolLiquidity[0])) &&
            ...
            (o.$typeUrl === exports.MsgCreateStableswapPool.typeUrl ||
                (typeof o.sender === 'string' &&
                    ...
                    (!o.initial_pool_liquidity.length ||
                        coin_1.Coin.isSDK(o.initial_pool_liquidity[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.MsgCreateStableswapPool.typeUrl ||
                (typeof o.sender === 'string' &&
                    Array.isArray(o.initial_pool_liquidity) &&
                    (!o.initial_pool_liquidity.length ||
                        coin_1.Coin.isAmino(o.initial_pool_liquidity[0])) &&
                    Array.isArray(o.scaling_factors) &&
                    (!o.scaling_factors.length ||
                        typeof o.scaling_factors[0] === 'bigint') &&
                    typeof o.future_pool_governor === 'string' &&
    ...
    fromPartial(object) {
        ...
        message.poolParams =
            object.poolParams !== undefined && object.poolParams !== null
                ? stableswap_pool_1.PoolParams.fromPartial(object.poolParams)
                : undefined;
        message.initialPoolLiquidity =
            object.initialPoolLiquidity?.map(e => coin_1.Coin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.initialPoolLiquidity =
            object.initial_pool_liquidity?.map(e => coin_1.Coin.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        obj.pool_params = message.poolParams
            ? stableswap_pool_1.PoolParams.toAmino(message.poolParams)
            : undefined;
...
exports.MsgCreateStableswapPoolResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateStableswapPoolResponse.typeUrl ||
...
exports.MsgStableSwapAdjustScalingFactors = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgStableSwapAdjustScalingFactors.typeUrl ||
                (typeof o.sender === 'string' &&
                    typeof o.poolId === 'bigint' &&
                    Array.isArray(o.scalingFactors) &&
                    (!o.scalingFactors.length ||
