...
exports.Pool = {
        ...
        return (o &&
            (o.$typeUrl === exports.Pool.typeUrl ||
                (typeof o.address === 'string' &&
                    ...
                    (!o.poolLiquidity.length || coin_1.Coin.is(o.poolLiquidity[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Pool.typeUrl ||
                (typeof o.address === 'string' &&
                    ...
                    (!o.pool_liquidity.length || coin_1.Coin.isSDK(o.pool_liquidity[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.Pool.typeUrl ||
                (typeof o.address === 'string' &&
                    ...
                    Array.isArray(o.pool_liquidity) &&
                    (!o.pool_liquidity.length || coin_1.Coin.isAmino(o.pool_liquidity[0])) &&
                    Array.isArray(o.scaling_factors) &&
                    (!o.scaling_factors.length ||
                        typeof o.scaling_factors[0] === 'bigint') &&
                    typeof o.scaling_factor_controller === 'string')));
    ...
    fromPartial(object) {
        ...
        message.poolLiquidity =
            object.poolLiquidity?.map(e => coin_1.Coin.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.poolLiquidity =
            object.pool_liquidity?.map(e => coin_1.Coin.fromAmino(e)) || [];
