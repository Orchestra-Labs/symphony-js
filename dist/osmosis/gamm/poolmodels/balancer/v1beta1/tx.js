...
exports.MsgCreateBalancerPool = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateBalancerPool.typeUrl ||
                (typeof o.sender === 'string' &&
                    Array.isArray(o.poolAssets) &&
                    (!o.poolAssets.length || balancerPool_1.PoolAsset.is(o.poolAssets[0])) &&
        ...
        return (o &&
            (o.$typeUrl === exports.MsgCreateBalancerPool.typeUrl ||
                (typeof o.sender === 'string' &&
                    ...
                    (!o.pool_assets.length || balancerPool_1.PoolAsset.isSDK(o.pool_assets[0])) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateBalancerPool.typeUrl ||
                (typeof o.sender === 'string' &&
                    Array.isArray(o.pool_assets) &&
                    (!o.pool_assets.length || balancerPool_1.PoolAsset.isAmino(o.pool_assets[0])) &&
                    typeof o.future_pool_governor === 'string')));
    },
    ...
    fromPartial(object) {
        ...
        message.poolParams =
            object.poolParams !== undefined && object.poolParams !== null
                ? balancerPool_1.PoolParams.fromPartial(object.poolParams)
                : undefined;
        message.poolAssets =
            object.poolAssets?.map(e => balancerPool_1.PoolAsset.fromPartial(e)) || [];
    ...
    fromAmino(object) {
        ...
        message.poolAssets =
            object.pool_assets?.map(e => balancerPool_1.PoolAsset.fromAmino(e)) || [];
    ...
    toAmino(message) {
        ...
        obj.pool_params = message.poolParams
            ? balancerPool_1.PoolParams.toAmino(message.poolParams)
            : undefined;
...
exports.MsgCreateBalancerPoolResponse = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.MsgCreateBalancerPoolResponse.typeUrl ||
