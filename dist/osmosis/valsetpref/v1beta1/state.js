...
exports.ValidatorPreference = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorPreference.typeUrl ||
...
exports.ValidatorSetPreferences = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSetPreferences.typeUrl ||
                (Array.isArray(o.preferences) &&
                    (!o.preferences.length || exports.ValidatorPreference.is(o.preferences[0])))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSetPreferences.typeUrl ||
                (Array.isArray(o.preferences) &&
                    (!o.preferences.length ||
                        exports.ValidatorPreference.isSDK(o.preferences[0])))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.ValidatorSetPreferences.typeUrl ||
                (Array.isArray(o.preferences) &&
                    (!o.preferences.length ||
                        exports.ValidatorPreference.isAmino(o.preferences[0])))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseValidatorSetPreferences();
        message.preferences =
            object.preferences?.map(e => exports.ValidatorPreference.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseValidatorSetPreferences();
        message.preferences =
            object.preferences?.map(e => exports.ValidatorPreference.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
