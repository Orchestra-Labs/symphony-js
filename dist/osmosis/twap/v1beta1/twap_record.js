...
exports.TwapRecord = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.TwapRecord.typeUrl ||
                (typeof o.poolId === 'bigint' &&
                    ...
                    timestamp_1.Timestamp.is(o.lastErrorTime))));
    },
    isSDK(o) {
        return (o &&
            (o.$typeUrl === exports.TwapRecord.typeUrl ||
                (typeof o.pool_id === 'bigint' &&
                    ...
                    timestamp_1.Timestamp.isSDK(o.last_error_time))));
    },
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.TwapRecord.typeUrl ||
                (typeof o.pool_id === 'bigint' &&
                    ...
                    typeof o.p1_arithmetic_twap_accumulator === 'string' &&
                    typeof o.geometric_twap_accumulator === 'string' &&
                    timestamp_1.Timestamp.isAmino(o.last_error_time))));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.p0LastSpotPrice !== '') {
            writer
                .uint32(50)
                .string(math_1.Decimal.fromUserInput(message.p0LastSpotPrice, 18).atomics);
        }
        if (message.p1LastSpotPrice !== '') {
            writer
                .uint32(58)
                .string(math_1.Decimal.fromUserInput(message.p1LastSpotPrice, 18).atomics);
        }
        if (message.p0ArithmeticTwapAccumulator !== '') {
            writer
                .uint32(66)
                .string(math_1.Decimal.fromUserInput(message.p0ArithmeticTwapAccumulator, 18)
                .atomics);
        }
        if (message.p1ArithmeticTwapAccumulator !== '') {
            writer
                .uint32(74)
                .string(math_1.Decimal.fromUserInput(message.p1ArithmeticTwapAccumulator, 18)
                .atomics);
        }
        if (message.geometricTwapAccumulator !== '') {
            writer
                .uint32(82)
                .string(math_1.Decimal.fromUserInput(message.geometricTwapAccumulator, 18).atomics);
        }
    ...
    toAmino(message) {
        ...
        obj.last_error_time = message.lastErrorTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.lastErrorTime))
            : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.PruningState = {
    ...
    is(o) {
        return (o &&
            (o.$typeUrl === exports.PruningState.typeUrl ||
                (typeof o.isPruning === 'boolean' &&
                    timestamp_1.Timestamp.is(o.lastKeptTime) &&
        ...
        return (o &&
            (o.$typeUrl === exports.PruningState.typeUrl ||
                (typeof o.is_pruning === 'boolean' &&
                    timestamp_1.Timestamp.isSDK(o.last_kept_time) &&
    ...
    isAmino(o) {
        return (o &&
            (o.$typeUrl === exports.PruningState.typeUrl ||
                (typeof o.is_pruning === 'boolean' &&
                    timestamp_1.Timestamp.isAmino(o.last_kept_time) &&
                    (o.last_key_seen instanceof Uint8Array ||
                        typeof o.last_key_seen === 'string') &&
                    typeof o.last_seen_pool_id === 'bigint')));
    },
    ...
    toAmino(message) {
        ...
        obj.last_kept_time = message.lastKeptTime
            ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.lastKeptTime))
            : undefined;
        obj.last_key_seen = message.lastKeySeen
            ? (0, helpers_1.base64FromBytes)(message.lastKeySeen)
            : undefined;
