...
export declare const osmosisAminoConverters: {
    ...
    '/osmosis.bridge.v1beta1.MsgInboundTransfer': {
        aminoType: string;
        toAmino: (message: import("./bridge/v1beta1/tx").MsgInboundTransfer) => import("./bridge/v1beta1/tx").MsgInboundTransferAmino;
        fromAmino: (object: import("./bridge/v1beta1/tx").MsgInboundTransferAmino) => import("./bridge/v1beta1/tx").MsgInboundTransfer;
    };
    '/osmosis.bridge.v1beta1.MsgOutboundTransfer': {
        aminoType: string;
        toAmino: (message: import("./bridge/v1beta1/tx").MsgOutboundTransfer) => import("./bridge/v1beta1/tx").MsgOutboundTransferAmino;
        fromAmino: (object: import("./bridge/v1beta1/tx").MsgOutboundTransferAmino) => import("./bridge/v1beta1/tx").MsgOutboundTransfer;
    };
    '/osmosis.bridge.v1beta1.MsgUpdateParams': {
        aminoType: string;
        toAmino: (message: import("./bridge/v1beta1/tx").MsgUpdateParams) => import("./bridge/v1beta1/tx").MsgUpdateParamsAmino;
        fromAmino: (object: import("./bridge/v1beta1/tx").MsgUpdateParamsAmino) => import("./bridge/v1beta1/tx").MsgUpdateParams;
    };
    '/osmosis.bridge.v1beta1.MsgChangeAssetStatus': {
        aminoType: string;
        toAmino: (message: import("./bridge/v1beta1/tx").MsgChangeAssetStatus) => import("./bridge/v1beta1/tx").MsgChangeAssetStatusAmino;
        fromAmino: (object: import("./bridge/v1beta1/tx").MsgChangeAssetStatusAmino) => import("./bridge/v1beta1/tx").MsgChangeAssetStatus;
    };
};
