...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QuerySwapRequest.aminoType,
  QuerySwapRequest.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QuerySwapResponse.aminoType,
  QuerySwapResponse.typeUrl,
);
...
export const QueryExchangeRequirementsRequest = {
  ...
  ): QueryExchangeRequirementsRequestAminoMsg {
    return {
      type: 'osmosis/market/query-exchange-requirements-request',
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryExchangeRequirementsRequest.aminoType,
  QueryExchangeRequirementsRequest.typeUrl,
);
...
export const QueryExchangeRequirementsResponse = {
  ...
  toAminoMsg(
    message: QueryExchangeRequirementsResponse,
  ): QueryExchangeRequirementsResponseAminoMsg {
    return {
      type: 'osmosis/market/query-exchange-requirements-response',
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  QueryExchangeRequirementsResponse.aminoType,
  QueryExchangeRequirementsResponse.typeUrl,
);
