...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetSwapFeeQueryMsg.aminoType,
  GetSwapFeeQueryMsg.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetSwapFeeQueryMsgResponse.aminoType,
  GetSwapFeeQueryMsgResponse.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  SpotPriceQueryMsg.aminoType,
  SpotPriceQueryMsg.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  SpotPriceQueryMsgResponse.aminoType,
  SpotPriceQueryMsgResponse.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetTotalPoolLiquidityQueryMsg.aminoType,
  GetTotalPoolLiquidityQueryMsg.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetTotalPoolLiquidityQueryMsgResponse.aminoType,
  GetTotalPoolLiquidityQueryMsgResponse.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetTotalSharesQueryMsg.aminoType,
  GetTotalSharesQueryMsg.typeUrl,
);
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GetTotalSharesQueryMsgResponse.aminoType,
  GetTotalSharesQueryMsgResponse.typeUrl,
);
